/* ACLE support for RISCV VECTOR (function_base classes)
...
public:
  ...
  virtual void
  apply_predication (tree, vec<tree> &, lmul_value_index, predication_index) const;
...
public:
  ...
  void
  apply_predication (tree return_type, vec<tree> &argument_types,
                     lmul_value_index, predication_index pred) const OVERRIDE;
};
...
public:
  ...
  apply_predication (tree return_type, vec<tree> &argument_types,
                     ...
                     predication_index pred) const OVERRIDE;
  rtx
  expand (const function_instance &instance, tree exp,
          rtx target) const OVERRIDE;
};
...
public:
  ...
  void
  apply_predication (tree, vec<tree> &argument_types, lmul_value_index lmul,
                     predication_index pred) const OVERRIDE;
