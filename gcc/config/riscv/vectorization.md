...
(define_expand "vec_duplicate<mode>"
  [(set (match_operand:VB 0 "register_operand")
    (vec_duplicate:VB (match_operand 1 "register_operand")))]
  "TARGET_VECTOR"
  {
    machine_mode inner = Pmode;
    machine_mode mode = get_vector_mode_for_mask (<MODE>mode);
    rtx tmp = gen_reg_rtx (inner);
    rtx op1 = gen_lowpart (inner, operands[1]);
    emit_insn (gen_rtx_SET (tmp, gen_rtx_ASHIFT (inner, op1, gen_int_mode (GET_MODE_BITSIZE(inner) - 1, inner))));
    rtx dup0 = gen_reg_rtx (mode);
    emit_insn (gen_vec_duplicate (mode, dup0, const0_rtx));
    rtx duptmp = gen_reg_rtx (mode);
    if (!TARGET_64BIT && GET_MODE_INNER (mode) == DImode)
      emit_insn (gen_vmv_v_x_32bit (mode, duptmp, const0_rtx, tmp,
                                    gen_rtx_REG (Pmode, X0_REGNUM),
                                    riscv_vector_gen_policy ()));
    else
      emit_insn (gen_vec_duplicate (mode, duptmp, tmp));
    riscv_expand_vec_cmp_int (operands[0], NE, dup0, duptmp, NULL_RTX);
    DONE;
  }
)
  ...
  "TARGET_VECTOR"
{
  ...
  if (INTVAL (operands[2]) != 1)
    emit_insn (gen_vmul<VI:mode>_vx (operands[0], const0_rtx, const0_rtx,
        operands[0], operands[2], gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));

  if (!satisfies_constraint_J (operands[1]))
    emit_insn (gen_vadd<VI:mode>_vx (operands[0], const0_rtx, const0_rtx,
...
(define_expand "len_mask_gather_load<V2UNITS:mode><V2UNITSI:mode>"
  ...
  "TARGET_VECTOR"
{
  riscv_vector_expand_gather_scatter (operands, ENUM_LEN_MASK_GATHER_LOAD);
  DONE;
})
...
(define_expand "len_scatter_store<V2UNITS:mode><V2UNITSI:mode>"
  ...
  "TARGET_VECTOR"
{
  riscv_vector_expand_gather_scatter (operands, ENUM_LEN_SCATTER_STORE);
  DONE;
})
...
(define_expand "len_mask_scatter_store<V2UNITS:mode><V2UNITSI:mode>"
  ...
  "TARGET_VECTOR"
{
  riscv_vector_expand_gather_scatter (operands, ENUM_LEN_MASK_SCATTER_STORE);
  DONE;
})
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  ...
  emit_insn (gen_vneg_v (<MODE>mode, operands[1], mask, operands[1],
      operands[1], gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  if (register_operand (operands[2], <MODE>mode))
    emit_insn (gen_v<optab><VI:mode>_vv (operands[0],
  ...
  else
    {
      ...
      emit_insn (gen_v<optab><VI:mode>_vx (operands[0],
        const0_rtx, const0_rtx, operands[1],
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  if (register_operand (operands[3], <MODE>mode))
    emit_insn (gen_v<optab><VI:mode>_vv (operands[0], operands[1], operands[4],
  ...
  else
    {
      ...
      emit_insn (gen_v<optab><VI:mode>_vx (operands[0], operands[1], operands[4],
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  if (register_operand (operands[2], <MODE>mode))
    {
      emit_insn (gen_vmulh<u><VI:mode>_vv (operands[0],
            const0_rtx, const0_rtx, operands[1],
            operands[2], gen_rtx_REG (Pmode, X0_REGNUM),
            riscv_vector_gen_policy ()));
    }
  else
    {
      rtx x;
      gcc_assert (const_vec_duplicate_p(operands[2], &x));
      emit_insn (gen_vmulh<u><VI:mode>_vx (
        operands[0], const0_rtx, const0_rtx,
        operands[1], x, gen_rtx_REG (Pmode, X0_REGNUM),
        riscv_vector_gen_policy ()));
    }
...
{
  if (register_operand (operands[2], <MODE>mode))
    emit_insn (gen_vf<optab><VF:mode>_vv (operands[0],
            const0_rtx, const0_rtx, operands[1],
            operands[2], gen_rtx_REG (Pmode, X0_REGNUM),
            riscv_vector_gen_policy ()));
  else
    {
      ...
      emit_insn (gen_vf<optab><VF:mode>_vf (operands[0],
            const0_rtx, const0_rtx, operands[1],
...
(define_expand "cond_<optab><mode>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vf<optab><VF:mode>_vv (operands[0], operands[1],
            operands[4], operands[2], operands[3],
            gen_rtx_REG (Pmode, X0_REGNUM),
            riscv_vector_gen_policy (RVV_POLICY_MU)));
  DONE;
...
(define_expand "len_fnma<VI:mode>"
  [(set (match_operand:VI 0 "register_operand")
    (unspec:VI
      [(plus:VI
        (mult:VI
...
(define_expand "cond_fma<mode>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_cond_fma (<MODE>mode, Pmode,
...
(define_expand "@cond_fma<VI:mode>_<X:mode>"
  [(parallel [(set (match_operand:VI 0 "register_operand")
      ...
      [(if_then_else:VI
        ...
        (plus:VI
	        ...
	        (match_operand:VI 4 "register_operand"))
        (match_operand:VI 5 "register_operand"))
        (match_operand:X 6 "register_operand")] UNSPEC_RVV))
    (use (match_dup 7))])]
  "TARGET_VECTOR && TARGET_RVV"
{
  operands[7] = gen_rtx_REG (SImode, VTYPE_REGNUM);
})

(define_insn "*cond_fma<VI:mode>_<X:mode>_2"
  [(set (match_operand:VI 0 "register_operand" "=vr, ?&vr")
      ...
      [(if_then_else:VI
        ...
        (match_dup 2))
        (match_operand:X 5 "p_reg_or_const_csr_operand")] UNSPEC_RVV))
...
(define_insn "*cond_fma<VI:mode>_<X:mode>_4"
  [(set (match_operand:VI 0 "register_operand" "=vr, ?&vr")
	  (unspec:VI
      [(if_then_else:VI
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn_and_rewrite "*cond_fma<VI:mode>_<X:mode>_any"
  [(set (match_operand:VI 0 "register_operand" "=&vr, &vr, &vr, &vr, &vr, ?&vr")
	  (unspec:VI
      [(if_then_else:VI
        (match_operand:<VM> 1 "register_operand" "vm, vm, vm, vm, vm, vm")
        (plus:VI
	        (mult:VI
	          (match_operand:VI 2 "register_operand" "vr, vr, 0, vr, vr, vr")
	          (match_operand:VI 3 "register_operand" "vr, vr, vr, 0, vr, vr"))
	        (match_operand:VI 4 "register_operand" "vr, 0, vr, vr, vr, vr"))
        (match_operand:VI 5 "vector_reg_or_zero" "Wc0, Wc0, Wc0, Wc0, 0, vr"))
        (match_operand:X 6 "p_reg_or_const_csr_operand")] UNSPEC_RVV))
    (use (reg:SI VTYPE_REGNUM))]
  "TARGET_VECTOR && TARGET_RVV
  ...
  "@
   ...
   #"
  "&& reload_completed
   && register_operand (operands[5], <VI:MODE>mode)"
  {
    emit_insn (gen_vcond_mask_<VI:mode><VI:vm> (operands[0], operands[4],
...
(define_expand "cond_fnma<mode>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_cond_fnma (<MODE>mode, Pmode,
      operands[0], operands[1], operands[2],
      operands[3], operands[4], operands[5],
      gen_rtx_REG (Pmode, X0_REGNUM)));
  DONE;
...
(define_expand "@cond_fnma<VI:mode>_<X:mode>"
  [(parallel [(set (match_operand:VI 0 "register_operand")
	  (unspec:VI
      [(if_then_else:VI
        (match_operand:<VM> 1 "register_operand")
...
(define_insn "*cond_fnma<VI:mode>_<X:mode>_2"
  [(set (match_operand:VI 0 "register_operand" "=vr, ?&vr")
	  (unspec:VI
      [(if_then_else:VI
        (match_operand:<VM> 1 "register_operand" "vm, vm")
  ...
  "@
   vmsub.vv\t%0,%3,%4,%1.t
   vmv<lmul>r.v\t%0,%2\;vmsub.vv\t%0,%3,%4,%1.t"
  [(set_attr "type" "vmadd")
   (set_attr "mode" "<VI:MODE>")])

(define_insn "*cond_fnma<VI:mode>_<X:mode>_4"
  [(set (match_operand:VI 0 "register_operand" "=vr, ?&vr")
	  (unspec:VI
      [(if_then_else:VI
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn_and_rewrite "*cond_fnma<VI:mode>_<X:mode>_any"
  [(set (match_operand:VI 0 "register_operand" "=&vr, &vr, &vr, &vr, &vr, ?&vr")
	  (unspec:VI
      [(if_then_else:VI
        (match_operand:<VM> 1 "register_operand" "vm, vm, vm, vm, vm, vm")
        (plus:VI
	        ...
	        (match_operand:VI 4 "register_operand" "vr, 0, vr, vr, vr, vr"))
        (match_operand:VI 5 "vector_reg_or_zero" "Wc0, Wc0, Wc0, Wc0, 0, vr"))
        (match_operand:X 6 "register_operand" "r, r, r, r, r, r")] UNSPEC_RVV))
    (use (reg:SI VTYPE_REGNUM))]
  "TARGET_VECTOR && TARGET_RVV
   && !rtx_equal_p (operands[2], operands[5])
   && !rtx_equal_p (operands[3], operands[5])
...
(define_expand "len_fnma<VF:mode>"
  [(set (match_operand:VF 0 "register_operand")
    (unspec:VF
      [(plus:VF
          (mult:VF
...
(define_expand "len_fnms<VF:mode>"
  [(set (match_operand:VF 0 "register_operand")
    (unspec:VF
      [(minus:VF
        (mult:VF
...
(define_expand "@cond_fma<VF:mode>_<X:mode>"
...
(define_insn "*cond_fma<VF:mode>_<X:mode>_2"
...
(define_insn "*cond_fma<VF:mode>_<X:mode>_4"
  [(set (match_operand:VF 0 "register_operand" "=vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn_and_rewrite "*cond_fma<VF:mode>_<X:mode>_any"
  [(set (match_operand:VF 0 "register_operand" "=&vr, &vr, &vr, &vr, &vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm, vm, vm, vm, vm")
        (plus:VF
	        (mult:VF
	          (match_operand:VF 2 "register_operand" "vr, vr, 0, vr, vr, vr")
	          (match_operand:VF 3 "register_operand" "vr, vr, vr, 0, vr, vr"))
	        (match_operand:VF 4 "register_operand" "vr, 0, vr, vr, vr, vr"))
        (match_operand:VF 5 "vector_reg_or_zero" "Wc0, Wc0, Wc0, Wc0, 0, vr"))
        (match_operand:X 6 "register_operand" "r, r, r, r, r, r")] UNSPEC_RVV))
    (use (reg:SI VTYPE_REGNUM))]
  "TARGET_VECTOR && TARGET_RVV
   && !rtx_equal_p (operands[2], operands[5])
  ...
  "@
   ...
   #"
  "&& reload_completed
   && register_operand (operands[5], <VF:MODE>mode)"
  {
    emit_insn (gen_vcond_mask_<VF:mode><VF:vm> (operands[0], operands[4],
					     operands[5], operands[1]));
    operands[5] = operands[4] = operands[0];
  }
  [(set_attr "type" "vmadd")
...
(define_expand "cond_fms<mode>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_cond_fms (<MODE>mode, Pmode,
      operands[0], operands[1], operands[2],
      operands[3], operands[4], operands[5],
      gen_rtx_REG (Pmode, X0_REGNUM)));
  DONE;
...
(define_expand "@cond_fms<VF:mode>_<X:mode>"
  [(parallel [(set (match_operand:VF 0 "register_operand")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand")
...
(define_insn "*cond_fms<VF:mode>_<X:mode>_2"
  [(set (match_operand:VF 0 "register_operand" "=vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn "*cond_fms<VF:mode>_<X:mode>_4"
  [(set (match_operand:VF 0 "register_operand" "=vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn_and_rewrite "*cond_fms<VF:mode>_<X:mode>_any"
  [(set (match_operand:VF 0 "register_operand" "=&vr, &vr, &vr, &vr, &vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm, vm, vm, vm, vm")
...
(define_expand "@cond_fnma<VF:mode>_<X:mode>"
  [(parallel [(set (match_operand:VF 0 "register_operand")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand")
...
(define_insn "*cond_fnma<VF:mode>_<X:mode>_2"
  [(set (match_operand:VF 0 "register_operand" "=vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn "*cond_fnma<VF:mode>_<X:mode>_4"
  [(set (match_operand:VF 0 "register_operand" "=vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn_and_rewrite "*cond_fnma<VF:mode>_<X:mode>_any"
  [(set (match_operand:VF 0 "register_operand" "=&vr, &vr, &vr, &vr, &vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm, vm, vm, vm, vm")
...
(define_expand "cond_fnms<mode>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_cond_fnms (<MODE>mode, Pmode,
      operands[0], operands[1], operands[2],
      operands[3], operands[4], operands[5],
      gen_rtx_REG (Pmode, X0_REGNUM)));
  DONE;
...
(define_expand "@cond_fnms<VF:mode>_<X:mode>"
  [(parallel [(set (match_operand:VF 0 "register_operand")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand")
...
(define_insn "*cond_fnms<VF:mode>_<X:mode>_2"
  [(set (match_operand:VF 0 "register_operand" "=vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn "*cond_fnms<VF:mode>_<X:mode>_4"
  [(set (match_operand:VF 0 "register_operand" "=vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm")
...
(define_insn_and_rewrite "*cond_fnms<VF:mode>_<X:mode>_any"
  [(set (match_operand:VF 0 "register_operand" "=&vr, &vr, &vr, &vr, &vr, ?&vr")
	  (unspec:VF
      [(if_then_else:VF
        (match_operand:<VM> 1 "register_operand" "vm, vm, vm, vm, vm, vm")
...
(define_expand "@vcond_mask_sv<vsub><vm>"
  [(match_operand:V 0 "register_operand")
...
(define_expand "@len_vcond_mask_sv<vsub><vm>"
  [(match_operand:V 0 "register_operand")
   (match_operand:<VSUB> 1 "reg_or_simm5_operand")
   (match_operand:V 2 "register_operand")
   (match_operand:<VM> 3 "register_operand")
...
(define_expand "vec_convert_v<su><optab>v<mode><vw>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vw<optab><u><vw>_vv (operands[0],
      const0_rtx, const0_rtx, operands[1],
      operands[2], gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  DONE;
...
(define_expand "vec_convert_<su><optab>v<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (plus_minus_mult:<VW>
      (any_extend:<VW>
        (match_operand:VWI 1 "register_operand"))
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vw<optab><u><vw>_vx (operands[0],
      const0_rtx, const0_rtx, operands[1],
      operands[2], gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  DONE;
...
(define_expand "vec_convert_vusmulv<mode><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (mult:<VW>
      (zero_extend:<VW>
        (match_operand:VWI 1 "register_operand"))
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  ...
  rtx wide1 = gen_reg_rtx (<VW>mode);
  rtx wide2 = gen_reg_rtx (<VW>mode);
  emit_insn (gen_vmv<mode>_v_x (reg, const0_rtx, operands[1],
                                gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  emit_insn (gen_vwcvt_x_x_v (SIGN_EXTEND, <MODE>mode,
      wide1, const0_rtx, const0_rtx, reg, gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  emit_insn (gen_vwcvt_x_x_v (ZERO_EXTEND, <MODE>mode,
      wide2, const0_rtx, const0_rtx, operands[2],
      gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  emit_insn (gen_vmul_vv (<VW>mode, operands[0], const0_rtx, const0_rtx,
      wide1, wide2, gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  DONE;
})
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  ...
  rtx wide1 = gen_reg_rtx (<VW>mode);
  rtx wide2 = gen_reg_rtx (<VW>mode);
  emit_insn (gen_vmv<mode>_v_x (reg, const0_rtx, operands[1], operands[3], riscv_vector_gen_policy ()));
  emit_insn (gen_vwcvt_x_x_v (SIGN_EXTEND, <MODE>mode,
      wide1, const0_rtx, const0_rtx, reg, operands[3],
      riscv_vector_gen_policy ()));
  emit_insn (gen_vwcvt_x_x_v (ZERO_EXTEND, <MODE>mode,
      wide2, const0_rtx, const0_rtx, operands[2], operands[3],
      riscv_vector_gen_policy ()));
  emit_insn (gen_vmul_vv (<VW>mode, operands[0], const0_rtx, const0_rtx,
      wide1, wide2, operands[3], riscv_vector_gen_policy ()));
  DONE;
})
...
(define_expand "vec_convert_vs<optab>v<mode><vw>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfw<optab><vw>_vv (operands[0],
      const0_rtx, const0_rtx, operands[1],
      operands[2], gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  DONE;
...
(define_expand "vec_convert_s<optab>v<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (plus_minus_mult:<VW>
      (float_extend:<VW>
        (match_operand:VWF 1 "register_operand"))
...
(define_expand "len_vec_convert_v<su><optab>v<mode><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus_minus_mult:<VW>
        (any_extend:<VW>
...
(define_expand "len_vec_convert_<su><optab>v<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus_minus_mult:<VW>
        (any_extend:<VW>
...
(define_expand "len_vec_convert_vusmulv<mode><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(mult:<VW>
        (zero_extend:<VW>
...
(define_expand "len_vec_convert_s<optab>v<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus_minus_mult:<VW>
        (float_extend:<VW>
...
(define_expand "vec_convert_v<su><optab>w<mode><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (plus_minus:<VW>
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vw<optab><u><vw>_wv (operands[0],
      const0_rtx, const0_rtx, operands[1],
      operands[2], gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  DONE;
...
(define_expand "len_vec_convert_v<su><optab>w<mode><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus_minus:<VW>
        (match_operand:<VW> 1 "register_operand")
...
(define_expand "len_vec_convert_vs<optab>w<mode><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus_minus:<VW>
        (match_operand:<VW> 1 "register_operand")
...
(define_expand "vec_convert_<su><optab>w<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (plus_minus:<VW>
      (match_operand:<VW> 1 "register_operand")
      (any_extend:<VW>
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vw<optab><u><vw>_wx (operands[0],
      const0_rtx, const0_rtx, operands[1],
      operands[2], gen_rtx_REG (Pmode, X0_REGNUM),
      riscv_vector_gen_policy ()));
  DONE;
...
(define_expand "len_vec_convert_<su><optab>w<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus_minus:<VW>
        (match_operand:<VW> 1 "register_operand")
...
(define_expand "len_vec_convert_s<optab>w<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus_minus:<VW>
        (match_operand:<VW> 1 "register_operand")
...
(define_expand "vec_convert_v<su>fmav<mode><vw>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vwmacc<u><vw>_vv (operands[3], const0_rtx, operands[3], operands[1], operands[2],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
...
(define_expand "vec_convert_vsfmav<mode><vw>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfwmacc<vw>_vv (operands[3], const0_rtx, operands[3], operands[1], operands[2],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})

(define_expand "vec_convert_vusfmav<mode><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (plus:<VW>
      (mult:<VW>
        (zero_extend:<VW>
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vwmaccsu<vw>_vv (operands[3], const0_rtx, operands[3], operands[2], operands[1],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})
...
(define_expand "len_vec_convert_vusfmav<mode><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus:<VW>
        (mult:<VW>
...
(define_expand "vec_convert_<su>fmav<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (plus:<VW>
      (mult:<VW>
        (any_extend:<VW>
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vwmacc<u><vw>_vx (
             operands[3], const0_rtx, operands[3], operands[2], operands[1],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})

(define_expand "vec_convert_sfmav<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (plus:<VW>
      (mult:<VW>
        (float_extend:<VW>
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfwmacc<vw>_vf (operands[3], const0_rtx, operands[3], operands[2], operands[1],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vwmaccus<vw>_vx (
             operands[3], const0_rtx, operands[3], operands[1], operands[2],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})
...
(define_expand "len_vec_convert_<su>fmav<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus:<VW>
        (mult:<VW>
...
(define_expand "len_vec_convert_sfmav<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(plus:<VW>
        (mult:<VW>
...
(define_expand "vec_convert_vsfmsv<mode><vw>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfwmsac<vw>_vv (operands[3], const0_rtx, operands[3], operands[1], operands[2],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})
...
(define_expand "vec_convert_sfmsv<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (minus:<VW>
      (mult:<VW>
        (float_extend:<VW>
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfwmsac<vw>_vf (operands[3], const0_rtx, operands[3], operands[2], operands[1],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})

(define_expand "len_vec_convert_sfmsv<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(minus:<VW>
        (mult:<VW>
...
(define_expand "vec_convert_vsfnmav<mode><vw>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfwnmsac<vw>_vv (operands[3], const0_rtx, operands[3], operands[1], operands[2],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})
...
(define_expand "vec_convert_sfnmav<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (minus:<VW>
      (match_operand:<VW> 3 "register_operand")
      (mult:<VW>
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfwnmsac<vw>_vf (operands[3], const0_rtx, operands[3], operands[2], operands[1],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})

(define_expand "len_vec_convert_sfnmav<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(minus:<VW>
        (match_operand:<VW> 3 "register_operand")
...
(define_expand "vec_convert_vsfnmsv<mode><vw>"
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfwnmacc<vw>_vv (operands[3], const0_rtx, operands[3], operands[1], operands[2],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})
...
(define_expand "vec_convert_sfnmsv<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (minus:<VW>
      (neg:<VW>
        (mult:<VW>
  ...
  "TARGET_VECTOR && TARGET_RVV"
{
  emit_insn (gen_vfwnmacc<vw>_vf (operands[3], const0_rtx, operands[3], operands[2], operands[1],
             gen_rtx_REG (Pmode, X0_REGNUM), riscv_vector_gen_policy ()));
  riscv_emit_move (operands[0], operands[3]);
  DONE;
})

(define_expand "len_vec_convert_sfnmsv<vsub><vw>"
  [(set (match_operand:<VW> 0 "register_operand")
    (unspec:<VW>
      [(minus:<VW>
        (neg:<VW>
...
(define_expand "sub_vs<mode>"
  [(set (match_operand:VI 0 "register_operand")
    (minus:VI
      (match_operand:VI 1 "register_operand")
      (vec_duplicate:VI
        (match_operand:<VSUB> 2 "reg_or_neg_simm5_operand"))))]
  "TARGET_VECTOR && TARGET_RVV
  && !(<VSUB>mode == DImode && !TARGET_64BIT)"
  {
...
(define_expand "<optab>_sv<mode>"
  ...
  && !(<VSUB>mode == DImode && !TARGET_64BIT)"
  {
    emit_insn (gen_vfr<optab><VF:mode>_vf (operands[0],
        const0_rtx, const0_rtx, operands[1],
        operands[2], gen_rtx_REG (Pmode, X0_REGNUM),
        riscv_vector_gen_policy ()));
    DONE;
...
(define_expand "len_<optab>_vs<mode>"
  ...
  "TARGET_VECTOR"
  {
    if (!CONSTANT_P (operands[3]))
      operands[3] = gen_lowpart (Pmode, operands[3]);
    emit_insn (gen_vf<optab><VF:mode>_vf (operands[0], const0_rtx, const0_rtx,
        operands[1], operands[2], operands[3],
        riscv_vector_gen_policy ()));
    DONE;
  })
...
(define_expand "len_<optab>_sv<mode>"
  ...
  "TARGET_VECTOR"
  {
    if (!CONSTANT_P (operands[3]))
      operands[3] = gen_lowpart (Pmode, operands[3]);
    emit_insn (gen_vfr<optab><VF:mode>_vf (operands[0], const0_rtx, const0_rtx,
        operands[1], operands[2], operands[3],
        riscv_vector_gen_policy ()));
    DONE;
  })

(define_expand "len_fma_vs<VI:mode>"
  [(set (match_operand:VI 0 "register_operand")
    (unspec:VI
      [(plus:VI
          (mult:VI
...
(define_expand "len_fnma_vs<VI:mode>"
  [(set (match_operand:VI 0 "register_operand")
    (unspec:VI
      [(plus:VI
        (mult:VI
...
(define_expand "len_fma_vs<VF:mode>"
  [(set (match_operand:VF 0 "register_operand")
    (unspec:VF
      [(plus:VF
          (mult:VF
...
(define_expand "len_fms_vs<VF:mode>"
  [(set (match_operand:VF 0 "register_operand")
    (unspec:VF
      [(minus:VF
        (mult:VF
...
(define_expand "len_fnma_vs<VF:mode>"
  [(set (match_operand:VF 0 "register_operand")
    (unspec:VF
      [(plus:VF
          (mult:VF
...
(define_expand "len_fnms_vs<VF:mode>"
  [(set (match_operand:VF 0 "register_operand")
    (unspec:VF
      [(minus:VF
        (mult:VF
...
(define_insn "*len_fma_vs<VI:mode>"
  [(set (match_operand:VI 0 "register_operand" "=vr, vr, ?&vr")
    (unspec:VI
      [(plus:VI
          (mult:VI
...
(define_insn "*len_fnma_vs<VI:mode>"
  [(set (match_operand:VI 0 "register_operand" "=vr, vr, ?&vr")
    (unspec:VI
      [(plus:VI
        (mult:VI
...
(define_insn "*len_fma_vs<VF:mode>"
  [(set (match_operand:VF 0 "register_operand" "=vr, vr, ?&vr")
    (unspec:VF
      [(plus:VF
          (mult:VF
...
(define_insn "*len_fms_vs<VF:mode>"
  [(set (match_operand:VF 0 "register_operand" "=vr, vr, ?&vr")
    (unspec:VF
      [(minus:VF
        (mult:VF
...
(define_insn "*len_fnma_vs<VF:mode>"
  [(set (match_operand:VF 0 "register_operand" "=vr, vr, ?&vr")
    (unspec:VF
      [(plus:VF
          (mult:VF
...
(define_insn "*len_fnms_vs<VF:mode>"
  [(set (match_operand:VF 0 "register_operand" "=vr, vr, ?&vr")
    (unspec:VF
      [(minus:VF
        (mult:VF
