...
private:
  ...
  struct gen_pack_maps_t {
	  ...
	  HOST_WIDE_INT get_inum(const HOST_WIDE_INT regno, rtx_insn* before) {
		  ...
		  for (std::vector<HOST_WIDE_INT>::reverse_iterator rit = inums.rbegin(); rit != inums.rend(); rit++) {
			  if (*rit < binum)
				  return *rit;
		  }
		  return -1;
	  }
	  reg_bits_prop get_reg_bits_prop(const HOST_WIDE_INT regno, rtx_insn* before = NULL) {
  ...
  */
  typedef bool (pass_gen_pack::*bit_checker_fn)(const rtx op, rtx out, char[256], struct gen_pack_maps_t*, rtx *, rtx*) const;

  bool output_is_at_most_0xFF_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFF_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFF00_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFF00_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFF0000_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFF0000_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFF000000_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFF000000_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFFFF_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFFFF_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFFFF0000_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool output_is_at_most_0xFFFF0000_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const;
  bool analyze (rtx_insn * const insn, struct gen_pack_maps_t *gen_pack_maps);
  bool check_2operands(rtx_insn * const insn, reg_bits_prop s1bits, reg_bits_prop s2bits, reg_bits_low_high low_high_1, reg_bits_low_high low_high_2, struct gen_pack_maps_t *gen_pack_maps, rtx *source1, rtx *source2);
  bool generate_packh (struct gen_pack_maps_t *gen_pack_maps, rtx_insn * insn);
  bool generate_packhu (struct gen_pack_maps_t *gen_pack_maps, rtx_insn * insn);
  bool generate_packhm (struct gen_pack_maps_t *gen_pack_maps, rtx_insn * insn);
  bool generate_pack (struct gen_pack_maps_t *gen_pack_maps, rtx_insn * insn);
  bool generate_packu (struct gen_pack_maps_t *gen_pack_maps, rtx_insn * insn);
  /*
 ...
 */
  bool check_or (struct gen_pack_maps_t *gen_pack_maps, rtx_insn* first_or);
...
bool
pass_gen_pack::output_is_at_most_0xFF_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	rtx pat = PATTERN(insn);
	rtx out = XEXP(pat, 0);
	rtx op = XEXP(pat, 1);
	return output_is_at_most_0xFF_bits(op, out, reason, gen_pack_maps, source_low, source_high);
}
	
bool
pass_gen_pack::output_is_at_most_0xFF_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	if (GET_CODE(op) == REG) {
		HOST_WIDE_INT regno = REGNO(op);
		reg_bits_prop b = gen_pack_maps->get_reg_bits_prop(regno);
		if (b == REG_0XFF) {
			snprintf(reason, 256, "register value");
			*source_low = gen_pack_maps->get_source_low(regno);
			*source_high = gen_pack_maps->get_source_high(regno);
			return true;
		}
		return false;
	}
	...
	if (GET_CODE(op) == LSHIFTRT) {
		...
		if (CONST_INT_P(op1) && (INTVAL(op1) == 8)) {
			...
			if (GET_CODE(op0) == REG) {
				rtx_insn *def = gen_pack_maps->get_def_insn(REGNO(op0));
				if (def != NULL) {
					recurse = output_is_at_most_0xFF00_bits(def, reason, gen_pack_maps, source_low, source_high);
				}
			} else {
				recurse = output_is_at_most_0xFF00_bits(op0, NULL, reason, gen_pack_maps, source_low, source_high);
			}
			if (recurse) {
				char bak[256];
			...
			if (GET_CODE(op0) == REG) {
				rtx_insn *def = gen_pack_maps->get_def_insn(REGNO(op0));
				if (def != NULL) {
					recurse = output_is_at_most_0xFFFF_bits(def, reason, gen_pack_maps, source_low, source_high);
				}
				...
				recurse = output_is_at_most_0xFFFF_bits(op0, NULL, reason, gen_pack_maps, source_low, source_high);
			}
			if (recurse) {
				char bak[256];
				snprintf(bak, 256, "%s", reason);
...
bool
pass_gen_pack::output_is_at_most_0xFF00_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	rtx pat = PATTERN(insn);
	rtx out = XEXP(pat, 0);
	rtx op = XEXP(pat, 1);
	return output_is_at_most_0xFF00_bits(op, out, reason, gen_pack_maps, source_low, source_high);
}
bool
pass_gen_pack::output_is_at_most_0xFF00_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	if (GET_CODE(op) == REG) {
		HOST_WIDE_INT regno = REGNO(op);
		reg_bits_prop b = gen_pack_maps->get_reg_bits_prop(regno);
		if (b == REG_0XFF00) {
	...
	if (GET_CODE(op) == ASHIFT) {
		...
		if (CONST_INT_P(op1) && (INTVAL(op1) == 8)) {
			...
			if (GET_CODE(op0) == REG) {
				rtx_insn *def = gen_pack_maps->get_def_insn(REGNO(op0));
				if (def != NULL) {
					recurse = output_is_at_most_0xFF_bits(def, reason, gen_pack_maps, source_low, source_high);
				}
			} else {
				recurse = output_is_at_most_0xFF_bits(op0, NULL, reason, gen_pack_maps, source_low, source_high);
			}
			if (recurse) {
				char bak[256];
				snprintf(bak, 256, "%s", reason);
...
bool
pass_gen_pack::output_is_at_most_0xFF0000_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	rtx pat = PATTERN(insn);
	rtx out = XEXP(pat, 0);
	rtx op = XEXP(pat, 1);
	return output_is_at_most_0xFF0000_bits(op, out, reason, gen_pack_maps, source_low, source_high);
}
bool
pass_gen_pack::output_is_at_most_0xFF0000_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	if (GET_CODE(op) == REG) {
		HOST_WIDE_INT regno = REGNO(op);
		reg_bits_prop b = gen_pack_maps->get_reg_bits_prop(regno);
		if (b == REG_0XFF0000) {
...
bool
pass_gen_pack::output_is_at_most_0xFF000000_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	rtx pat = PATTERN(insn);
	rtx out = XEXP(pat, 0);
	rtx op = XEXP(pat, 1);
	return output_is_at_most_0xFF000000_bits(op, out, reason, gen_pack_maps, source_low, source_high);
}
bool
pass_gen_pack::output_is_at_most_0xFF000000_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	if (GET_CODE(op) == REG) {
		HOST_WIDE_INT regno = REGNO(op);
		reg_bits_prop b = gen_pack_maps->get_reg_bits_prop(regno);
		if (b == REG_0XFF000000) {
...
bool
pass_gen_pack::output_is_at_most_0xFFFF_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	rtx pat = PATTERN(insn);
	rtx out = XEXP(pat, 0);
	rtx op = XEXP(pat, 1);
	...
	return output_is_at_most_0xFFFF_bits(op, out, reason, gen_pack_maps, source_low, source_high);
}
bool
pass_gen_pack::output_is_at_most_0xFFFF_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	if (GET_CODE(op) == REG) {
		HOST_WIDE_INT regno = REGNO(op);
		reg_bits_prop b = gen_pack_maps->get_reg_bits_prop(regno);
		if (b == REG_0XFFFF) {
	...
	if ((GET_CODE(op) == LSHIFTRT) &&
		...
		if (CONST_INT_P(op1) && (INTVAL(op1) == 16)) {
			...
			if (GET_CODE(op0) == REG) {
				rtx_insn *def = gen_pack_maps->get_def_insn(REGNO(op0));
				if (def != NULL) {
					recurse = output_is_at_most_0xFFFF0000_bits(def, reason, gen_pack_maps, source_low, source_high);
				}
			} else {
				recurse = output_is_at_most_0xFFFF0000_bits(op0, NULL, reason, gen_pack_maps, source_low, source_high);
			}
			if (recurse) {
				char bak[256];
				snprintf(bak, 256, "%s", reason);
...
bool
pass_gen_pack::output_is_at_most_0xFFFF0000_bits(rtx_insn * const insn, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	rtx pat = PATTERN(insn);
	rtx out = XEXP(pat, 0);
	rtx op = XEXP(pat, 1);
	return output_is_at_most_0xFFFF0000_bits(op, out, reason, gen_pack_maps, source_low, source_high);
}
bool
pass_gen_pack::output_is_at_most_0xFFFF0000_bits(const rtx op, rtx out, char reason[256], struct gen_pack_maps_t *gen_pack_maps, rtx *source_low, rtx *source_high) const {
	if (GET_CODE(op) == REG) {
		HOST_WIDE_INT regno = REGNO(op);
		reg_bits_prop b = gen_pack_maps->get_reg_bits_prop(regno);
		if (b == REG_0XFFFF0000) {
		...
		if (GET_MODE(op) == SImode) {
			if (CONST_INT_P(op1) && (INTVAL(op1) == -65536)) {
				...
				*source_high = op0;// first operand of and
				...
				rtx_insn *def = gen_pack_maps->get_def_insn(REGNO(op1));
				if (def != NULL) {
					rtx cst = PATTERN(def);
					rtx cst1 = XEXP(cst, 1);
...
bool
pass_gen_pack::analyze (rtx_insn * const insn, struct gen_pack_maps_t *gen_pack_maps)
{
	rtx source_low = NULL;
	...
	reason[0] = '\0';
	found = output_is_at_most_0xFF_bits(insn, reason, gen_pack_maps, &source_low, &source_high);
	if (found) {
		//printf("%s:%d : %d, 0xFF -> %s (for %d, '%s')\n", __PRETTY_FUNCTION__, __LINE__, GET_CODE(pat), found ? "yes" : "no", regno, reason);
		gen_pack_maps->fill(regno, REG_0XFF, insn, source_low, source_high);
		return true;
	}

	reason[0] = '\0';
	found = output_is_at_most_0xFF00_bits(insn, reason, gen_pack_maps, &source_low, &source_high);
	if (found) {
		//printf("%s:%d : %d, 0xFF00 -> %s (for %d, '%s')\n", __PRETTY_FUNCTION__, __LINE__, GET_CODE(pat), found ? "yes" : "no", regno, reason);
		gen_pack_maps->fill(regno, REG_0XFF00, insn, source_low, source_high);
		return true;
	}

	reason[0] = '\0';
	found = output_is_at_most_0xFF0000_bits(insn, reason, gen_pack_maps, &source_low, &source_high);
	if (found) {
		//printf("%s:%d : %d, 0xFF0000 -> %s (for %d, '%s')\n", __PRETTY_FUNCTION__, __LINE__, GET_CODE(pat), found ? "yes" : "no", regno, reason);
		gen_pack_maps->fill(regno, REG_0XFF0000, insn, source_low, source_high);
		return true;
	}

	reason[0] = '\0';
	found = output_is_at_most_0xFF000000_bits(insn, reason, gen_pack_maps, &source_low, &source_high);
	if (found) {
		//printf("%s:%d : %d, 0xFF000000 -> %s (for %d, '%s')\n", __PRETTY_FUNCTION__, __LINE__, GET_CODE(pat), found ? "yes" : "no", regno, reason);
		gen_pack_maps->fill(regno, REG_0XFF000000, insn, source_low, source_high);
		return true;
	}

	reason[0] = '\0';
	found = output_is_at_most_0xFFFF_bits(insn, reason, gen_pack_maps, &source_low, &source_high);
	if (found) {
		//printf("%s:%d : %d, 0xFFFF -> %s (for %d, '%s')\n", __PRETTY_FUNCTION__, __LINE__, GET_CODE(pat), found ? "yes" : "no", regno, reason);
		gen_pack_maps->fill(regno, REG_0XFFFF, insn, source_low, source_high);
		return true;
	}

	reason[0] = '\0';
	found = output_is_at_most_0xFFFF0000_bits(insn, reason, gen_pack_maps, &source_low, &source_high);
	if (found) {
		//printf("%s:%d : %d, 0xFFFF0000 -> %s (for %d, '%s')\n", __PRETTY_FUNCTION__, __LINE__, GET_CODE(pat), found ? "yes" : "no", regno, reason);
		gen_pack_maps->fill(regno, REG_0XFFFF0000, insn, source_low, source_high);
		return true;
	}

	//printf("%s:%d : %d, (something) -> %s (for %d, '%s')\n", __PRETTY_FUNCTION__, __LINE__, GET_CODE(pat), found ? "yes" : "no", regno, reason);
	gen_pack_maps->fill(regno, REG_UNKNOWN, insn, NULL, NULL);

	return true;
}

bool
pass_gen_pack::check_2operands(rtx_insn * const insn, reg_bits_prop s1bits, reg_bits_prop s2bits, reg_bits_low_high low_high_1, reg_bits_low_high low_high_2, struct gen_pack_maps_t *gen_pack_maps, rtx *source1, rtx *source2) {
	...
	reason[0] = '\0';
	if ((this->*s1check)(op0, out, reason, gen_pack_maps, &source_low, &source_high)) {
		opL = op0;
		true_opL = (low_high_1 == reg_bits_low ? source_low : source_high);
	}
	if ((this->*s2check)(op0, out, reason, gen_pack_maps, &source_low, &source_high)) {
		opH = op0;
		true_opH = (low_high_2 == reg_bits_low ? source_low : source_high);
	}

	reason[0] = '\0';
	if ((this->*s1check)(op1, out, reason, gen_pack_maps, &source_low, &source_high)) {
		opL = op1;
		true_opL = (low_high_1 == reg_bits_low ? source_low : source_high);
	}
	if ((this->*s2check)(op1, out, reason, gen_pack_maps, &source_low, &source_high)) {
		opH = op1;
		true_opH = (low_high_2 == reg_bits_low ? source_low : source_high);
	}
...
bool
pass_gen_pack::generate_packh (struct gen_pack_maps_t *gen_pack_maps, rtx_insn* insn) {
	if (!NONJUMP_INSN_P (insn))
		return false;
	rtx pat = PATTERN(insn);
	if (GET_CODE (pat) != SET)
	...
	if (!check_2operands(insn, REG_0XFF, REG_0XFF00, reg_bits_low, reg_bits_low, gen_pack_maps, &true_opL, &true_opH))
		return false;
...
bool
pass_gen_pack::generate_packhu (struct gen_pack_maps_t *gen_pack_maps, rtx_insn* insn) {
	if (!NONJUMP_INSN_P (insn))
		return false;
	rtx pat = PATTERN(insn);
	if (GET_CODE (pat) != SET)
	...
	if (!check_2operands(insn, REG_0XFF0000, REG_0XFF000000, reg_bits_low, reg_bits_low, gen_pack_maps, &true_opL, &true_opH))
		return false;
...
pass_gen_pack::generate_packhm (struct gen_pack_maps_t *gen_pack_maps, rtx_insn* insn) {
	if (!NONJUMP_INSN_P (insn))
		return false;
	rtx pat = PATTERN(insn);
	if (GET_CODE (pat) != SET)
	...
	if (!check_2operands(insn, REG_0XFF00, REG_0XFF0000, reg_bits_low, reg_bits_low, gen_pack_maps, &true_opL, &true_opH))
		return false;
...
bool
pass_gen_pack::generate_pack (struct gen_pack_maps_t *gen_pack_maps, rtx_insn* insn) {
	if (!NONJUMP_INSN_P (insn))
		return false;
	rtx pat = PATTERN(insn);
	if (GET_CODE (pat) != SET)
	...
	if (!check_2operands(insn, REG_0XFFFF, REG_0XFFFF0000, reg_bits_low, reg_bits_low, gen_pack_maps, &true_opL, &true_opH))
		return false;
...
bool
pass_gen_pack::generate_packu (struct gen_pack_maps_t *gen_pack_maps, rtx_insn* insn) {
	if (!NONJUMP_INSN_P (insn))
		return false;
	rtx pat = PATTERN(insn);
	if (GET_CODE (pat) != SET)
	...
	if (!check_2operands(insn, REG_0XFFFF, REG_0XFFFF0000, reg_bits_high, reg_bits_high, gen_pack_maps, &true_opL, &true_opH))
		return false;
...
bool
pass_gen_pack::check_or (struct gen_pack_maps_t *gen_pack_maps, rtx_insn* first_or) {
	...
	for (int i = 0; !second_found && i < 2 ; i++) {
		...
		if (GET_CODE(first_or_opchain) != REG)
			continue;
		second_or = gen_pack_maps->get_def_insn(REGNO(first_or_opchain), first_or);
		if (second_or == NULL)
			continue;
	...
	for (int i = 0; !third_found && i < 2 ; i++) {
		...
		if (GET_CODE(second_or_opchain) != REG)
			continue;
		third_or = gen_pack_maps->get_def_insn(REGNO(second_or_opchain), second_or);
		if (third_or == NULL)
			continue;
	...
	operands_before[0] = first_or;
	operands_before[1] = second_or;
	operands_before[2] = third_or;
	operands_before[3] = third_or;
	...
	for (int i = 0 ; i < 4 ; i++) {
		...
		if (GET_CODE(operands[i]) != REG)
			return false;
		rtx_insn* def = gen_pack_maps->get_def_insn(REGNO(operands[i]), operands_before[i]);
		if (def == NULL)
			return false;
		if (output_is_at_most_0xFF_bits(def, reason, gen_pack_maps, &source_low, &source_high)) {
			operands_sorted[0] = operands[i];
			def_sorted[0] = def;
		}
		if (output_is_at_most_0xFF00_bits(def, reason, gen_pack_maps, &source_low, &source_high)) {
			operands_sorted[1] = operands[i];
			def_sorted[1] = def;
		}
		if (output_is_at_most_0xFF0000_bits(def, reason, gen_pack_maps, &source_low, &source_high)) {
			operands_sorted[2] = operands[i];
			def_sorted[2] = def;
		}
		if (output_is_at_most_0xFF000000_bits(def, reason, gen_pack_maps, &source_low, &source_high)) {
...
pass_gen_pack::execute (function *fn)
{
  ...
  FOR_ALL_BB_FN (bb, fn)
  {
	  ...
	  FOR_BB_INSNS (bb, insn)
		  {
			  if (analyze (insn, &gen_pack_maps)) {
				  if (check_or(&gen_pack_maps, insn)) {
					  c_treeor ++;
					  goto start_or;
				  }
			  }
	  ...
	  FOR_BB_INSNS (bb, insn)
		  {
			  if (analyze (insn, &gen_pack_maps)) {
				  if (generate_packh(&gen_pack_maps, insn)) {
					  c_packh ++;
					  goto start_pack;
				  }
				  if (generate_packhu(&gen_pack_maps, insn)) {
					  c_packhu ++;
					  goto start_pack;
				  }
				  if (generate_packhm(&gen_pack_maps, insn)) {
					  c_packhm ++;
					  goto start_pack;
				  }
				  if (generate_pack(&gen_pack_maps, insn)) {
				  	  c_pack ++;
				  	  goto start_pack;
				  }
				  if (generate_packu(&gen_pack_maps, insn)) {
				  	  c_packu ++;
				  	  goto start_pack;
				  }
			  }
