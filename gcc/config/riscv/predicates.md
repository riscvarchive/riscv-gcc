...
(define_predicate "vector_const_int_operand"
  (and (match_code "const_vector")
       (match_test "riscv_const_vec_all_same_in_range_p (op, -16, 15)")))

(define_predicate "vector_neg_const_int_operand"
  (and (match_code "const_vector")
       (match_test "riscv_const_vec_all_same_in_range_p (op, -15, 16)")))

(define_predicate "vector_unsigned_const_int_operand"
  (and (match_code "const_vector")
...
(define_predicate "vector_arith_operand"
  (ior (match_operand 0 "vector_const_int_operand")
       (match_operand 0 "register_operand")))

(define_predicate "vector_neg_arith_operand"
  (ior (match_operand 0 "vector_neg_const_int_operand")
       (match_operand 0 "register_operand")))

(define_predicate "vector_shift_operand"
  (ior (match_operand 0 "vector_unsigned_const_int_operand")
       (match_operand 0 "register_operand")))
...
(define_predicate "vector_reg_or_zero"
