...
#define MASK_ZBKB     (1 << 6)
#define MASK_ZBKC     (1 << 7)
#define MASK_ZBKX     (1 << 8)
#define MASK_ZKNE     (1 << 9)
#define MASK_ZKND     (1 << 10)
#define MASK_ZKNH     (1 << 11)
#define MASK_ZKR      (1 << 12)
#define MASK_ZKSED    (1 << 13)
#define MASK_ZKSH     (1 << 14)
#define MASK_ZKT      (1 << 15)
