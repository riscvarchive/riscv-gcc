...
{
  return vnsra(mask, maskedoff, op1, op2, vl);
}
...
{
  return vnsra_tu(dest, op1, op2, vl);
}
...
{
  return vnsra_tama(mask, op1, op2, vl);
}
...
{
  return vnsra_tamu(mask, maskedoff, op1, op2, vl);
}
...
{
  return vnsra_tuma(mask, maskedoff, op1, op2, vl);
}
...
{
  return vnsra_tumu(mask, maskedoff, op1, op2, vl);
}
