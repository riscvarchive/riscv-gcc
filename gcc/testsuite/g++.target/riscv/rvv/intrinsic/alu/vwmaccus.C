...
{
  return vwmaccus(dest, op1, op2, vl);
}
...
{
  return vwmaccus(mask, dest, op1, op2, vl);
}
...
{
  return vwmaccus_ta(dest, op1, op2, vl);
}
...
{
  return vwmaccus_tu(dest, op1, op2, vl);
}
...
{
  return vwmaccus_tama(mask, dest, op1, op2, vl);
}
...
{
  return vwmaccus_tamu(mask, dest, op1, op2, vl);
}
...
{
  return vwmaccus_tuma(mask, dest, op1, op2, vl);
}
...
{
  return vwmaccus_tumu(mask, dest, op1, op2, vl);
}
