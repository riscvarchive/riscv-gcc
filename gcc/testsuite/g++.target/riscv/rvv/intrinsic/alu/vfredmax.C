...
{
  return vfredmax(dest, op1, op2, vl);
}
...
{
  return vfredmax(mask, maskedoff, op1, op2, vl);
}
...
{
  return vfredmax_tam(mask, op1, op2, vl);
}
...
{
  return vfredmax_tum(mask, maskedoff, op1, op2, vl);
}
...
{
  return vfredmax_tu(dest, op1, op2, vl);
}
