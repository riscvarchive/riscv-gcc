...
{
  vfloat16mf4_t a = vlmul_trunc_f16mf4(op1);
  return a;
}
...
{
  vfloat16mf2_t a = vlmul_trunc_f16mf2(op1);
  return a;
}
...
{
  vfloat16m1_t a = vlmul_trunc_f16m1(op1);
  return a;
}
...
{
  vfloat16m2_t a = vlmul_trunc_f16m2(op1);
  return a;
}
...
{
  vfloat16m4_t a = vlmul_trunc_f16m4(op1);
  return a;
}
