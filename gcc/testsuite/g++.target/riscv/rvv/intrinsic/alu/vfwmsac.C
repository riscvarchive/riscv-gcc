...
{
  return vfwmsac(dest, op1, op2, vl);
}
...
{
  return vfwmsac(mask, dest, op1, op2, vl);
}
...
{
  return vfwmsac_ta(dest, op1, op2, vl);
}
...
{
  return vfwmsac_tu(dest, op1, op2, vl);
}
...
{
  return vfwmsac_tama(mask, dest, op1, op2, vl);
}
...
{
  return vfwmsac_tamu(mask, dest, op1, op2, vl);
}
...
{
  return vfwmsac_tuma(mask, dest, op1, op2, vl);
}
...
{
  return vfwmsac_tumu(mask, dest, op1, op2, vl);
}
