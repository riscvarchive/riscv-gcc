...
{
  return vredmax(dest, op1, op2, vl);
}
...
{
  return vredmax(mask, maskedoff, op1, op2, vl);
}
...
{
  return vredmax_tam(mask, op1, op2, vl);
}
...
{
  return vredmax_tum(mask, maskedoff, op1, op2, vl);
}
...
{
  return vredmax_tu(dest, op1, op2, vl);
}
