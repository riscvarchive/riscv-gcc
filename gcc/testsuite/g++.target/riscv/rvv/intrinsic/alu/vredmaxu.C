...
{
  return vredmaxu(dest, op1, op2, vl);
}
...
{
  return vredmaxu(mask, maskedoff, op1, op2, vl);
}
...
{
  return vredmaxu_tam(mask, op1, op2, vl);
}
...
{
  return vredmaxu_tum(mask, maskedoff, op1, op2, vl);
}
...
{
  return vredmaxu_tu(dest, op1, op2, vl);
}
