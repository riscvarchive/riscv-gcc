...
{
  return vredxor(dest, op1, op2, vl);
}
...
{
  return vredxor(mask, maskedoff, op1, op2, vl);
}
...
{
  return vredxor_tam(mask, op1, op2, vl);
}
...
{
  return vredxor_tum(mask, maskedoff, op1, op2, vl);
}
...
{
  return vredxor_tu(dest, op1, op2, vl);
}
