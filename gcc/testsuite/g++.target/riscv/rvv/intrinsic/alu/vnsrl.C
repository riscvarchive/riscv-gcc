...
{
  return vnsrl(mask, maskedoff, op1, op2, vl);
}
...
{
  return vnsrl_tu(dest, op1, op2, vl);
}
...
{
  return vnsrl_tama(mask, op1, op2, vl);
}
...
{
  return vnsrl_tamu(mask, maskedoff, op1, op2, vl);
}
...
{
  return vnsrl_tuma(mask, maskedoff, op1, op2, vl);
}
...
{
  return vnsrl_tumu(mask, maskedoff, op1, op2, vl);
}
