...
#define RVV_WFCVT_TEST(EM, WEM, MLEN, SEW, WSEW)	\
  ...
  {									\
    ...
    vint##WEM##_t vy;							\
    vx = vload_float##EM(x);						\
    vy = vwcvt_f##SEW##toi##WSEW##_v_##EM (vx);			\
    vstore_int##WEM(y, vy);						\
  }									\
  ...
  {									\
    ...
    vuint##WEM##_t vy;						\
    vx = vload_float##EM(x);					\
    vy = vwcvt_f##SEW##toui##WSEW##_v_##EM (vx);			\
  ...
  {									\
    ...
    vint##EM##_t vy;						\
    vy = vload_int##EM(y);					\
    vx = vwcvt_i##SEW##tof##WSEW##_v_##EM (vy);			\
  ...
  {									\
    ...
    vuint##EM##_t vy;						\
    vy = vload_uint##EM(y);						\
    vx = vwcvt_ui##SEW##tof##WSEW##_v_##EM (vy);			\
    vstore_float##WEM(x, vx);						\
  }\
  ...
  {									\
    ...
    vfloat##EM##_t vy;						\
    vy = vload_float##EM(y);						\
    vx = vwcvt_f##SEW##tof##WSEW##_v_##EM (vy);			\
    vstore_float##WEM(x, vx);						\
  }
