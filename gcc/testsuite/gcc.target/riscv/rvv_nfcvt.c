...
#define RVV_NFCVT_TEST(EM, WEM, MLEN, SEW, WSEW)	\
  ...
  {									\
    ...
    vint##EM##_t vy;							\
    vx = vload_f##WEM(x);						\
    vy = vcvt_i##SEW##_f##WSEW##_v_##WEM (vx);			\
    vstore_i##EM(y, vy);						\
  }									\
  ...
  {									\
    ...
    vuint##EM##_t vy;						\
    vx = vload_f##WEM(x);					\
    vy = vcvt_u##SEW##_f##WSEW##_v_##WEM (vx);			\
    vstore_u##EM(y, vy);					\
  }									\
  ...
  {									\
    ...
    vint##EM##_t vy;							\
    vx = vload_f##WEM(x);						\
    vy = vcvt_rtz_i##SEW##_f##WSEW##_v_##WEM (vx);			\
    vstore_i##EM(y, vy);						\
  }									\
  ...
  {									\
    ...
    vuint##EM##_t vy;						\
    vx = vload_f##WEM(x);					\
    vy = vcvt_rtz_u##SEW##_f##WSEW##_v_##WEM (vx);			\
    vstore_u##EM(y, vy);					\
  }									\
  ...
  {									\
    ...
    vint##WEM##_t vy;						\
    vy = vload_i##WEM(y);					\
    vx = vcvt_f##SEW##_i##WSEW##_v_##WEM (vy);			\
    vstore_f##EM(x, vx);						\
  }									\
  ...
  {									\
    ...
    vuint##WEM##_t vy;						\
    vy = vload_u##WEM(y);						\
    vx = vcvt_f##SEW##_u##WSEW##_v_##WEM (vy);			\
    vstore_f##EM(x, vx);						\
  }\
  ...
  {									\
    ...
    vfloat##WEM##_t vy;						\
    vy = vload_f##WEM(y);						\
    vx = vcvt_f##SEW##_f##WSEW##_v_##WEM (vy);			\
    vstore_f##EM(x, vx);						\
  }									\
  ...
  {									\
    ...
    vfloat##WEM##_t vy;						\
    vy = vload_f##WEM(y);						\
    vx = vcvt_rod_f##SEW##_f##WSEW##_v_##WEM (vy);			\
    vstore_f##EM(x, vx);						\
  }
