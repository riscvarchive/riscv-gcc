...
RVV_UINT_TEST_ARG(RVV_BIN_BUILTIN_VEC_SCALAR_IMM_MASKED_TEST, aadd)
RVV_INT_TEST_ARG(RVV_BIN_BUILTIN_VEC_SCALAR_IMM_MASKED_TEST, asub)
RVV_UINT_TEST_ARG(RVV_BIN_BUILTIN_VEC_SCALAR_IMM_MASKED_TEST, asub)

/* { dg-final { scan-assembler-times "vaadd.vv" 16 } } */
/* { dg-final { scan-assembler-times "vaadd.vx" 16 } } */
/* { dg-final { scan-assembler-times "vaadd.vi" 16 } } */
/* { dg-final { scan-assembler-times "vaaddu.vv" 16 } } */
/* { dg-final { scan-assembler-times "vaaddu.vx" 16 } } */
/* { dg-final { scan-assembler-times "vaaddu.vi" 16 } } */
