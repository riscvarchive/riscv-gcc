...
vint8mf8_t 
test_vslidedown_vx_i8mf8_vl32_0(vint8mf8_t op1)
{
  return vslidedown_vx_i8mf8(op1, 0, 32);
}
...
vint8mf8_t 
test_vslidedown_vx_i8mf8_vl32_31(vint8mf8_t op1)
{
  return vslidedown_vx_i8mf8(op1, 31, 32);
}
...
vint8mf4_t 
test_vslidedown_vx_i8mf4_vl32_0(vint8mf4_t op1)
{
  return vslidedown_vx_i8mf4(op1, 0, 32);
}
...
vint8mf4_t 
test_vslidedown_vx_i8mf4_vl32_31(vint8mf4_t op1)
{
  return vslidedown_vx_i8mf4(op1, 31, 32);
}
...
vint8mf2_t 
test_vslidedown_vx_i8mf2_vl32_0(vint8mf2_t op1)
{
  return vslidedown_vx_i8mf2(op1, 0, 32);
}
...
vint8mf2_t 
test_vslidedown_vx_i8mf2_vl32_31(vint8mf2_t op1)
{
  return vslidedown_vx_i8mf2(op1, 31, 32);
}
...
vint8m1_t 
test_vslidedown_vx_i8m1_vl32_0(vint8m1_t op1)
{
  return vslidedown_vx_i8m1(op1, 0, 32);
}
...
vint8m1_t 
test_vslidedown_vx_i8m1_vl32_31(vint8m1_t op1)
{
  return vslidedown_vx_i8m1(op1, 31, 32);
}
...
vint8m2_t 
test_vslidedown_vx_i8m2_vl32_0(vint8m2_t op1)
{
  return vslidedown_vx_i8m2(op1, 0, 32);
}
...
vint8m2_t 
test_vslidedown_vx_i8m2_vl32_31(vint8m2_t op1)
{
  return vslidedown_vx_i8m2(op1, 31, 32);
}
...
vint8m4_t 
test_vslidedown_vx_i8m4_vl32_0(vint8m4_t op1)
{
  return vslidedown_vx_i8m4(op1, 0, 32);
}
...
vint8m4_t 
test_vslidedown_vx_i8m4_vl32_31(vint8m4_t op1)
{
  return vslidedown_vx_i8m4(op1, 31, 32);
}
...
vint8m8_t 
test_vslidedown_vx_i8m8_vl32_0(vint8m8_t op1)
{
  return vslidedown_vx_i8m8(op1, 0, 32);
}
...
vint8m8_t 
test_vslidedown_vx_i8m8_vl32_31(vint8m8_t op1)
{
  return vslidedown_vx_i8m8(op1, 31, 32);
}
...
vint16mf4_t 
test_vslidedown_vx_i16mf4_vl32_0(vint16mf4_t op1)
{
  return vslidedown_vx_i16mf4(op1, 0, 32);
}
...
vint16mf4_t 
test_vslidedown_vx_i16mf4_vl32_31(vint16mf4_t op1)
{
  return vslidedown_vx_i16mf4(op1, 31, 32);
}
...
vint16mf2_t 
test_vslidedown_vx_i16mf2_vl32_0(vint16mf2_t op1)
{
  return vslidedown_vx_i16mf2(op1, 0, 32);
}
...
vint16mf2_t 
test_vslidedown_vx_i16mf2_vl32_31(vint16mf2_t op1)
{
  return vslidedown_vx_i16mf2(op1, 31, 32);
}
...
vint16m1_t 
test_vslidedown_vx_i16m1_vl32_0(vint16m1_t op1)
{
  return vslidedown_vx_i16m1(op1, 0, 32);
}
...
vint16m1_t 
test_vslidedown_vx_i16m1_vl32_31(vint16m1_t op1)
{
  return vslidedown_vx_i16m1(op1, 31, 32);
}
...
vint16m2_t 
test_vslidedown_vx_i16m2_vl32_0(vint16m2_t op1)
{
  return vslidedown_vx_i16m2(op1, 0, 32);
}
...
vint16m2_t 
test_vslidedown_vx_i16m2_vl32_31(vint16m2_t op1)
{
  return vslidedown_vx_i16m2(op1, 31, 32);
}
...
vint16m4_t 
test_vslidedown_vx_i16m4_vl32_0(vint16m4_t op1)
{
  return vslidedown_vx_i16m4(op1, 0, 32);
}
...
vint16m4_t 
test_vslidedown_vx_i16m4_vl32_31(vint16m4_t op1)
{
  return vslidedown_vx_i16m4(op1, 31, 32);
}
...
vint16m8_t 
test_vslidedown_vx_i16m8_vl32_0(vint16m8_t op1)
{
  return vslidedown_vx_i16m8(op1, 0, 32);
}
...
vint16m8_t 
test_vslidedown_vx_i16m8_vl32_31(vint16m8_t op1)
{
  return vslidedown_vx_i16m8(op1, 31, 32);
}
...
vint32mf2_t 
test_vslidedown_vx_i32mf2_vl32_0(vint32mf2_t op1)
{
  return vslidedown_vx_i32mf2(op1, 0, 32);
}
...
vint32mf2_t 
test_vslidedown_vx_i32mf2_vl32_31(vint32mf2_t op1)
{
  return vslidedown_vx_i32mf2(op1, 31, 32);
}
...
vint32m1_t 
test_vslidedown_vx_i32m1_vl32_0(vint32m1_t op1)
{
  return vslidedown_vx_i32m1(op1, 0, 32);
}
...
vint32m1_t 
test_vslidedown_vx_i32m1_vl32_31(vint32m1_t op1)
{
  return vslidedown_vx_i32m1(op1, 31, 32);
}
...
vint32m2_t 
test_vslidedown_vx_i32m2_vl32_0(vint32m2_t op1)
{
  return vslidedown_vx_i32m2(op1, 0, 32);
}
...
vint32m2_t 
test_vslidedown_vx_i32m2_vl32_31(vint32m2_t op1)
{
  return vslidedown_vx_i32m2(op1, 31, 32);
}
...
vint32m4_t 
test_vslidedown_vx_i32m4_vl32_0(vint32m4_t op1)
{
  return vslidedown_vx_i32m4(op1, 0, 32);
}
...
vint32m4_t 
test_vslidedown_vx_i32m4_vl32_31(vint32m4_t op1)
{
  return vslidedown_vx_i32m4(op1, 31, 32);
}
...
vint32m8_t 
test_vslidedown_vx_i32m8_vl32_0(vint32m8_t op1)
{
  return vslidedown_vx_i32m8(op1, 0, 32);
}
...
vint32m8_t 
test_vslidedown_vx_i32m8_vl32_31(vint32m8_t op1)
{
  return vslidedown_vx_i32m8(op1, 31, 32);
}
...
vint64m1_t 
test_vslidedown_vx_i64m1_vl32_0(vint64m1_t op1)
{
  return vslidedown_vx_i64m1(op1, 0, 32);
}
...
vint64m1_t 
test_vslidedown_vx_i64m1_vl32_31(vint64m1_t op1)
{
  return vslidedown_vx_i64m1(op1, 31, 32);
}
...
vint64m2_t 
test_vslidedown_vx_i64m2_vl32_0(vint64m2_t op1)
{
  return vslidedown_vx_i64m2(op1, 0, 32);
}
...
vint64m2_t 
test_vslidedown_vx_i64m2_vl32_31(vint64m2_t op1)
{
  return vslidedown_vx_i64m2(op1, 31, 32);
}
...
vint64m4_t 
test_vslidedown_vx_i64m4_vl32_0(vint64m4_t op1)
{
  return vslidedown_vx_i64m4(op1, 0, 32);
}
...
vint64m4_t 
test_vslidedown_vx_i64m4_vl32_31(vint64m4_t op1)
{
  return vslidedown_vx_i64m4(op1, 31, 32);
}
...
vint64m8_t 
test_vslidedown_vx_i64m8_vl32_0(vint64m8_t op1)
{
  return vslidedown_vx_i64m8(op1, 0, 32);
}
...
vint64m8_t 
test_vslidedown_vx_i64m8_vl32_31(vint64m8_t op1)
{
  return vslidedown_vx_i64m8(op1, 31, 32);
}
