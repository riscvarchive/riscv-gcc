...
vint8m1_t 
test_vredand_vs_i8mf8_i8m1_vl32(vint8mf8_t op1, vint8m1_t op2)
{
  return vredand_vs_i8mf8_i8m1(op1, op2, 32);
}
...
vint8m1_t 
test_vredand_vs_i8mf4_i8m1_vl32(vint8mf4_t op1, vint8m1_t op2)
{
  return vredand_vs_i8mf4_i8m1(op1, op2, 32);
}
...
vint8m1_t 
test_vredand_vs_i8mf2_i8m1_vl32(vint8mf2_t op1, vint8m1_t op2)
{
  return vredand_vs_i8mf2_i8m1(op1, op2, 32);
}
...
vint8m1_t 
test_vredand_vs_i8m1_i8m1_vl32(vint8m1_t op1, vint8m1_t op2)
{
  return vredand_vs_i8m1_i8m1(op1, op2, 32);
}
...
vint8m1_t 
test_vredand_vs_i8m2_i8m1_vl32(vint8m2_t op1, vint8m1_t op2)
{
  return vredand_vs_i8m2_i8m1(op1, op2, 32);
}
...
vint8m1_t 
test_vredand_vs_i8m4_i8m1_vl32(vint8m4_t op1, vint8m1_t op2)
{
  return vredand_vs_i8m4_i8m1(op1, op2, 32);
}
...
vint8m1_t 
test_vredand_vs_i8m8_i8m1_vl32(vint8m8_t op1, vint8m1_t op2)
{
  return vredand_vs_i8m8_i8m1(op1, op2, 32);
}
...
vint16m1_t 
test_vredand_vs_i16mf4_i16m1_vl32(vint16mf4_t op1, vint16m1_t op2)
{
  return vredand_vs_i16mf4_i16m1(op1, op2, 32);
}
...
vint16m1_t 
test_vredand_vs_i16mf2_i16m1_vl32(vint16mf2_t op1, vint16m1_t op2)
{
  return vredand_vs_i16mf2_i16m1(op1, op2, 32);
}
...
vint16m1_t 
test_vredand_vs_i16m1_i16m1_vl32(vint16m1_t op1, vint16m1_t op2)
{
  return vredand_vs_i16m1_i16m1(op1, op2, 32);
}
...
vint16m1_t 
test_vredand_vs_i16m2_i16m1_vl32(vint16m2_t op1, vint16m1_t op2)
{
  return vredand_vs_i16m2_i16m1(op1, op2, 32);
}
...
vint16m1_t 
test_vredand_vs_i16m4_i16m1_vl32(vint16m4_t op1, vint16m1_t op2)
{
  return vredand_vs_i16m4_i16m1(op1, op2, 32);
}
...
vint16m1_t 
test_vredand_vs_i16m8_i16m1_vl32(vint16m8_t op1, vint16m1_t op2)
{
  return vredand_vs_i16m8_i16m1(op1, op2, 32);
}
...
vint32m1_t 
test_vredand_vs_i32mf2_i32m1_vl32(vint32mf2_t op1, vint32m1_t op2)
{
  return vredand_vs_i32mf2_i32m1(op1, op2, 32);
}
...
vint32m1_t 
test_vredand_vs_i32m1_i32m1_vl32(vint32m1_t op1, vint32m1_t op2)
{
  return vredand_vs_i32m1_i32m1(op1, op2, 32);
}
...
vint32m1_t 
test_vredand_vs_i32m2_i32m1_vl32(vint32m2_t op1, vint32m1_t op2)
{
  return vredand_vs_i32m2_i32m1(op1, op2, 32);
}
...
vint32m1_t 
test_vredand_vs_i32m4_i32m1_vl32(vint32m4_t op1, vint32m1_t op2)
{
  return vredand_vs_i32m4_i32m1(op1, op2, 32);
}
...
vint32m1_t 
test_vredand_vs_i32m8_i32m1_vl32(vint32m8_t op1, vint32m1_t op2)
{
  return vredand_vs_i32m8_i32m1(op1, op2, 32);
}
...
vint64m1_t 
test_vredand_vs_i64m1_i64m1_vl32(vint64m1_t op1, vint64m1_t op2)
{
  return vredand_vs_i64m1_i64m1(op1, op2, 32);
}
...
vint64m1_t 
test_vredand_vs_i64m2_i64m1_vl32(vint64m2_t op1, vint64m1_t op2)
{
  return vredand_vs_i64m2_i64m1(op1, op2, 32);
}
...
vint64m1_t 
test_vredand_vs_i64m4_i64m1_vl32(vint64m4_t op1, vint64m1_t op2)
{
  return vredand_vs_i64m4_i64m1(op1, op2, 32);
}
...
vint64m1_t 
test_vredand_vs_i64m8_i64m1_vl32(vint64m8_t op1, vint64m1_t op2)
{
  return vredand_vs_i64m8_i64m1(op1, op2, 32);
}
