...
vfloat16mf4_t 
test_vfmv_s_f_f16mf4_vl32(float16_t op1)
{
  return vfmv_s_f_f16mf4(op1, 32);
}
...
vfloat16mf2_t 
test_vfmv_s_f_f16mf2_vl32(float16_t op1)
{
  return vfmv_s_f_f16mf2(op1, 32);
}
...
vfloat16m1_t 
test_vfmv_s_f_f16m1_vl32(float16_t op1)
{
  return vfmv_s_f_f16m1(op1, 32);
}
...
vfloat16m2_t 
test_vfmv_s_f_f16m2_vl32(float16_t op1)
{
  return vfmv_s_f_f16m2(op1, 32);
}
...
vfloat16m4_t 
test_vfmv_s_f_f16m4_vl32(float16_t op1)
{
  return vfmv_s_f_f16m4(op1, 32);
}
...
vfloat16m8_t 
test_vfmv_s_f_f16m8_vl32(float16_t op1)
{
  return vfmv_s_f_f16m8(op1, 32);
}
...
vfloat32mf2_t 
test_vfmv_s_f_f32mf2_vl32(float32_t op1)
{
  return vfmv_s_f_f32mf2(op1, 32);
}
...
vfloat32m1_t 
test_vfmv_s_f_f32m1_vl32(float32_t op1)
{
  return vfmv_s_f_f32m1(op1, 32);
}
...
vfloat32m2_t 
test_vfmv_s_f_f32m2_vl32(float32_t op1)
{
  return vfmv_s_f_f32m2(op1, 32);
}
...
vfloat32m4_t 
test_vfmv_s_f_f32m4_vl32(float32_t op1)
{
  return vfmv_s_f_f32m4(op1, 32);
}
...
vfloat32m8_t 
test_vfmv_s_f_f32m8_vl32(float32_t op1)
{
  return vfmv_s_f_f32m8(op1, 32);
}
...
vfloat64m1_t 
test_vfmv_s_f_f64m1_vl32(float64_t op1)
{
  return vfmv_s_f_f64m1(op1, 32);
}
...
vfloat64m2_t 
test_vfmv_s_f_f64m2_vl32(float64_t op1)
{
  return vfmv_s_f_f64m2(op1, 32);
}
...
vfloat64m4_t 
test_vfmv_s_f_f64m4_vl32(float64_t op1)
{
  return vfmv_s_f_f64m4(op1, 32);
}
...
vfloat64m8_t 
test_vfmv_s_f_f64m8_vl32(float64_t op1)
{
  return vfmv_s_f_f64m8(op1, 32);
}
