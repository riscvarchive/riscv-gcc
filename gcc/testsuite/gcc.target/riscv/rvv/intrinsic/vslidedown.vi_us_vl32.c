...
vuint8mf8_t 
test_vslidedown_vx_u8mf8_vl32_0(vuint8mf8_t op1)
{
  return vslidedown_vx_u8mf8(op1, 0, 32);
}
...
vuint8mf8_t 
test_vslidedown_vx_u8mf8_vl32_31(vuint8mf8_t op1)
{
  return vslidedown_vx_u8mf8(op1, 31, 32);
}
...
vuint8mf4_t 
test_vslidedown_vx_u8mf4_vl32_0(vuint8mf4_t op1)
{
  return vslidedown_vx_u8mf4(op1, 0, 32);
}
...
vuint8mf4_t 
test_vslidedown_vx_u8mf4_vl32_31(vuint8mf4_t op1)
{
  return vslidedown_vx_u8mf4(op1, 31, 32);
}
...
vuint8mf2_t 
test_vslidedown_vx_u8mf2_vl32_0(vuint8mf2_t op1)
{
  return vslidedown_vx_u8mf2(op1, 0, 32);
}
...
vuint8mf2_t 
test_vslidedown_vx_u8mf2_vl32_31(vuint8mf2_t op1)
{
  return vslidedown_vx_u8mf2(op1, 31, 32);
}
...
vuint8m1_t 
test_vslidedown_vx_u8m1_vl32_0(vuint8m1_t op1)
{
  return vslidedown_vx_u8m1(op1, 0, 32);
}
...
vuint8m1_t 
test_vslidedown_vx_u8m1_vl32_31(vuint8m1_t op1)
{
  return vslidedown_vx_u8m1(op1, 31, 32);
}
...
vuint8m2_t 
test_vslidedown_vx_u8m2_vl32_0(vuint8m2_t op1)
{
  return vslidedown_vx_u8m2(op1, 0, 32);
}
...
vuint8m2_t 
test_vslidedown_vx_u8m2_vl32_31(vuint8m2_t op1)
{
  return vslidedown_vx_u8m2(op1, 31, 32);
}
...
vuint8m4_t 
test_vslidedown_vx_u8m4_vl32_0(vuint8m4_t op1)
{
  return vslidedown_vx_u8m4(op1, 0, 32);
}
...
vuint8m4_t 
test_vslidedown_vx_u8m4_vl32_31(vuint8m4_t op1)
{
  return vslidedown_vx_u8m4(op1, 31, 32);
}
...
vuint8m8_t 
test_vslidedown_vx_u8m8_vl32_0(vuint8m8_t op1)
{
  return vslidedown_vx_u8m8(op1, 0, 32);
}
...
vuint8m8_t 
test_vslidedown_vx_u8m8_vl32_31(vuint8m8_t op1)
{
  return vslidedown_vx_u8m8(op1, 31, 32);
}
...
vuint16mf4_t 
test_vslidedown_vx_u16mf4_vl32_0(vuint16mf4_t op1)
{
  return vslidedown_vx_u16mf4(op1, 0, 32);
}
...
vuint16mf4_t 
test_vslidedown_vx_u16mf4_vl32_31(vuint16mf4_t op1)
{
  return vslidedown_vx_u16mf4(op1, 31, 32);
}
...
vuint16mf2_t 
test_vslidedown_vx_u16mf2_vl32_0(vuint16mf2_t op1)
{
  return vslidedown_vx_u16mf2(op1, 0, 32);
}
...
vuint16mf2_t 
test_vslidedown_vx_u16mf2_vl32_31(vuint16mf2_t op1)
{
  return vslidedown_vx_u16mf2(op1, 31, 32);
}
...
vuint16m1_t 
test_vslidedown_vx_u16m1_vl32_0(vuint16m1_t op1)
{
  return vslidedown_vx_u16m1(op1, 0, 32);
}
...
vuint16m1_t 
test_vslidedown_vx_u16m1_vl32_31(vuint16m1_t op1)
{
  return vslidedown_vx_u16m1(op1, 31, 32);
}
...
vuint16m2_t 
test_vslidedown_vx_u16m2_vl32_0(vuint16m2_t op1)
{
  return vslidedown_vx_u16m2(op1, 0, 32);
}
...
vuint16m2_t 
test_vslidedown_vx_u16m2_vl32_31(vuint16m2_t op1)
{
  return vslidedown_vx_u16m2(op1, 31, 32);
}
...
vuint16m4_t 
test_vslidedown_vx_u16m4_vl32_0(vuint16m4_t op1)
{
  return vslidedown_vx_u16m4(op1, 0, 32);
}
...
vuint16m4_t 
test_vslidedown_vx_u16m4_vl32_31(vuint16m4_t op1)
{
  return vslidedown_vx_u16m4(op1, 31, 32);
}
...
vuint16m8_t 
test_vslidedown_vx_u16m8_vl32_0(vuint16m8_t op1)
{
  return vslidedown_vx_u16m8(op1, 0, 32);
}
...
vuint16m8_t 
test_vslidedown_vx_u16m8_vl32_31(vuint16m8_t op1)
{
  return vslidedown_vx_u16m8(op1, 31, 32);
}
...
vuint32mf2_t 
test_vslidedown_vx_u32mf2_vl32_0(vuint32mf2_t op1)
{
  return vslidedown_vx_u32mf2(op1, 0, 32);
}
...
vuint32mf2_t 
test_vslidedown_vx_u32mf2_vl32_31(vuint32mf2_t op1)
{
  return vslidedown_vx_u32mf2(op1, 31, 32);
}
...
vuint32m1_t 
test_vslidedown_vx_u32m1_vl32_0(vuint32m1_t op1)
{
  return vslidedown_vx_u32m1(op1, 0, 32);
}
...
vuint32m1_t 
test_vslidedown_vx_u32m1_vl32_31(vuint32m1_t op1)
{
  return vslidedown_vx_u32m1(op1, 31, 32);
}
...
vuint32m2_t 
test_vslidedown_vx_u32m2_vl32_0(vuint32m2_t op1)
{
  return vslidedown_vx_u32m2(op1, 0, 32);
}
...
vuint32m2_t 
test_vslidedown_vx_u32m2_vl32_31(vuint32m2_t op1)
{
  return vslidedown_vx_u32m2(op1, 31, 32);
}
...
vuint32m4_t 
test_vslidedown_vx_u32m4_vl32_0(vuint32m4_t op1)
{
  return vslidedown_vx_u32m4(op1, 0, 32);
}
...
vuint32m4_t 
test_vslidedown_vx_u32m4_vl32_31(vuint32m4_t op1)
{
  return vslidedown_vx_u32m4(op1, 31, 32);
}
...
vuint32m8_t 
test_vslidedown_vx_u32m8_vl32_0(vuint32m8_t op1)
{
  return vslidedown_vx_u32m8(op1, 0, 32);
}
...
vuint32m8_t 
test_vslidedown_vx_u32m8_vl32_31(vuint32m8_t op1)
{
  return vslidedown_vx_u32m8(op1, 31, 32);
}
...
vuint64m1_t 
test_vslidedown_vx_u64m1_vl32_0(vuint64m1_t op1)
{
  return vslidedown_vx_u64m1(op1, 0, 32);
}
...
vuint64m1_t 
test_vslidedown_vx_u64m1_vl32_31(vuint64m1_t op1)
{
  return vslidedown_vx_u64m1(op1, 31, 32);
}
...
vuint64m2_t 
test_vslidedown_vx_u64m2_vl32_0(vuint64m2_t op1)
{
  return vslidedown_vx_u64m2(op1, 0, 32);
}
...
vuint64m2_t 
test_vslidedown_vx_u64m2_vl32_31(vuint64m2_t op1)
{
  return vslidedown_vx_u64m2(op1, 31, 32);
}
...
vuint64m4_t 
test_vslidedown_vx_u64m4_vl32_0(vuint64m4_t op1)
{
  return vslidedown_vx_u64m4(op1, 0, 32);
}
...
vuint64m4_t 
test_vslidedown_vx_u64m4_vl32_31(vuint64m4_t op1)
{
  return vslidedown_vx_u64m4(op1, 31, 32);
}
...
vuint64m8_t 
test_vslidedown_vx_u64m8_vl32_0(vuint64m8_t op1)
{
  return vslidedown_vx_u64m8(op1, 0, 32);
}
...
vuint64m8_t 
test_vslidedown_vx_u64m8_vl32_31(vuint64m8_t op1)
{
  return vslidedown_vx_u64m8(op1, 31, 32);
}
