...
vuint8m2_t
test0_vloxei16_v_u8m2_m(vbool4_t mask,vuint8m2_t maskedoff,const uint8_t *base,vuint16m4_t bindex,size_t vl)
{
...
vuint8m2_t
test1_vloxei16_v_u8m2_m(vbool4_t mask,vuint8m2_t maskedoff,const uint8_t *base,vuint16m4_t bindex,size_t vl)
{
    return vloxei16_v_u8m2_m(mask, maskedoff, base, bindex, 7);
}
