...
void
test1_vsuxseg3ei16_v_u32mf2_m(vbool64_t mask,uint32_t *base,vuint16mf4_t bindex,vuint32mf2_t v0,vuint32mf2_t v1,vuint32mf2_t v2,size_t vl)
{
    vsuxseg3ei16_v_u32mf2_m(mask, base, bindex, v0, v1, v2, 22);
}
