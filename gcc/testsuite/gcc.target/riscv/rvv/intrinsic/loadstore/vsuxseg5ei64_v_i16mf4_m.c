...
void
test1_vsuxseg5ei64_v_i16mf4_m(vbool64_t mask,int16_t *base,vuint64m1_t bindex,vint16mf4_t v0,vint16mf4_t v1,vint16mf4_t v2,vint16mf4_t v3,vint16mf4_t v4,size_t vl)
{
