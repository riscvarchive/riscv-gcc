...
vint8mf8_t
test0_vluxei32_v_i8mf8(const int8_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vint8mf8_t
test1_vluxei32_v_i8mf8(const int8_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vluxei32_v_i8mf8(base, bindex, 14);
}
