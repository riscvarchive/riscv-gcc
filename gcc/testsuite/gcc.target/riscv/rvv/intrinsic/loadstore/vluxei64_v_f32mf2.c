...
vfloat32mf2_t
test0_vluxei64_v_f32mf2(const float32_t *base,vuint64m1_t bindex,size_t vl)
{
...
vfloat32mf2_t
test1_vluxei64_v_f32mf2(const float32_t *base,vuint64m1_t bindex,size_t vl)
{
    return vluxei64_v_f32mf2(base, bindex, 13);
}
