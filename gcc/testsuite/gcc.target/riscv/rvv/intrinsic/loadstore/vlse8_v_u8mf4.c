...
vuint8mf4_t
test0_vlse8_v_u8mf4(const uint8_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint8mf4_t
test1_vlse8_v_u8mf4(const uint8_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse8_v_u8mf4(base, bstride, 12);
}
