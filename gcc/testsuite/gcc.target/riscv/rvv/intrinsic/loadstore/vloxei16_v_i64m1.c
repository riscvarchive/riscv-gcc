...
vint64m1_t
test0_vloxei16_v_i64m1(const int64_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vint64m1_t
test1_vloxei16_v_i64m1(const int64_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vloxei16_v_i64m1(base, bindex, 22);
}
