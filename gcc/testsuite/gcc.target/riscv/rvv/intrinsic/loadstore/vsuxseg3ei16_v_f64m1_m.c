...
void
test1_vsuxseg3ei16_v_f64m1_m(vbool64_t mask,float64_t *base,vuint16mf4_t bindex,vfloat64m1_t v0,vfloat64m1_t v1,vfloat64m1_t v2,size_t vl)
{
    vsuxseg3ei16_v_f64m1_m(mask, base, bindex, v0, v1, v2, 2);
}
