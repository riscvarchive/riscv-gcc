...
vuint64m4_t
test0_vlse64_v_u64m4(const uint64_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint64m4_t
test1_vlse64_v_u64m4(const uint64_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse64_v_u64m4(base, bstride, 12);
}
