...
vuint16m2_t
test0_vluxei32_v_u16m2(const uint16_t *base,vuint32m4_t bindex,size_t vl)
{
...
vuint16m2_t
test1_vluxei32_v_u16m2(const uint16_t *base,vuint32m4_t bindex,size_t vl)
{
    return vluxei32_v_u16m2(base, bindex, 10);
}
