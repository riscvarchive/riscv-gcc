...
void
test1_vsuxseg4ei64_v_i32m1_m(vbool32_t mask,int32_t *base,vuint64m2_t bindex,vint32m1_t v0,vint32m1_t v1,vint32m1_t v2,vint32m1_t v3,size_t vl)
{
    vsuxseg4ei64_v_i32m1_m(mask, base, bindex, v0, v1, v2, v3, 15);
}
