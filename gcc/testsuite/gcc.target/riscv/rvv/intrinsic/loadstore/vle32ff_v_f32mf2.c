...
vfloat32mf2_t
test0_vle32ff_v_f32mf2(const float32_t *base,size_t *new_vl,size_t vl)
{
...
vfloat32mf2_t
test1_vle32ff_v_f32mf2(const float32_t *base,size_t *new_vl,size_t vl)
{
    return vle32ff_v_f32mf2(base, new_vl, 0);
}
