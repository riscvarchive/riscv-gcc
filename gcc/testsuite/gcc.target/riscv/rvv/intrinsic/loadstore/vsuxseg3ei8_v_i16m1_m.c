...
void
test1_vsuxseg3ei8_v_i16m1_m(vbool16_t mask,int16_t *base,vuint8mf2_t bindex,vint16m1_t v0,vint16m1_t v1,vint16m1_t v2,size_t vl)
{
    vsuxseg3ei8_v_i16m1_m(mask, base, bindex, v0, v1, v2, 8);
}
