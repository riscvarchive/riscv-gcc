...
vuint32mf2_t
test0_vle32_v_u32mf2_m(vbool64_t mask,vuint32mf2_t maskedoff,const uint32_t *base,size_t vl)
{
...
vuint32mf2_t
test1_vle32_v_u32mf2_m(vbool64_t mask,vuint32mf2_t maskedoff,const uint32_t *base,size_t vl)
{
    return vle32_v_u32mf2_m(mask, maskedoff, base, 31);
}
