...
vuint32m8_t
test0_vluxei16_v_u32m8_m(vbool4_t mask,vuint32m8_t maskedoff,const uint32_t *base,vuint16m4_t bindex,size_t vl)
{
...
vuint32m8_t
test1_vluxei16_v_u32m8_m(vbool4_t mask,vuint32m8_t maskedoff,const uint32_t *base,vuint16m4_t bindex,size_t vl)
{
    return vluxei16_v_u32m8_m(mask, maskedoff, base, bindex, 4);
}
