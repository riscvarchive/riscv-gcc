...
vfloat32m8_t
test0_vle32_v_f32m8_tu(vfloat32m8_t dest,const float32_t *base,size_t vl)
{
...
vfloat32m8_t
test1_vle32_v_f32m8_tu(vfloat32m8_t dest,const float32_t *base,size_t vl)
{
    return vle32_v_f32m8_tu(dest, base, 9);
}
