...
vuint8mf4_t
test0_vluxei64_v_u8mf4(const uint8_t *base,vuint64m2_t bindex,size_t vl)
{
...
vuint8mf4_t
test1_vluxei64_v_u8mf4(const uint8_t *base,vuint64m2_t bindex,size_t vl)
{
    return vluxei64_v_u8mf4(base, bindex, 27);
}
