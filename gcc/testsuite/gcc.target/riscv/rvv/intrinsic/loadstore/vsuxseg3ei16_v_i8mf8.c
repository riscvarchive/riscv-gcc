...
void
test1_vsuxseg3ei16_v_i8mf8(int8_t *base,vuint16mf4_t bindex,vint8mf8_t v0,vint8mf8_t v1,vint8mf8_t v2,size_t vl)
{
    vsuxseg3ei16_v_i8mf8(base, bindex, v0, v1, v2, 27);
}
