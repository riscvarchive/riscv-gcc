...
void
test1_vsuxseg2ei64_v_f32mf2_m(vbool64_t mask,float32_t *base,vuint64m1_t bindex,vfloat32mf2_t v0,vfloat32mf2_t v1,size_t vl)
{
    vsuxseg2ei64_v_f32mf2_m(mask, base, bindex, v0, v1, 6);
}
