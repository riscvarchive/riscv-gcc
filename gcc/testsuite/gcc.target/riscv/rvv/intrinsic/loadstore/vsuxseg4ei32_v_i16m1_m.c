...
void
test1_vsuxseg4ei32_v_i16m1_m(vbool16_t mask,int16_t *base,vuint32m2_t bindex,vint16m1_t v0,vint16m1_t v1,vint16m1_t v2,vint16m1_t v3,size_t vl)
{
    vsuxseg4ei32_v_i16m1_m(mask, base, bindex, v0, v1, v2, v3, 3);
}
