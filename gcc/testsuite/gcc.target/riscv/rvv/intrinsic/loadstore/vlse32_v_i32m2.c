...
vint32m2_t
test0_vlse32_v_i32m2(const int32_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint32m2_t
test1_vlse32_v_i32m2(const int32_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse32_v_i32m2(base, bstride, 17);
}
