...
void
test1_vsuxseg3ei16_v_u32m2_m(vbool16_t mask,uint32_t *base,vuint16m1_t bindex,vuint32m2_t v0,vuint32m2_t v1,vuint32m2_t v2,size_t vl)
{
    vsuxseg3ei16_v_u32m2_m(mask, base, bindex, v0, v1, v2, 19);
}
