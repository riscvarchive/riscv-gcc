...
vuint8mf2_t
test0_vle8_v_u8mf2_m(vbool16_t mask,vuint8mf2_t maskedoff,const uint8_t *base,size_t vl)
{
...
vuint8mf2_t
test1_vle8_v_u8mf2_m(vbool16_t mask,vuint8mf2_t maskedoff,const uint8_t *base,size_t vl)
{
    return vle8_v_u8mf2_m(mask, maskedoff, base, 30);
}
