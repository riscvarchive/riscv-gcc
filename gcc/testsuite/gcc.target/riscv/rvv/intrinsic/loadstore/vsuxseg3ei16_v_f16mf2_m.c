...
void
test1_vsuxseg3ei16_v_f16mf2_m(vbool32_t mask,float16_t *base,vuint16mf2_t bindex,vfloat16mf2_t v0,vfloat16mf2_t v1,vfloat16mf2_t v2,size_t vl)
{
    vsuxseg3ei16_v_f16mf2_m(mask, base, bindex, v0, v1, v2, 11);
}
