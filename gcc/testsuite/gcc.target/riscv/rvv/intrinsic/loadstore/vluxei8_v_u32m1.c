...
vuint32m1_t
test0_vluxei8_v_u32m1(const uint32_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vuint32m1_t
test1_vluxei8_v_u32m1(const uint32_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vluxei8_v_u32m1(base, bindex, 1);
}
