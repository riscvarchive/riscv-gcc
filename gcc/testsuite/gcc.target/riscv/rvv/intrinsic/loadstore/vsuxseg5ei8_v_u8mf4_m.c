...
void
test1_vsuxseg5ei8_v_u8mf4_m(vbool32_t mask,uint8_t *base,vuint8mf4_t bindex,vuint8mf4_t v0,vuint8mf4_t v1,vuint8mf4_t v2,vuint8mf4_t v3,vuint8mf4_t v4,size_t vl)
{
    vsuxseg5ei8_v_u8mf4_m(mask, base, bindex, v0, v1, v2, v3, v4, 0);
}
