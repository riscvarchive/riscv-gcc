...
vint16mf4_t
test0_vloxei64_v_i16mf4(const int16_t *base,vuint64m1_t bindex,size_t vl)
{
...
vint16mf4_t
test1_vloxei64_v_i16mf4(const int16_t *base,vuint64m1_t bindex,size_t vl)
{
    return vloxei64_v_i16mf4(base, bindex, 19);
}
