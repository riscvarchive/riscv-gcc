...
vint32m4_t
test0_vluxei64_v_i32m4(const int32_t *base,vuint64m8_t bindex,size_t vl)
{
...
vint32m4_t
test1_vluxei64_v_i32m4(const int32_t *base,vuint64m8_t bindex,size_t vl)
{
    return vluxei64_v_i32m4(base, bindex, 30);
}
