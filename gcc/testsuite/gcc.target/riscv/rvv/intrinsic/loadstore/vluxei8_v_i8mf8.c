...
vint8mf8_t
test0_vluxei8_v_i8mf8(const int8_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vint8mf8_t
test1_vluxei8_v_i8mf8(const int8_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vluxei8_v_i8mf8(base, bindex, 27);
}
