...
void
test1_vsuxseg3ei16_v_f64m2(float64_t *base,vuint16mf2_t bindex,vfloat64m2_t v0,vfloat64m2_t v1,vfloat64m2_t v2,size_t vl)
{
    vsuxseg3ei16_v_f64m2(base, bindex, v0, v1, v2, 30);
}
