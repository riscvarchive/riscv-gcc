...
void
test1_vsuxseg2ei8_v_f16mf4_m(vbool64_t mask,float16_t *base,vuint8mf8_t bindex,vfloat16mf4_t v0,vfloat16mf4_t v1,size_t vl)
{
    vsuxseg2ei8_v_f16mf4_m(mask, base, bindex, v0, v1, 8);
}
