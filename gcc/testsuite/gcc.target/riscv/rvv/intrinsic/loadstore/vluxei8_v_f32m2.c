...
vfloat32m2_t
test0_vluxei8_v_f32m2(const float32_t *base,vuint8mf2_t bindex,size_t vl)
{
...
vfloat32m2_t
test1_vluxei8_v_f32m2(const float32_t *base,vuint8mf2_t bindex,size_t vl)
{
    return vluxei8_v_f32m2(base, bindex, 30);
}
