...
vuint64m2_t
test0_vloxei8_v_u64m2_m(vbool32_t mask,vuint64m2_t maskedoff,const uint64_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vuint64m2_t
test1_vloxei8_v_u64m2_m(vbool32_t mask,vuint64m2_t maskedoff,const uint64_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vloxei8_v_u64m2_m(mask, maskedoff, base, bindex, 31);
}
