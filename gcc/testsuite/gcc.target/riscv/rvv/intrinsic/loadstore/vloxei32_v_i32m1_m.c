...
vint32m1_t
test0_vloxei32_v_i32m1_m(vbool32_t mask,vint32m1_t maskedoff,const int32_t *base,vuint32m1_t bindex,size_t vl)
{
...
vint32m1_t
test1_vloxei32_v_i32m1_m(vbool32_t mask,vint32m1_t maskedoff,const int32_t *base,vuint32m1_t bindex,size_t vl)
{
    return vloxei32_v_i32m1_m(mask, maskedoff, base, bindex, 31);
}
