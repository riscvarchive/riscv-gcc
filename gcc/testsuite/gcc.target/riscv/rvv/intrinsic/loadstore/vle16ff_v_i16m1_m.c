...
vint16m1_t
test0_vle16ff_v_i16m1_m(vbool16_t mask,vint16m1_t maskedoff,const int16_t *base,size_t *new_vl,size_t vl)
{
...
vint16m1_t
test1_vle16ff_v_i16m1_m(vbool16_t mask,vint16m1_t maskedoff,const int16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_i16m1_m(mask, maskedoff, base, new_vl, 11);
}
