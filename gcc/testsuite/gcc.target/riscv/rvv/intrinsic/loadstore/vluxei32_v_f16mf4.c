...
vfloat16mf4_t
test0_vluxei32_v_f16mf4(const float16_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vfloat16mf4_t
test1_vluxei32_v_f16mf4(const float16_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vluxei32_v_f16mf4(base, bindex, 24);
}
