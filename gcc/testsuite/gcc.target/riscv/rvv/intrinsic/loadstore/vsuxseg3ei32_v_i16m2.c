...
void
test1_vsuxseg3ei32_v_i16m2(int16_t *base,vuint32m4_t bindex,vint16m2_t v0,vint16m2_t v1,vint16m2_t v2,size_t vl)
{
    vsuxseg3ei32_v_i16m2(base, bindex, v0, v1, v2, 4);
}
