...
void
test1_vsuxseg4ei8_v_u8mf8(uint8_t *base,vuint8mf8_t bindex,vuint8mf8_t v0,vuint8mf8_t v1,vuint8mf8_t v2,vuint8mf8_t v3,size_t vl)
{
    vsuxseg4ei8_v_u8mf8(base, bindex, v0, v1, v2, v3, 14);
}
