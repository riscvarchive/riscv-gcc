...
vint16m1_t
test0_vluxei32_v_i16m1_m(vbool16_t mask,vint16m1_t maskedoff,const int16_t *base,vuint32m2_t bindex,size_t vl)
{
...
vint16m1_t
test1_vluxei32_v_i16m1_m(vbool16_t mask,vint16m1_t maskedoff,const int16_t *base,vuint32m2_t bindex,size_t vl)
{
    return vluxei32_v_i16m1_m(mask, maskedoff, base, bindex, 1);
}
