...
vfloat16mf4_t
test0_vluxei64_v_f16mf4(const float16_t *base,vuint64m1_t bindex,size_t vl)
{
...
vfloat16mf4_t
test1_vluxei64_v_f16mf4(const float16_t *base,vuint64m1_t bindex,size_t vl)
{
    return vluxei64_v_f16mf4(base, bindex, 21);
}
