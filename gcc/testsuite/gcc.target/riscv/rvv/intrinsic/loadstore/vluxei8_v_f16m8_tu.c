...
vfloat16m8_t
test0_vluxei8_v_f16m8_tu(vfloat16m8_t dest,const float16_t *base,vuint8m4_t bindex,size_t vl)
{
...
vfloat16m8_t
test1_vluxei8_v_f16m8_tu(vfloat16m8_t dest,const float16_t *base,vuint8m4_t bindex,size_t vl)
{
    return vluxei8_v_f16m8_tu(dest, base, bindex, 29);
}
