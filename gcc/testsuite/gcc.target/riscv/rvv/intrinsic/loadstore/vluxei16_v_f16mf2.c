...
vfloat16mf2_t
test0_vluxei16_v_f16mf2(const float16_t *base,vuint16mf2_t bindex,size_t vl)
{
...
vfloat16mf2_t
test1_vluxei16_v_f16mf2(const float16_t *base,vuint16mf2_t bindex,size_t vl)
{
    return vluxei16_v_f16mf2(base, bindex, 5);
}
