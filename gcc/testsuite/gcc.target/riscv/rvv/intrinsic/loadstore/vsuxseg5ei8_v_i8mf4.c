...
void
test1_vsuxseg5ei8_v_i8mf4(int8_t *base,vuint8mf4_t bindex,vint8mf4_t v0,vint8mf4_t v1,vint8mf4_t v2,vint8mf4_t v3,vint8mf4_t v4,size_t vl)
{
    vsuxseg5ei8_v_i8mf4(base, bindex, v0, v1, v2, v3, v4, 18);
}
