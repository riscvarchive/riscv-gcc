...
vuint16mf4_t
test0_vluxei32_v_u16mf4(const uint16_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vuint16mf4_t
test1_vluxei32_v_u16mf4(const uint16_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vluxei32_v_u16mf4(base, bindex, 9);
}
