...
void
test1_vsuxseg2ei8_v_u32m2_m(vbool16_t mask,uint32_t *base,vuint8mf2_t bindex,vuint32m2_t v0,vuint32m2_t v1,size_t vl)
{
    vsuxseg2ei8_v_u32m2_m(mask, base, bindex, v0, v1, 16);
}
