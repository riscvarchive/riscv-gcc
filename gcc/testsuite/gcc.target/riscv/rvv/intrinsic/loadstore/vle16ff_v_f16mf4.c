...
vfloat16mf4_t
test0_vle16ff_v_f16mf4(const float16_t *base,size_t *new_vl,size_t vl)
{
...
vfloat16mf4_t
test1_vle16ff_v_f16mf4(const float16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_f16mf4(base, new_vl, 23);
}
