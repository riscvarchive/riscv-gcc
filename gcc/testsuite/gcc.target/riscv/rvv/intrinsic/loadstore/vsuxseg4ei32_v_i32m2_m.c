...
void
test1_vsuxseg4ei32_v_i32m2_m(vbool16_t mask,int32_t *base,vuint32m2_t bindex,vint32m2_t v0,vint32m2_t v1,vint32m2_t v2,vint32m2_t v3,size_t vl)
{
    vsuxseg4ei32_v_i32m2_m(mask, base, bindex, v0, v1, v2, v3, 23);
}
