...
void
test1_vsuxseg6ei16_v_u16mf2(uint16_t *base,vuint16mf2_t bindex,vuint16mf2_t v0,vuint16mf2_t v1,vuint16mf2_t v2,vuint16mf2_t v3,vuint16mf2_t v4,vuint16mf2_t v5,size_t vl)
{
    vsuxseg6ei16_v_u16mf2(base, bindex, v0, v1, v2, v3, v4, v5, 16);
}
