...
void
test1_vsuxseg3ei16_v_u8mf8_m(vbool64_t mask,uint8_t *base,vuint16mf4_t bindex,vuint8mf8_t v0,vuint8mf8_t v1,vuint8mf8_t v2,size_t vl)
{
    vsuxseg3ei16_v_u8mf8_m(mask, base, bindex, v0, v1, v2, 23);
}
