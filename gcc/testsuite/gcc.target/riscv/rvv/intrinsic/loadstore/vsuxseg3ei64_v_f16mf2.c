...
void
test1_vsuxseg3ei64_v_f16mf2(float16_t *base,vuint64m2_t bindex,vfloat16mf2_t v0,vfloat16mf2_t v1,vfloat16mf2_t v2,size_t vl)
{
    vsuxseg3ei64_v_f16mf2(base, bindex, v0, v1, v2, 29);
}
