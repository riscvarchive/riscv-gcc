...
void
test1_vsuxseg6ei16_v_i16m1(int16_t *base,vuint16m1_t bindex,vint16m1_t v0,vint16m1_t v1,vint16m1_t v2,vint16m1_t v3,vint16m1_t v4,vint16m1_t v5,size_t vl)
{
    vsuxseg6ei16_v_i16m1(base, bindex, v0, v1, v2, v3, v4, v5, 20);
}
