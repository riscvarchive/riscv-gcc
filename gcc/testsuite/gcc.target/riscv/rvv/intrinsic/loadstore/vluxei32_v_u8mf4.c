...
vuint8mf4_t
test0_vluxei32_v_u8mf4(const uint8_t *base,vuint32m1_t bindex,size_t vl)
{
...
vuint8mf4_t
test1_vluxei32_v_u8mf4(const uint8_t *base,vuint32m1_t bindex,size_t vl)
{
    return vluxei32_v_u8mf4(base, bindex, 16);
}
