...
vint16m4_t
test0_vluxei8_v_i16m4_m(vbool4_t mask,vint16m4_t maskedoff,const int16_t *base,vuint8m2_t bindex,size_t vl)
{
...
vint16m4_t
test1_vluxei8_v_i16m4_m(vbool4_t mask,vint16m4_t maskedoff,const int16_t *base,vuint8m2_t bindex,size_t vl)
{
    return vluxei8_v_i16m4_m(mask, maskedoff, base, bindex, 8);
}
