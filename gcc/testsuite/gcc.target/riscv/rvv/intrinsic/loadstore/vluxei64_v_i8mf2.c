...
vint8mf2_t
test0_vluxei64_v_i8mf2(const int8_t *base,vuint64m4_t bindex,size_t vl)
{
...
vint8mf2_t
test1_vluxei64_v_i8mf2(const int8_t *base,vuint64m4_t bindex,size_t vl)
{
    return vluxei64_v_i8mf2(base, bindex, 29);
}
