...
void
test1_vsuxseg2ei32_v_f16m2_m(vbool8_t mask,float16_t *base,vuint32m4_t bindex,vfloat16m2_t v0,vfloat16m2_t v1,size_t vl)
{
    vsuxseg2ei32_v_f16m2_m(mask, base, bindex, v0, v1, 10);
}
