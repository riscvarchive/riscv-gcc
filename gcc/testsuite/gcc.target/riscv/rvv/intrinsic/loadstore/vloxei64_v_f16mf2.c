...
vfloat16mf2_t
test0_vloxei64_v_f16mf2(const float16_t *base,vuint64m2_t bindex,size_t vl)
{
...
vfloat16mf2_t
test1_vloxei64_v_f16mf2(const float16_t *base,vuint64m2_t bindex,size_t vl)
{
    return vloxei64_v_f16mf2(base, bindex, 14);
}
