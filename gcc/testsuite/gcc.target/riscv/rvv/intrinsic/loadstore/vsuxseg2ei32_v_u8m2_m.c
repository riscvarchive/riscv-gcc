...
void
test1_vsuxseg2ei32_v_u8m2_m(vbool4_t mask,uint8_t *base,vuint32m8_t bindex,vuint8m2_t v0,vuint8m2_t v1,size_t vl)
{
    vsuxseg2ei32_v_u8m2_m(mask, base, bindex, v0, v1, 4);
}
