...
void
test1_vsuxseg4ei8_v_f64m1_m(vbool64_t mask,float64_t *base,vuint8mf8_t bindex,vfloat64m1_t v0,vfloat64m1_t v1,vfloat64m1_t v2,vfloat64m1_t v3,size_t vl)
{
    vsuxseg4ei8_v_f64m1_m(mask, base, bindex, v0, v1, v2, v3, 29);
}
