...
vfloat64m8_t
test0_vluxei8_v_f64m8_m(vbool8_t mask,vfloat64m8_t maskedoff,const float64_t *base,vuint8m1_t bindex,size_t vl)
{
...
vfloat64m8_t
test1_vluxei8_v_f64m8_m(vbool8_t mask,vfloat64m8_t maskedoff,const float64_t *base,vuint8m1_t bindex,size_t vl)
{
    return vluxei8_v_f64m8_m(mask, maskedoff, base, bindex, 14);
}
