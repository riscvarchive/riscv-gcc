...
vfloat32m1_t
test0_vloxei64_v_f32m1_m(vbool32_t mask,vfloat32m1_t maskedoff,const float32_t *base,vuint64m2_t bindex,size_t vl)
{
...
vfloat32m1_t
test1_vloxei64_v_f32m1_m(vbool32_t mask,vfloat32m1_t maskedoff,const float32_t *base,vuint64m2_t bindex,size_t vl)
{
    return vloxei64_v_f32m1_m(mask, maskedoff, base, bindex, 14);
}
