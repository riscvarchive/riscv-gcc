...
vuint8mf2_t
test0_vlse8_v_u8mf2_tu(vuint8mf2_t dest,const uint8_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint8mf2_t
test1_vlse8_v_u8mf2_tu(vuint8mf2_t dest,const uint8_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse8_v_u8mf2_tu(dest, base, bstride, 29);
}
