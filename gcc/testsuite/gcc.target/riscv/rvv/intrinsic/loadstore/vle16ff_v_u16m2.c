...
vuint16m2_t
test0_vle16ff_v_u16m2(const uint16_t *base,size_t *new_vl,size_t vl)
{
...
vuint16m2_t
test1_vle16ff_v_u16m2(const uint16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_u16m2(base, new_vl, 0);
}
