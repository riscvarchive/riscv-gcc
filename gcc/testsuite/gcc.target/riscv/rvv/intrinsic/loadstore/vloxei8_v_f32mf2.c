...
vfloat32mf2_t
test0_vloxei8_v_f32mf2(const float32_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vfloat32mf2_t
test1_vloxei8_v_f32mf2(const float32_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vloxei8_v_f32mf2(base, bindex, 21);
}
