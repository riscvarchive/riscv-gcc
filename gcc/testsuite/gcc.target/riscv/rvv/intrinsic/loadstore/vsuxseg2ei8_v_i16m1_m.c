...
void
test1_vsuxseg2ei8_v_i16m1_m(vbool16_t mask,int16_t *base,vuint8mf2_t bindex,vint16m1_t v0,vint16m1_t v1,size_t vl)
{
    vsuxseg2ei8_v_i16m1_m(mask, base, bindex, v0, v1, 8);
}
