...
vint16mf2_t
test0_vle16_v_i16mf2_m(vbool32_t mask,vint16mf2_t maskedoff,const int16_t *base,size_t vl)
{
...
vint16mf2_t
test1_vle16_v_i16mf2_m(vbool32_t mask,vint16mf2_t maskedoff,const int16_t *base,size_t vl)
{
    return vle16_v_i16mf2_m(mask, maskedoff, base, 14);
}
