...
void
test1_vsuxseg2ei8_v_f16mf2_m(vbool32_t mask,float16_t *base,vuint8mf4_t bindex,vfloat16mf2_t v0,vfloat16mf2_t v1,size_t vl)
{
    vsuxseg2ei8_v_f16mf2_m(mask, base, bindex, v0, v1, 20);
}
