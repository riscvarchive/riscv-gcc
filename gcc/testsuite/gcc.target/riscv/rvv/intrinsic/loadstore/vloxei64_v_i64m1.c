...
vint64m1_t
test0_vloxei64_v_i64m1(const int64_t *base,vuint64m1_t bindex,size_t vl)
{
...
vint64m1_t
test1_vloxei64_v_i64m1(const int64_t *base,vuint64m1_t bindex,size_t vl)
{
    return vloxei64_v_i64m1(base, bindex, 13);
}
