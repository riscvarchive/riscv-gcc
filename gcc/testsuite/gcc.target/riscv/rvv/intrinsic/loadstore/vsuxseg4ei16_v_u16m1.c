...
void
test1_vsuxseg4ei16_v_u16m1(uint16_t *base,vuint16m1_t bindex,vuint16m1_t v0,vuint16m1_t v1,vuint16m1_t v2,vuint16m1_t v3,size_t vl)
{
    vsuxseg4ei16_v_u16m1(base, bindex, v0, v1, v2, v3, 16);
}
