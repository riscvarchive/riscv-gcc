...
vfloat16mf4_t
test0_vloxei16_v_f16mf4(const float16_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vfloat16mf4_t
test1_vloxei16_v_f16mf4(const float16_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vloxei16_v_f16mf4(base, bindex, 28);
}
