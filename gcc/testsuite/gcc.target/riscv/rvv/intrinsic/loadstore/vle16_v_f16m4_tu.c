...
vfloat16m4_t
test0_vle16_v_f16m4_tu(vfloat16m4_t dest,const float16_t *base,size_t vl)
{
...
vfloat16m4_t
test1_vle16_v_f16m4_tu(vfloat16m4_t dest,const float16_t *base,size_t vl)
{
    return vle16_v_f16m4_tu(dest, base, 4);
}
