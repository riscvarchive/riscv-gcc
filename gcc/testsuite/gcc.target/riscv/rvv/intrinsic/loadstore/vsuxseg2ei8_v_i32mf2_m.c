...
void
test1_vsuxseg2ei8_v_i32mf2_m(vbool64_t mask,int32_t *base,vuint8mf8_t bindex,vint32mf2_t v0,vint32mf2_t v1,size_t vl)
{
    vsuxseg2ei8_v_i32mf2_m(mask, base, bindex, v0, v1, 11);
}
