...
vint64m8_t
test0_vloxei16_v_i64m8(const int64_t *base,vuint16m2_t bindex,size_t vl)
{
...
vint64m8_t
test1_vloxei16_v_i64m8(const int64_t *base,vuint16m2_t bindex,size_t vl)
{
    return vloxei16_v_i64m8(base, bindex, 13);
}
