...
vint16m2_t
test0_vloxei32_v_i16m2_m(vbool8_t mask,vint16m2_t maskedoff,const int16_t *base,vuint32m4_t bindex,size_t vl)
{
...
vint16m2_t
test1_vloxei32_v_i16m2_m(vbool8_t mask,vint16m2_t maskedoff,const int16_t *base,vuint32m4_t bindex,size_t vl)
{
    return vloxei32_v_i16m2_m(mask, maskedoff, base, bindex, 28);
}
