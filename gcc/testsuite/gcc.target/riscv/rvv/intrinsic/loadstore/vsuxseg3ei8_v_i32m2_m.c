...
void
test1_vsuxseg3ei8_v_i32m2_m(vbool16_t mask,int32_t *base,vuint8mf2_t bindex,vint32m2_t v0,vint32m2_t v1,vint32m2_t v2,size_t vl)
{
    vsuxseg3ei8_v_i32m2_m(mask, base, bindex, v0, v1, v2, 16);
}
