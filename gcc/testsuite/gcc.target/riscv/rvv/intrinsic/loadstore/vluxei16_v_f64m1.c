...
vfloat64m1_t
test0_vluxei16_v_f64m1(const float64_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vfloat64m1_t
test1_vluxei16_v_f64m1(const float64_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vluxei16_v_f64m1(base, bindex, 22);
}
