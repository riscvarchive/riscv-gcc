...
void
test1_vsuxseg3ei8_v_u64m2(uint64_t *base,vuint8mf4_t bindex,vuint64m2_t v0,vuint64m2_t v1,vuint64m2_t v2,size_t vl)
{
    vsuxseg3ei8_v_u64m2(base, bindex, v0, v1, v2, 11);
}
