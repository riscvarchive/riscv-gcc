...
vfloat16m2_t
test0_vloxei32_v_f16m2(const float16_t *base,vuint32m4_t bindex,size_t vl)
{
...
vfloat16m2_t
test1_vloxei32_v_f16m2(const float16_t *base,vuint32m4_t bindex,size_t vl)
{
    return vloxei32_v_f16m2(base, bindex, 22);
}
