...
void
test1_vsuxseg4ei16_v_f16m2(float16_t *base,vuint16m2_t bindex,vfloat16m2_t v0,vfloat16m2_t v1,vfloat16m2_t v2,vfloat16m2_t v3,size_t vl)
{
    vsuxseg4ei16_v_f16m2(base, bindex, v0, v1, v2, v3, 27);
}
