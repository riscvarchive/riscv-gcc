...
vfloat16m2_t
test0_vloxei16_v_f16m2_m(vbool8_t mask,vfloat16m2_t maskedoff,const float16_t *base,vuint16m2_t bindex,size_t vl)
{
...
vfloat16m2_t
test1_vloxei16_v_f16m2_m(vbool8_t mask,vfloat16m2_t maskedoff,const float16_t *base,vuint16m2_t bindex,size_t vl)
{
    return vloxei16_v_f16m2_m(mask, maskedoff, base, bindex, 18);
}
