...
void
test1_vsuxseg5ei16_v_u16m1_m(vbool16_t mask,uint16_t *base,vuint16m1_t bindex,vuint16m1_t v0,vuint16m1_t v1,vuint16m1_t v2,vuint16m1_t v3,vuint16m1_t v4,size_t vl)
{
    vsuxseg5ei16_v_u16m1_m(mask, base, bindex, v0, v1, v2, v3, v4, 20);
}
