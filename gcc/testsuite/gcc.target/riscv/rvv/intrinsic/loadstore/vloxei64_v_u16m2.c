...
vuint16m2_t
test0_vloxei64_v_u16m2(const uint16_t *base,vuint64m8_t bindex,size_t vl)
{
...
vuint16m2_t
test1_vloxei64_v_u16m2(const uint16_t *base,vuint64m8_t bindex,size_t vl)
{
    return vloxei64_v_u16m2(base, bindex, 22);
}
