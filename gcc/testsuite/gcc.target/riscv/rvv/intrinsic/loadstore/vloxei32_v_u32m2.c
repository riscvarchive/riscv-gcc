...
vuint32m2_t
test0_vloxei32_v_u32m2(const uint32_t *base,vuint32m2_t bindex,size_t vl)
{
...
vuint32m2_t
test1_vloxei32_v_u32m2(const uint32_t *base,vuint32m2_t bindex,size_t vl)
{
    return vloxei32_v_u32m2(base, bindex, 30);
}
