...
vuint16m2_t
test0_vloxei8_v_u16m2_m(vbool8_t mask,vuint16m2_t maskedoff,const uint16_t *base,vuint8m1_t bindex,size_t vl)
{
...
vuint16m2_t
test1_vloxei8_v_u16m2_m(vbool8_t mask,vuint16m2_t maskedoff,const uint16_t *base,vuint8m1_t bindex,size_t vl)
{
    return vloxei8_v_u16m2_m(mask, maskedoff, base, bindex, 28);
}
