...
void
test1_vsuxseg4ei64_v_f64m2_m(vbool32_t mask,float64_t *base,vuint64m2_t bindex,vfloat64m2_t v0,vfloat64m2_t v1,vfloat64m2_t v2,vfloat64m2_t v3,size_t vl)
{
    vsuxseg4ei64_v_f64m2_m(mask, base, bindex, v0, v1, v2, v3, 27);
}
