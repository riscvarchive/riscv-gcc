...
void
test1_vsuxseg5ei32_v_u16mf2(uint16_t *base,vuint32m1_t bindex,vuint16mf2_t v0,vuint16mf2_t v1,vuint16mf2_t v2,vuint16mf2_t v3,vuint16mf2_t v4,size_t vl)
{
    vsuxseg5ei32_v_u16mf2(base, bindex, v0, v1, v2, v3, v4, 26);
}
