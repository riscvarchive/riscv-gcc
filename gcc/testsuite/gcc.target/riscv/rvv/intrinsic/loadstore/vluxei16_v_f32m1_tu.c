...
vfloat32m1_t
test0_vluxei16_v_f32m1_tu(vfloat32m1_t dest,const float32_t *base,vuint16mf2_t bindex,size_t vl)
{
...
vfloat32m1_t
test1_vluxei16_v_f32m1_tu(vfloat32m1_t dest,const float32_t *base,vuint16mf2_t bindex,size_t vl)
{
    return vluxei16_v_f32m1_tu(dest, base, bindex, 29);
}
