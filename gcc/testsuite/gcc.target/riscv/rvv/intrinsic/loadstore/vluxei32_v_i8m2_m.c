...
vint8m2_t
test0_vluxei32_v_i8m2_m(vbool4_t mask,vint8m2_t maskedoff,const int8_t *base,vuint32m8_t bindex,size_t vl)
{
...
vint8m2_t
test1_vluxei32_v_i8m2_m(vbool4_t mask,vint8m2_t maskedoff,const int8_t *base,vuint32m8_t bindex,size_t vl)
{
    return vluxei32_v_i8m2_m(mask, maskedoff, base, bindex, 27);
}
