...
vfloat16m1_t
test0_vloxei8_v_f16m1(const float16_t *base,vuint8mf2_t bindex,size_t vl)
{
...
vfloat16m1_t
test1_vloxei8_v_f16m1(const float16_t *base,vuint8mf2_t bindex,size_t vl)
{
    return vloxei8_v_f16m1(base, bindex, 4);
}
