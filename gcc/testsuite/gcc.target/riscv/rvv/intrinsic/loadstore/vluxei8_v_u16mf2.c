...
vuint16mf2_t
test0_vluxei8_v_u16mf2(const uint16_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vuint16mf2_t
test1_vluxei8_v_u16mf2(const uint16_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vluxei8_v_u16mf2(base, bindex, 29);
}
