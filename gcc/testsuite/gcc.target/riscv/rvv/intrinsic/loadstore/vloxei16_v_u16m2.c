...
vuint16m2_t
test0_vloxei16_v_u16m2(const uint16_t *base,vuint16m2_t bindex,size_t vl)
{
...
vuint16m2_t
test1_vloxei16_v_u16m2(const uint16_t *base,vuint16m2_t bindex,size_t vl)
{
    return vloxei16_v_u16m2(base, bindex, 2);
}
