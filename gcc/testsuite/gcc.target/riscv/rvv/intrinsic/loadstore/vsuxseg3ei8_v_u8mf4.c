...
void
test1_vsuxseg3ei8_v_u8mf4(uint8_t *base,vuint8mf4_t bindex,vuint8mf4_t v0,vuint8mf4_t v1,vuint8mf4_t v2,size_t vl)
{
    vsuxseg3ei8_v_u8mf4(base, bindex, v0, v1, v2, 0);
}
