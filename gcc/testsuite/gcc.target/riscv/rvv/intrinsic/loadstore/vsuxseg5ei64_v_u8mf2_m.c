...
void
test1_vsuxseg5ei64_v_u8mf2_m(vbool16_t mask,uint8_t *base,vuint64m4_t bindex,vuint8mf2_t v0,vuint8mf2_t v1,vuint8mf2_t v2,vuint8mf2_t v3,vuint8mf2_t v4,size_t vl)
{
    vsuxseg5ei64_v_u8mf2_m(mask, base, bindex, v0, v1, v2, v3, v4, 21);
}
