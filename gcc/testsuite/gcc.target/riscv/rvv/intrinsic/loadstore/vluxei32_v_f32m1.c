...
vfloat32m1_t
test0_vluxei32_v_f32m1(const float32_t *base,vuint32m1_t bindex,size_t vl)
{
...
vfloat32m1_t
test1_vluxei32_v_f32m1(const float32_t *base,vuint32m1_t bindex,size_t vl)
{
    return vluxei32_v_f32m1(base, bindex, 11);
}
