...
vint16m2_t
test0_vloxei16_v_i16m2(const int16_t *base,vuint16m2_t bindex,size_t vl)
{
...
vint16m2_t
test1_vloxei16_v_i16m2(const int16_t *base,vuint16m2_t bindex,size_t vl)
{
    return vloxei16_v_i16m2(base, bindex, 0);
}
