...
void
test1_vsuxseg2ei32_v_u8mf4_m(vbool32_t mask,uint8_t *base,vuint32m1_t bindex,vuint8mf4_t v0,vuint8mf4_t v1,size_t vl)
{
    vsuxseg2ei32_v_u8mf4_m(mask, base, bindex, v0, v1, 17);
}
