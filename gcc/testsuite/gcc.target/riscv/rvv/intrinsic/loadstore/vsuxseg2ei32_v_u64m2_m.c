...
void
test1_vsuxseg2ei32_v_u64m2_m(vbool32_t mask,uint64_t *base,vuint32m1_t bindex,vuint64m2_t v0,vuint64m2_t v1,size_t vl)
{
    vsuxseg2ei32_v_u64m2_m(mask, base, bindex, v0, v1, 25);
}
