...
void
test1_vsuxseg3ei32_v_i8m2_m(vbool4_t mask,int8_t *base,vuint32m8_t bindex,vint8m2_t v0,vint8m2_t v1,vint8m2_t v2,size_t vl)
{
    vsuxseg3ei32_v_i8m2_m(mask, base, bindex, v0, v1, v2, 23);
}
