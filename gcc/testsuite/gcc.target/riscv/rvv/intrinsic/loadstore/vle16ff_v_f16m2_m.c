...
vfloat16m2_t
test0_vle16ff_v_f16m2_m(vbool8_t mask,vfloat16m2_t maskedoff,const float16_t *base,size_t *new_vl,size_t vl)
{
...
vfloat16m2_t
test1_vle16ff_v_f16m2_m(vbool8_t mask,vfloat16m2_t maskedoff,const float16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_f16m2_m(mask, maskedoff, base, new_vl, 18);
}
