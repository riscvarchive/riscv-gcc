...
vfloat32m8_t
test0_vluxei16_v_f32m8_tu(vfloat32m8_t dest,const float32_t *base,vuint16m4_t bindex,size_t vl)
{
...
vfloat32m8_t
test1_vluxei16_v_f32m8_tu(vfloat32m8_t dest,const float32_t *base,vuint16m4_t bindex,size_t vl)
{
    return vluxei16_v_f32m8_tu(dest, base, bindex, 30);
}
