...
void
test1_vsuxseg4ei64_v_i8mf8(int8_t *base,vuint64m1_t bindex,vint8mf8_t v0,vint8mf8_t v1,vint8mf8_t v2,vint8mf8_t v3,size_t vl)
{
    vsuxseg4ei64_v_i8mf8(base, bindex, v0, v1, v2, v3, 0);
}
