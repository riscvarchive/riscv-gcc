...
void
test1_vsuxseg4ei16_v_f16m1_m(vbool16_t mask,float16_t *base,vuint16m1_t bindex,vfloat16m1_t v0,vfloat16m1_t v1,vfloat16m1_t v2,vfloat16m1_t v3,size_t vl)
{
    vsuxseg4ei16_v_f16m1_m(mask, base, bindex, v0, v1, v2, v3, 13);
}
