...
void
test1_vsuxseg3ei8_v_i32m1(int32_t *base,vuint8mf4_t bindex,vint32m1_t v0,vint32m1_t v1,vint32m1_t v2,size_t vl)
{
    vsuxseg3ei8_v_i32m1(base, bindex, v0, v1, v2, 8);
}
