...
vint16mf2_t
test0_vlse16_v_i16mf2_m(vbool32_t mask,vint16mf2_t maskedoff,const int16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint16mf2_t
test1_vlse16_v_i16mf2_m(vbool32_t mask,vint16mf2_t maskedoff,const int16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_i16mf2_m(mask, maskedoff, base, bstride, 19);
}
