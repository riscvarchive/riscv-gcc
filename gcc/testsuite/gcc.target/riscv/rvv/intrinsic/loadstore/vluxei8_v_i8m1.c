...
vint8m1_t
test0_vluxei8_v_i8m1(const int8_t *base,vuint8m1_t bindex,size_t vl)
{
...
vint8m1_t
test1_vluxei8_v_i8m1(const int8_t *base,vuint8m1_t bindex,size_t vl)
{
    return vluxei8_v_i8m1(base, bindex, 7);
}
