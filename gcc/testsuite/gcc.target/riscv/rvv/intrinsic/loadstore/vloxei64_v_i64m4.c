...
vint64m4_t
test0_vloxei64_v_i64m4(const int64_t *base,vuint64m4_t bindex,size_t vl)
{
...
vint64m4_t
test1_vloxei64_v_i64m4(const int64_t *base,vuint64m4_t bindex,size_t vl)
{
    return vloxei64_v_i64m4(base, bindex, 21);
}
