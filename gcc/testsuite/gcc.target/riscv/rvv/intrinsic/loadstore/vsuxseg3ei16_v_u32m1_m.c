...
void
test1_vsuxseg3ei16_v_u32m1_m(vbool32_t mask,uint32_t *base,vuint16mf2_t bindex,vuint32m1_t v0,vuint32m1_t v1,vuint32m1_t v2,size_t vl)
{
    vsuxseg3ei16_v_u32m1_m(mask, base, bindex, v0, v1, v2, 10);
}
