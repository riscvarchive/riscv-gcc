...
vuint16m1_t
test0_vle16_v_u16m1_m(vbool16_t mask,vuint16m1_t maskedoff,const uint16_t *base,size_t vl)
{
...
vuint16m1_t
test1_vle16_v_u16m1_m(vbool16_t mask,vuint16m1_t maskedoff,const uint16_t *base,size_t vl)
{
    return vle16_v_u16m1_m(mask, maskedoff, base, 22);
}
