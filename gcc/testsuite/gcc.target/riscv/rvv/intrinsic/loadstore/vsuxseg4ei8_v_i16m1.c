...
void
test1_vsuxseg4ei8_v_i16m1(int16_t *base,vuint8mf2_t bindex,vint16m1_t v0,vint16m1_t v1,vint16m1_t v2,vint16m1_t v3,size_t vl)
{
    vsuxseg4ei8_v_i16m1(base, bindex, v0, v1, v2, v3, 20);
}
