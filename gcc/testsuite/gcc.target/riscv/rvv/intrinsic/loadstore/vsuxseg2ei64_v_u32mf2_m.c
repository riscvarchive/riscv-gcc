...
void
test1_vsuxseg2ei64_v_u32mf2_m(vbool64_t mask,uint32_t *base,vuint64m1_t bindex,vuint32mf2_t v0,vuint32mf2_t v1,size_t vl)
{
    vsuxseg2ei64_v_u32mf2_m(mask, base, bindex, v0, v1, 8);
}
