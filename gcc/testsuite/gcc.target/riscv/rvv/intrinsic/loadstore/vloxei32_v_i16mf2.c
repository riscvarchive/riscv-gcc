...
vint16mf2_t
test0_vloxei32_v_i16mf2(const int16_t *base,vuint32m1_t bindex,size_t vl)
{
...
vint16mf2_t
test1_vloxei32_v_i16mf2(const int16_t *base,vuint32m1_t bindex,size_t vl)
{
    return vloxei32_v_i16mf2(base, bindex, 23);
}
