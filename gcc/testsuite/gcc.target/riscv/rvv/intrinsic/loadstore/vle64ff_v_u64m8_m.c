...
vuint64m8_t
test0_vle64ff_v_u64m8_m(vbool8_t mask,vuint64m8_t maskedoff,const uint64_t *base,size_t *new_vl,size_t vl)
{
...
vuint64m8_t
test1_vle64ff_v_u64m8_m(vbool8_t mask,vuint64m8_t maskedoff,const uint64_t *base,size_t *new_vl,size_t vl)
{
    return vle64ff_v_u64m8_m(mask, maskedoff, base, new_vl, 0);
}
