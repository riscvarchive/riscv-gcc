...
void
test1_vsuxseg4ei16_v_f32mf2_m(vbool64_t mask,float32_t *base,vuint16mf4_t bindex,vfloat32mf2_t v0,vfloat32mf2_t v1,vfloat32mf2_t v2,vfloat32mf2_t v3,size_t vl)
{
    vsuxseg4ei16_v_f32mf2_m(mask, base, bindex, v0, v1, v2, v3, 6);
}
