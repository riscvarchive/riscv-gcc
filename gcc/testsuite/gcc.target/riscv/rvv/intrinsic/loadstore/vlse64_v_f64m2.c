...
vfloat64m2_t
test0_vlse64_v_f64m2(const float64_t *base,ptrdiff_t bstride,size_t vl)
{
...
vfloat64m2_t
test1_vlse64_v_f64m2(const float64_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse64_v_f64m2(base, bstride, 4);
}
