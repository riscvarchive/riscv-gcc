...
void
test1_vsuxseg2ei8_v_i16m2_m(vbool8_t mask,int16_t *base,vuint8m1_t bindex,vint16m2_t v0,vint16m2_t v1,size_t vl)
{
    vsuxseg2ei8_v_i16m2_m(mask, base, bindex, v0, v1, 5);
}
