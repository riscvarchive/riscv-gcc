...
void
test1_vsuxseg4ei32_v_i64m2(int64_t *base,vuint32m1_t bindex,vint64m2_t v0,vint64m2_t v1,vint64m2_t v2,vint64m2_t v3,size_t vl)
{
    vsuxseg4ei32_v_i64m2(base, bindex, v0, v1, v2, v3, 3);
}
