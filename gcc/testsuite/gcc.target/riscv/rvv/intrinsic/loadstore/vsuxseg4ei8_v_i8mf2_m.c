...
void
test1_vsuxseg4ei8_v_i8mf2_m(vbool16_t mask,int8_t *base,vuint8mf2_t bindex,vint8mf2_t v0,vint8mf2_t v1,vint8mf2_t v2,vint8mf2_t v3,size_t vl)
{
    vsuxseg4ei8_v_i8mf2_m(mask, base, bindex, v0, v1, v2, v3, 8);
}
