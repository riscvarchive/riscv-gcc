...
vint8m1_t
test0_vle8_v_i8m1_tu(vint8m1_t dest,const int8_t *base,size_t vl)
{
...
vint8m1_t
test1_vle8_v_i8m1_tu(vint8m1_t dest,const int8_t *base,size_t vl)
{
    return vle8_v_i8m1_tu(dest, base, 18);
}
