...
void
test1_vsuxseg3ei32_v_f16m1(float16_t *base,vuint32m2_t bindex,vfloat16m1_t v0,vfloat16m1_t v1,vfloat16m1_t v2,size_t vl)
{
    vsuxseg3ei32_v_f16m1(base, bindex, v0, v1, v2, 21);
}
