...
vuint16mf2_t
test0_vlse16_v_u16mf2(const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint16mf2_t
test1_vlse16_v_u16mf2(const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_u16mf2(base, bstride, 29);
}
