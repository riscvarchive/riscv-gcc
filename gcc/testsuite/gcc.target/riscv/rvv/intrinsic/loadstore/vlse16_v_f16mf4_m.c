...
vfloat16mf4_t
test0_vlse16_v_f16mf4_m(vbool64_t mask,vfloat16mf4_t maskedoff,const float16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vfloat16mf4_t
test1_vlse16_v_f16mf4_m(vbool64_t mask,vfloat16mf4_t maskedoff,const float16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_f16mf4_m(mask, maskedoff, base, bstride, 29);
}
