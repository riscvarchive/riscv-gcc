...
vuint8m2_t
test0_vlse8_v_u8m2_m(vbool4_t mask,vuint8m2_t maskedoff,const uint8_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint8m2_t
test1_vlse8_v_u8m2_m(vbool4_t mask,vuint8m2_t maskedoff,const uint8_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse8_v_u8m2_m(mask, maskedoff, base, bstride, 4);
}
