...
void
test1_vsuxseg4ei64_v_f32m1(float32_t *base,vuint64m2_t bindex,vfloat32m1_t v0,vfloat32m1_t v1,vfloat32m1_t v2,vfloat32m1_t v3,size_t vl)
{
    vsuxseg4ei64_v_f32m1(base, bindex, v0, v1, v2, v3, 17);
}
