...
void
test1_vsuxseg3ei32_v_f16m2(float16_t *base,vuint32m4_t bindex,vfloat16m2_t v0,vfloat16m2_t v1,vfloat16m2_t v2,size_t vl)
{
    vsuxseg3ei32_v_f16m2(base, bindex, v0, v1, v2, 18);
}
