...
vuint64m1_t
test0_vle64ff_v_u64m1(const uint64_t *base,size_t *new_vl,size_t vl)
{
...
vuint64m1_t
test1_vle64ff_v_u64m1(const uint64_t *base,size_t *new_vl,size_t vl)
{
    return vle64ff_v_u64m1(base, new_vl, 25);
}
