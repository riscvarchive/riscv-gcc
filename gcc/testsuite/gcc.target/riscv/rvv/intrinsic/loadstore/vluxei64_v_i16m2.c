...
vint16m2_t
test0_vluxei64_v_i16m2(const int16_t *base,vuint64m8_t bindex,size_t vl)
{
...
vint16m2_t
test1_vluxei64_v_i16m2(const int16_t *base,vuint64m8_t bindex,size_t vl)
{
    return vluxei64_v_i16m2(base, bindex, 27);
}
