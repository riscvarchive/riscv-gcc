...
void
test1_vsuxseg2ei8_v_f64m2_m(vbool32_t mask,float64_t *base,vuint8mf4_t bindex,vfloat64m2_t v0,vfloat64m2_t v1,size_t vl)
{
    vsuxseg2ei8_v_f64m2_m(mask, base, bindex, v0, v1, 30);
}
