...
vint64m8_t
test0_vluxei8_v_i64m8(const int64_t *base,vuint8m1_t bindex,size_t vl)
{
...
vint64m8_t
test1_vluxei8_v_i64m8(const int64_t *base,vuint8m1_t bindex,size_t vl)
{
    return vluxei8_v_i64m8(base, bindex, 14);
}
