...
vuint8m1_t
test0_vloxei64_v_u8m1(const uint8_t *base,vuint64m8_t bindex,size_t vl)
{
...
vuint8m1_t
test1_vloxei64_v_u8m1(const uint8_t *base,vuint64m8_t bindex,size_t vl)
{
    return vloxei64_v_u8m1(base, bindex, 20);
}
