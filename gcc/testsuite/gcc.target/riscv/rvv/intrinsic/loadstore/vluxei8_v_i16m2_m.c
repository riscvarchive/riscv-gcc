...
vint16m2_t
test0_vluxei8_v_i16m2_m(vbool8_t mask,vint16m2_t maskedoff,const int16_t *base,vuint8m1_t bindex,size_t vl)
{
...
vint16m2_t
test1_vluxei8_v_i16m2_m(vbool8_t mask,vint16m2_t maskedoff,const int16_t *base,vuint8m1_t bindex,size_t vl)
{
    return vluxei8_v_i16m2_m(mask, maskedoff, base, bindex, 0);
}
