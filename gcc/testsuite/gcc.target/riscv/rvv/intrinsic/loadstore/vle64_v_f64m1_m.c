...
vfloat64m1_t
test0_vle64_v_f64m1_m(vbool64_t mask,vfloat64m1_t maskedoff,const float64_t *base,size_t vl)
{
...
vfloat64m1_t
test1_vle64_v_f64m1_m(vbool64_t mask,vfloat64m1_t maskedoff,const float64_t *base,size_t vl)
{
    return vle64_v_f64m1_m(mask, maskedoff, base, 8);
}
