...
vint8mf2_t
test0_vloxei32_v_i8mf2(const int8_t *base,vuint32m2_t bindex,size_t vl)
{
...
vint8mf2_t
test1_vloxei32_v_i8mf2(const int8_t *base,vuint32m2_t bindex,size_t vl)
{
    return vloxei32_v_i8mf2(base, bindex, 2);
}
