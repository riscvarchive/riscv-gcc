...
vint8mf8_t
test0_vloxei16_v_i8mf8_m(vbool64_t mask,vint8mf8_t maskedoff,const int8_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vint8mf8_t
test1_vloxei16_v_i8mf8_m(vbool64_t mask,vint8mf8_t maskedoff,const int8_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vloxei16_v_i8mf8_m(mask, maskedoff, base, bindex, 27);
}
