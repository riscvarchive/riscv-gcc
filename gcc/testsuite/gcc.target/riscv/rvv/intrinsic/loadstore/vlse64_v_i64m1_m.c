...
vint64m1_t
test0_vlse64_v_i64m1_m(vbool64_t mask,vint64m1_t maskedoff,const int64_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint64m1_t
test1_vlse64_v_i64m1_m(vbool64_t mask,vint64m1_t maskedoff,const int64_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse64_v_i64m1_m(mask, maskedoff, base, bstride, 31);
}
