...
vuint8m2_t
test0_vluxei16_v_u8m2(const uint8_t *base,vuint16m4_t bindex,size_t vl)
{
...
vuint8m2_t
test1_vluxei16_v_u8m2(const uint8_t *base,vuint16m4_t bindex,size_t vl)
{
    return vluxei16_v_u8m2(base, bindex, 26);
}
