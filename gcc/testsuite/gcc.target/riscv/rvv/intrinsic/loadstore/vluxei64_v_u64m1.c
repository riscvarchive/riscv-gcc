...
vuint64m1_t
test0_vluxei64_v_u64m1(const uint64_t *base,vuint64m1_t bindex,size_t vl)
{
...
vuint64m1_t
test1_vluxei64_v_u64m1(const uint64_t *base,vuint64m1_t bindex,size_t vl)
{
    return vluxei64_v_u64m1(base, bindex, 0);
}
