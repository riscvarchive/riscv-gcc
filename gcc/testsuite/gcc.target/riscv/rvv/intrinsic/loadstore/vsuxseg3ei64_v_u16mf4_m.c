...
void
test1_vsuxseg3ei64_v_u16mf4_m(vbool64_t mask,uint16_t *base,vuint64m1_t bindex,vuint16mf4_t v0,vuint16mf4_t v1,vuint16mf4_t v2,size_t vl)
{
    vsuxseg3ei64_v_u16mf4_m(mask, base, bindex, v0, v1, v2, 25);
}
