...
vuint8m2_t
test0_vle8ff_v_u8m2(const uint8_t *base,size_t *new_vl,size_t vl)
{
...
vuint8m2_t
test1_vle8ff_v_u8m2(const uint8_t *base,size_t *new_vl,size_t vl)
{
    return vle8ff_v_u8m2(base, new_vl, 14);
}
