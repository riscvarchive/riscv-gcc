...
void
test1_vsuxseg3ei8_v_f16mf4(float16_t *base,vuint8mf8_t bindex,vfloat16mf4_t v0,vfloat16mf4_t v1,vfloat16mf4_t v2,size_t vl)
{
    vsuxseg3ei8_v_f16mf4(base, bindex, v0, v1, v2, 11);
}
