...
vfloat32m4_t
test0_vloxei64_v_f32m4_m(vbool8_t mask,vfloat32m4_t maskedoff,const float32_t *base,vuint64m8_t bindex,size_t vl)
{
...
vfloat32m4_t
test1_vloxei64_v_f32m4_m(vbool8_t mask,vfloat32m4_t maskedoff,const float32_t *base,vuint64m8_t bindex,size_t vl)
{
    return vloxei64_v_f32m4_m(mask, maskedoff, base, bindex, 1);
}
