...
vint16m8_t
test0_vloxei8_v_i16m8(const int16_t *base,vuint8m4_t bindex,size_t vl)
{
...
vint16m8_t
test1_vloxei8_v_i16m8(const int16_t *base,vuint8m4_t bindex,size_t vl)
{
    return vloxei8_v_i16m8(base, bindex, 0);
}
