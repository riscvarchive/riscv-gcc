...
vuint32m1_t
test0_vloxei16_v_u32m1_m(vbool32_t mask,vuint32m1_t maskedoff,const uint32_t *base,vuint16mf2_t bindex,size_t vl)
{
...
vuint32m1_t
test1_vloxei16_v_u32m1_m(vbool32_t mask,vuint32m1_t maskedoff,const uint32_t *base,vuint16mf2_t bindex,size_t vl)
{
    return vloxei16_v_u32m1_m(mask, maskedoff, base, bindex, 31);
}
