...
vint8mf4_t
test0_vluxei8_v_i8mf4(const int8_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vint8mf4_t
test1_vluxei8_v_i8mf4(const int8_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vluxei8_v_i8mf4(base, bindex, 30);
}
