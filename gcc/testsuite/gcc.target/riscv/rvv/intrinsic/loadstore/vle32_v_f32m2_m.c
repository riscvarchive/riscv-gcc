...
vfloat32m2_t
test0_vle32_v_f32m2_m(vbool16_t mask,vfloat32m2_t maskedoff,const float32_t *base,size_t vl)
{
...
vfloat32m2_t
test1_vle32_v_f32m2_m(vbool16_t mask,vfloat32m2_t maskedoff,const float32_t *base,size_t vl)
{
    return vle32_v_f32m2_m(mask, maskedoff, base, 30);
}
