...
vint8m2_t
test0_vloxei8_v_i8m2_m(vbool4_t mask,vint8m2_t maskedoff,const int8_t *base,vuint8m2_t bindex,size_t vl)
{
...
vint8m2_t
test1_vloxei8_v_i8m2_m(vbool4_t mask,vint8m2_t maskedoff,const int8_t *base,vuint8m2_t bindex,size_t vl)
{
    return vloxei8_v_i8m2_m(mask, maskedoff, base, bindex, 31);
}
