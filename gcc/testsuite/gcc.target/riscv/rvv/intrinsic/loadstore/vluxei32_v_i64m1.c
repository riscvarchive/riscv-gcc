...
vint64m1_t
test0_vluxei32_v_i64m1(const int64_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vint64m1_t
test1_vluxei32_v_i64m1(const int64_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vluxei32_v_i64m1(base, bindex, 10);
}
