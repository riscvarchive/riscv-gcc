...
vuint32m1_t
test0_vlse32_v_u32m1_tu(vuint32m1_t dest,const uint32_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint32m1_t
test1_vlse32_v_u32m1_tu(vuint32m1_t dest,const uint32_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse32_v_u32m1_tu(dest, base, bstride, 29);
}
