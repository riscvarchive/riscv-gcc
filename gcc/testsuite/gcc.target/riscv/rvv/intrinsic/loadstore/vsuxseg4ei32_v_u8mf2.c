...
void
test1_vsuxseg4ei32_v_u8mf2(uint8_t *base,vuint32m2_t bindex,vuint8mf2_t v0,vuint8mf2_t v1,vuint8mf2_t v2,vuint8mf2_t v3,size_t vl)
{
    vsuxseg4ei32_v_u8mf2(base, bindex, v0, v1, v2, v3, 18);
}
