...
vint64m4_t
test0_vluxei16_v_i64m4_m(vbool16_t mask,vint64m4_t maskedoff,const int64_t *base,vuint16m1_t bindex,size_t vl)
{
...
vint64m4_t
test1_vluxei16_v_i64m4_m(vbool16_t mask,vint64m4_t maskedoff,const int64_t *base,vuint16m1_t bindex,size_t vl)
{
    return vluxei16_v_i64m4_m(mask, maskedoff, base, bindex, 19);
}
