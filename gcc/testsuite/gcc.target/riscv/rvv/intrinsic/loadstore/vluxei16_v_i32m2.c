...
vint32m2_t
test0_vluxei16_v_i32m2(const int32_t *base,vuint16m1_t bindex,size_t vl)
{
...
vint32m2_t
test1_vluxei16_v_i32m2(const int32_t *base,vuint16m1_t bindex,size_t vl)
{
    return vluxei16_v_i32m2(base, bindex, 29);
}
