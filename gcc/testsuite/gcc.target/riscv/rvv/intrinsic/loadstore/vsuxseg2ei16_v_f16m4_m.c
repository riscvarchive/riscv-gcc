...
void
test1_vsuxseg2ei16_v_f16m4_m(vbool4_t mask,float16_t *base,vuint16m4_t bindex,vfloat16m4_t v0,vfloat16m4_t v1,size_t vl)
{
    vsuxseg2ei16_v_f16m4_m(mask, base, bindex, v0, v1, 6);
}
