...
vint16mf4_t
test0_vlse16_v_i16mf4_m(vbool64_t mask,vint16mf4_t maskedoff,const int16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint16mf4_t
test1_vlse16_v_i16mf4_m(vbool64_t mask,vint16mf4_t maskedoff,const int16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_i16mf4_m(mask, maskedoff, base, bstride, 19);
}
