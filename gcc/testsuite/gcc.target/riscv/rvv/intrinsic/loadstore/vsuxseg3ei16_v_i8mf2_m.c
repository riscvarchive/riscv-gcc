...
void
test1_vsuxseg3ei16_v_i8mf2_m(vbool16_t mask,int8_t *base,vuint16m1_t bindex,vint8mf2_t v0,vint8mf2_t v1,vint8mf2_t v2,size_t vl)
{
    vsuxseg3ei16_v_i8mf2_m(mask, base, bindex, v0, v1, v2, 2);
}
