...
vint8mf4_t
test0_vloxei16_v_i8mf4(const int8_t *base,vuint16mf2_t bindex,size_t vl)
{
...
vint8mf4_t
test1_vloxei16_v_i8mf4(const int8_t *base,vuint16mf2_t bindex,size_t vl)
{
    return vloxei16_v_i8mf4(base, bindex, 18);
}
