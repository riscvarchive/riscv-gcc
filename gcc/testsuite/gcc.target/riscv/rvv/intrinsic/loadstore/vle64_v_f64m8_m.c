...
vfloat64m8_t
test0_vle64_v_f64m8_m(vbool8_t mask,vfloat64m8_t maskedoff,const float64_t *base,size_t vl)
{
...
vfloat64m8_t
test1_vle64_v_f64m8_m(vbool8_t mask,vfloat64m8_t maskedoff,const float64_t *base,size_t vl)
{
    return vle64_v_f64m8_m(mask, maskedoff, base, 26);
}
