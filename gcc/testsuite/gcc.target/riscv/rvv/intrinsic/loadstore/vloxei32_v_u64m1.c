...
vuint64m1_t
test0_vloxei32_v_u64m1(const uint64_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vuint64m1_t
test1_vloxei32_v_u64m1(const uint64_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vloxei32_v_u64m1(base, bindex, 12);
}
