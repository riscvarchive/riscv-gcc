...
vfloat64m4_t
test0_vloxei16_v_f64m4(const float64_t *base,vuint16m1_t bindex,size_t vl)
{
...
vfloat64m4_t
test1_vloxei16_v_f64m4(const float64_t *base,vuint16m1_t bindex,size_t vl)
{
    return vloxei16_v_f64m4(base, bindex, 18);
}
