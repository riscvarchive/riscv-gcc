...
vint16m8_t
test0_vloxei16_v_i16m8_m(vbool2_t mask,vint16m8_t maskedoff,const int16_t *base,vuint16m8_t bindex,size_t vl)
{
...
vint16m8_t
test1_vloxei16_v_i16m8_m(vbool2_t mask,vint16m8_t maskedoff,const int16_t *base,vuint16m8_t bindex,size_t vl)
{
    return vloxei16_v_i16m8_m(mask, maskedoff, base, bindex, 11);
}
