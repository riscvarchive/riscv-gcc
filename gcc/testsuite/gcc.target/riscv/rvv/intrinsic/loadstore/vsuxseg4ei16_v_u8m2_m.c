...
void
test1_vsuxseg4ei16_v_u8m2_m(vbool4_t mask,uint8_t *base,vuint16m4_t bindex,vuint8m2_t v0,vuint8m2_t v1,vuint8m2_t v2,vuint8m2_t v3,size_t vl)
{
    vsuxseg4ei16_v_u8m2_m(mask, base, bindex, v0, v1, v2, v3, 20);
}
