...
void
test1_vsuxseg3ei64_v_u16m2_m(vbool8_t mask,uint16_t *base,vuint64m8_t bindex,vuint16m2_t v0,vuint16m2_t v1,vuint16m2_t v2,size_t vl)
{
    vsuxseg3ei64_v_u16m2_m(mask, base, bindex, v0, v1, v2, 0);
}
