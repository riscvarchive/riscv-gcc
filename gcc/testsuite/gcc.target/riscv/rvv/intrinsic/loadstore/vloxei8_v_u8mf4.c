...
vuint8mf4_t
test0_vloxei8_v_u8mf4(const uint8_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vuint8mf4_t
test1_vloxei8_v_u8mf4(const uint8_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vloxei8_v_u8mf4(base, bindex, 5);
}
