...
vuint32mf2_t
test0_vluxei16_v_u32mf2(const uint32_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vuint32mf2_t
test1_vluxei16_v_u32mf2(const uint32_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vluxei16_v_u32mf2(base, bindex, 1);
}
