...
vint32m1_t
test0_vle32_v_i32m1_tu(vint32m1_t dest,const int32_t *base,size_t vl)
{
...
vint32m1_t
test1_vle32_v_i32m1_tu(vint32m1_t dest,const int32_t *base,size_t vl)
{
    return vle32_v_i32m1_tu(dest, base, 29);
}
