...
vfloat32m2_t
test0_vluxei16_v_f32m2_m(vbool16_t mask,vfloat32m2_t maskedoff,const float32_t *base,vuint16m1_t bindex,size_t vl)
{
...
vfloat32m2_t
test1_vluxei16_v_f32m2_m(vbool16_t mask,vfloat32m2_t maskedoff,const float32_t *base,vuint16m1_t bindex,size_t vl)
{
    return vluxei16_v_f32m2_m(mask, maskedoff, base, bindex, 14);
}
