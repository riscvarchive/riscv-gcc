...
void
test1_vsuxseg3ei32_v_u16m1_m(vbool16_t mask,uint16_t *base,vuint32m2_t bindex,vuint16m1_t v0,vuint16m1_t v1,vuint16m1_t v2,size_t vl)
{
    vsuxseg3ei32_v_u16m1_m(mask, base, bindex, v0, v1, v2, 1);
}
