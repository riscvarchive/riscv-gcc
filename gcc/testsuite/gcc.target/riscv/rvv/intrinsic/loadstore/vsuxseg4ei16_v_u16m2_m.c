...
void
test1_vsuxseg4ei16_v_u16m2_m(vbool8_t mask,uint16_t *base,vuint16m2_t bindex,vuint16m2_t v0,vuint16m2_t v1,vuint16m2_t v2,vuint16m2_t v3,size_t vl)
{
    vsuxseg4ei16_v_u16m2_m(mask, base, bindex, v0, v1, v2, v3, 8);
}
