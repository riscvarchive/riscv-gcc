...
vint32mf2_t
test0_vloxei8_v_i32mf2_m(vbool64_t mask,vint32mf2_t maskedoff,const int32_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vint32mf2_t
test1_vloxei8_v_i32mf2_m(vbool64_t mask,vint32mf2_t maskedoff,const int32_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vloxei8_v_i32mf2_m(mask, maskedoff, base, bindex, 31);
}
