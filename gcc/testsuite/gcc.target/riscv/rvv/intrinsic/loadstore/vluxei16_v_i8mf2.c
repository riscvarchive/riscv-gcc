...
vint8mf2_t
test0_vluxei16_v_i8mf2(const int8_t *base,vuint16m1_t bindex,size_t vl)
{
...
vint8mf2_t
test1_vluxei16_v_i8mf2(const int8_t *base,vuint16m1_t bindex,size_t vl)
{
    return vluxei16_v_i8mf2(base, bindex, 26);
}
