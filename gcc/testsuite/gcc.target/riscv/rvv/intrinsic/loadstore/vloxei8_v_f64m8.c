...
vfloat64m8_t
test0_vloxei8_v_f64m8(const float64_t *base,vuint8m1_t bindex,size_t vl)
{
...
vfloat64m8_t
test1_vloxei8_v_f64m8(const float64_t *base,vuint8m1_t bindex,size_t vl)
{
    return vloxei8_v_f64m8(base, bindex, 17);
}
