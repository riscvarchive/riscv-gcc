...
vuint8mf8_t
test0_vle8ff_v_u8mf8(const uint8_t *base,size_t *new_vl,size_t vl)
{
...
vuint8mf8_t
test1_vle8ff_v_u8mf8(const uint8_t *base,size_t *new_vl,size_t vl)
{
    return vle8ff_v_u8mf8(base, new_vl, 11);
}
