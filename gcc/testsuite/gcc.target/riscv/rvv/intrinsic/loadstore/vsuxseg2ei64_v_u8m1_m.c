...
void
test1_vsuxseg2ei64_v_u8m1_m(vbool8_t mask,uint8_t *base,vuint64m8_t bindex,vuint8m1_t v0,vuint8m1_t v1,size_t vl)
{
    vsuxseg2ei64_v_u8m1_m(mask, base, bindex, v0, v1, 27);
}
