...
vfloat32m4_t
test0_vloxei16_v_f32m4_m(vbool8_t mask,vfloat32m4_t maskedoff,const float32_t *base,vuint16m2_t bindex,size_t vl)
{
...
vfloat32m4_t
test1_vloxei16_v_f32m4_m(vbool8_t mask,vfloat32m4_t maskedoff,const float32_t *base,vuint16m2_t bindex,size_t vl)
{
    return vloxei16_v_f32m4_m(mask, maskedoff, base, bindex, 1);
}
