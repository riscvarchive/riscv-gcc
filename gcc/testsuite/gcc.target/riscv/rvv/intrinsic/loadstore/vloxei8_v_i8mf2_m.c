...
vint8mf2_t
test0_vloxei8_v_i8mf2_m(vbool16_t mask,vint8mf2_t maskedoff,const int8_t *base,vuint8mf2_t bindex,size_t vl)
{
...
vint8mf2_t
test1_vloxei8_v_i8mf2_m(vbool16_t mask,vint8mf2_t maskedoff,const int8_t *base,vuint8mf2_t bindex,size_t vl)
{
    return vloxei8_v_i8mf2_m(mask, maskedoff, base, bindex, 8);
}
