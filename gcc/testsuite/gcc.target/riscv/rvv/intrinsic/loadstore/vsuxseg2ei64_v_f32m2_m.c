...
void
test1_vsuxseg2ei64_v_f32m2_m(vbool16_t mask,float32_t *base,vuint64m4_t bindex,vfloat32m2_t v0,vfloat32m2_t v1,size_t vl)
{
    vsuxseg2ei64_v_f32m2_m(mask, base, bindex, v0, v1, 8);
}
