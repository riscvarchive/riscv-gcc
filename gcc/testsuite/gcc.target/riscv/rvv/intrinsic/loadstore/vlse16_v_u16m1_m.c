...
vuint16m1_t
test0_vlse16_v_u16m1_m(vbool16_t mask,vuint16m1_t maskedoff,const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint16m1_t
test1_vlse16_v_u16m1_m(vbool16_t mask,vuint16m1_t maskedoff,const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_u16m1_m(mask, maskedoff, base, bstride, 22);
}
