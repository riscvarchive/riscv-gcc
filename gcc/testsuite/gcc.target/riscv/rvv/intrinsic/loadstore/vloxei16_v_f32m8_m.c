...
vfloat32m8_t
test0_vloxei16_v_f32m8_m(vbool4_t mask,vfloat32m8_t maskedoff,const float32_t *base,vuint16m4_t bindex,size_t vl)
{
...
vfloat32m8_t
test1_vloxei16_v_f32m8_m(vbool4_t mask,vfloat32m8_t maskedoff,const float32_t *base,vuint16m4_t bindex,size_t vl)
{
    return vloxei16_v_f32m8_m(mask, maskedoff, base, bindex, 29);
}
