...
vuint16m4_t
test0_vle16_v_u16m4_tu(vuint16m4_t dest,const uint16_t *base,size_t vl)
{
...
vuint16m4_t
test1_vle16_v_u16m4_tu(vuint16m4_t dest,const uint16_t *base,size_t vl)
{
    return vle16_v_u16m4_tu(dest, base, 2);
}
