...
void
test1_vsuxseg5ei64_v_f32m1_m(vbool32_t mask,float32_t *base,vuint64m2_t bindex,vfloat32m1_t v0,vfloat32m1_t v1,vfloat32m1_t v2,vfloat32m1_t v3,vfloat32m1_t v4,size_t vl)
{
    vsuxseg5ei64_v_f32m1_m(mask, base, bindex, v0, v1, v2, v3, v4, 11);
}
