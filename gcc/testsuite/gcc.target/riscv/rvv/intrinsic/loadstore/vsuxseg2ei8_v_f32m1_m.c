...
void
test1_vsuxseg2ei8_v_f32m1_m(vbool32_t mask,float32_t *base,vuint8mf4_t bindex,vfloat32m1_t v0,vfloat32m1_t v1,size_t vl)
{
    vsuxseg2ei8_v_f32m1_m(mask, base, bindex, v0, v1, 21);
}
