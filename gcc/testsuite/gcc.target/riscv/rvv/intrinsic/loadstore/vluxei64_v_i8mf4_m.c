...
vint8mf4_t
test0_vluxei64_v_i8mf4_m(vbool32_t mask,vint8mf4_t maskedoff,const int8_t *base,vuint64m2_t bindex,size_t vl)
{
...
vint8mf4_t
test1_vluxei64_v_i8mf4_m(vbool32_t mask,vint8mf4_t maskedoff,const int8_t *base,vuint64m2_t bindex,size_t vl)
{
    return vluxei64_v_i8mf4_m(mask, maskedoff, base, bindex, 26);
}
