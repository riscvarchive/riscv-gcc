...
vint32m1_t
test0_vloxei8_v_i32m1(const int32_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vint32m1_t
test1_vloxei8_v_i32m1(const int32_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vloxei8_v_i32m1(base, bindex, 8);
}
