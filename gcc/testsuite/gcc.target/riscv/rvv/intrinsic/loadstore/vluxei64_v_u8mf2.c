...
vuint8mf2_t
test0_vluxei64_v_u8mf2(const uint8_t *base,vuint64m4_t bindex,size_t vl)
{
...
vuint8mf2_t
test1_vluxei64_v_u8mf2(const uint8_t *base,vuint64m4_t bindex,size_t vl)
{
    return vluxei64_v_u8mf2(base, bindex, 29);
}
