...
void
test1_vsuxseg3ei32_v_i32mf2(int32_t *base,vuint32mf2_t bindex,vint32mf2_t v0,vint32mf2_t v1,vint32mf2_t v2,size_t vl)
{
    vsuxseg3ei32_v_i32mf2(base, bindex, v0, v1, v2, 22);
}
