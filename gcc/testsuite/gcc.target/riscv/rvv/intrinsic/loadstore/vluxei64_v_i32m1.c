...
vint32m1_t
test0_vluxei64_v_i32m1(const int32_t *base,vuint64m2_t bindex,size_t vl)
{
...
vint32m1_t
test1_vluxei64_v_i32m1(const int32_t *base,vuint64m2_t bindex,size_t vl)
{
    return vluxei64_v_i32m1(base, bindex, 13);
}
