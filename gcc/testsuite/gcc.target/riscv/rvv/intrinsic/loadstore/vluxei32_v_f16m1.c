...
vfloat16m1_t
test0_vluxei32_v_f16m1(const float16_t *base,vuint32m2_t bindex,size_t vl)
{
...
vfloat16m1_t
test1_vluxei32_v_f16m1(const float16_t *base,vuint32m2_t bindex,size_t vl)
{
    return vluxei32_v_f16m1(base, bindex, 7);
}
