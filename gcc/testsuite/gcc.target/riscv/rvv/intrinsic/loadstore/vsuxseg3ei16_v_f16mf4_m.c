...
void
test1_vsuxseg3ei16_v_f16mf4_m(vbool64_t mask,float16_t *base,vuint16mf4_t bindex,vfloat16mf4_t v0,vfloat16mf4_t v1,vfloat16mf4_t v2,size_t vl)
{
    vsuxseg3ei16_v_f16mf4_m(mask, base, bindex, v0, v1, v2, 30);
}
