...
vfloat64m2_t
test0_vluxei16_v_f64m2(const float64_t *base,vuint16mf2_t bindex,size_t vl)
{
...
vfloat64m2_t
test1_vluxei16_v_f64m2(const float64_t *base,vuint16mf2_t bindex,size_t vl)
{
    return vluxei16_v_f64m2(base, bindex, 30);
}
