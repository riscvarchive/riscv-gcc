...
vuint16m8_t
test0_vlse16_v_u16m8(const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint16m8_t
test1_vlse16_v_u16m8(const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_u16m8(base, bstride, 0);
}
