...
void
test1_vsuxseg4ei32_v_i16mf4_m(vbool64_t mask,int16_t *base,vuint32mf2_t bindex,vint16mf4_t v0,vint16mf4_t v1,vint16mf4_t v2,vint16mf4_t v3,size_t vl)
{
    vsuxseg4ei32_v_i16mf4_m(mask, base, bindex, v0, v1, v2, v3, 14);
}
