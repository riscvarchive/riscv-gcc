...
vfloat32mf2_t
test0_vluxei16_v_f32mf2(const float32_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vfloat32mf2_t
test1_vluxei16_v_f32mf2(const float32_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vluxei16_v_f32mf2(base, bindex, 13);
}
