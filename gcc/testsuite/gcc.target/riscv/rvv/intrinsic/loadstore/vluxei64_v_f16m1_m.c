...
vfloat16m1_t
test0_vluxei64_v_f16m1_m(vbool16_t mask,vfloat16m1_t maskedoff,const float16_t *base,vuint64m4_t bindex,size_t vl)
{
...
vfloat16m1_t
test1_vluxei64_v_f16m1_m(vbool16_t mask,vfloat16m1_t maskedoff,const float16_t *base,vuint64m4_t bindex,size_t vl)
{
    return vluxei64_v_f16m1_m(mask, maskedoff, base, bindex, 1);
}
