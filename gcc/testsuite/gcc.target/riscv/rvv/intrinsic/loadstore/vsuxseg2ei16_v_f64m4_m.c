...
void
test1_vsuxseg2ei16_v_f64m4_m(vbool16_t mask,float64_t *base,vuint16m1_t bindex,vfloat64m4_t v0,vfloat64m4_t v1,size_t vl)
{
    vsuxseg2ei16_v_f64m4_m(mask, base, bindex, v0, v1, 22);
}
