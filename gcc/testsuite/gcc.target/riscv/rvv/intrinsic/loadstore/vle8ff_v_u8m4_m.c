...
vuint8m4_t
test0_vle8ff_v_u8m4_m(vbool2_t mask,vuint8m4_t maskedoff,const uint8_t *base,size_t *new_vl,size_t vl)
{
...
vuint8m4_t
test1_vle8ff_v_u8m4_m(vbool2_t mask,vuint8m4_t maskedoff,const uint8_t *base,size_t *new_vl,size_t vl)
{
    return vle8ff_v_u8m4_m(mask, maskedoff, base, new_vl, 29);
}
