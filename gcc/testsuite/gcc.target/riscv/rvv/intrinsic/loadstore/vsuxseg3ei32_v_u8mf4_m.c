...
void
test1_vsuxseg3ei32_v_u8mf4_m(vbool32_t mask,uint8_t *base,vuint32m1_t bindex,vuint8mf4_t v0,vuint8mf4_t v1,vuint8mf4_t v2,size_t vl)
{
    vsuxseg3ei32_v_u8mf4_m(mask, base, bindex, v0, v1, v2, 3);
}
