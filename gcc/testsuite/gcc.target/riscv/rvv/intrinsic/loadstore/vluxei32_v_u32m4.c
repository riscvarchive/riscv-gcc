...
vuint32m4_t
test0_vluxei32_v_u32m4(const uint32_t *base,vuint32m4_t bindex,size_t vl)
{
...
vuint32m4_t
test1_vluxei32_v_u32m4(const uint32_t *base,vuint32m4_t bindex,size_t vl)
{
    return vluxei32_v_u32m4(base, bindex, 5);
}
