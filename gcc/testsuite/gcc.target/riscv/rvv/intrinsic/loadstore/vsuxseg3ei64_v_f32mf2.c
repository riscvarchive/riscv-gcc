...
void
test1_vsuxseg3ei64_v_f32mf2(float32_t *base,vuint64m1_t bindex,vfloat32mf2_t v0,vfloat32mf2_t v1,vfloat32mf2_t v2,size_t vl)
{
    vsuxseg3ei64_v_f32mf2(base, bindex, v0, v1, v2, 14);
}
