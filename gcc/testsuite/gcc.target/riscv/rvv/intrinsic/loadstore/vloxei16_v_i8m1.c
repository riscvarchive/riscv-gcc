...
vint8m1_t
test0_vloxei16_v_i8m1(const int8_t *base,vuint16m2_t bindex,size_t vl)
{
...
vint8m1_t
test1_vloxei16_v_i8m1(const int8_t *base,vuint16m2_t bindex,size_t vl)
{
    return vloxei16_v_i8m1(base, bindex, 6);
}
