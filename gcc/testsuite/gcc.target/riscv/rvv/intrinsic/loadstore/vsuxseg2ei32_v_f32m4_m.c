...
void
test1_vsuxseg2ei32_v_f32m4_m(vbool8_t mask,float32_t *base,vuint32m4_t bindex,vfloat32m4_t v0,vfloat32m4_t v1,size_t vl)
{
    vsuxseg2ei32_v_f32m4_m(mask, base, bindex, v0, v1, 30);
}
