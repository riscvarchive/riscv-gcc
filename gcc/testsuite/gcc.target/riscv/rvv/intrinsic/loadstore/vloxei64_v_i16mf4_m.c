...
vint16mf4_t
test0_vloxei64_v_i16mf4_m(vbool64_t mask,vint16mf4_t maskedoff,const int16_t *base,vuint64m1_t bindex,size_t vl)
{
...
vint16mf4_t
test1_vloxei64_v_i16mf4_m(vbool64_t mask,vint16mf4_t maskedoff,const int16_t *base,vuint64m1_t bindex,size_t vl)
{
    return vloxei64_v_i16mf4_m(mask, maskedoff, base, bindex, 31);
}
