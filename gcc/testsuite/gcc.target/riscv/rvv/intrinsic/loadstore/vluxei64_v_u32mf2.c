...
vuint32mf2_t
test0_vluxei64_v_u32mf2(const uint32_t *base,vuint64m1_t bindex,size_t vl)
{
...
vuint32mf2_t
test1_vluxei64_v_u32mf2(const uint32_t *base,vuint64m1_t bindex,size_t vl)
{
    return vluxei64_v_u32mf2(base, bindex, 17);
}
