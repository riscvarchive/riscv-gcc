...
vint8mf8_t
test0_vloxei64_v_i8mf8_m(vbool64_t mask,vint8mf8_t maskedoff,const int8_t *base,vuint64m1_t bindex,size_t vl)
{
...
vint8mf8_t
test1_vloxei64_v_i8mf8_m(vbool64_t mask,vint8mf8_t maskedoff,const int8_t *base,vuint64m1_t bindex,size_t vl)
{
    return vloxei64_v_i8mf8_m(mask, maskedoff, base, bindex, 10);
}
