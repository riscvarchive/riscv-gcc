...
void
test1_vsuxseg3ei8_v_u64m1(uint64_t *base,vuint8mf8_t bindex,vuint64m1_t v0,vuint64m1_t v1,vuint64m1_t v2,size_t vl)
{
    vsuxseg3ei8_v_u64m1(base, bindex, v0, v1, v2, 8);
}
