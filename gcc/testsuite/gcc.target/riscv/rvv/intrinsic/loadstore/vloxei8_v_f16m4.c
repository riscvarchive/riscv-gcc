...
vfloat16m4_t
test0_vloxei8_v_f16m4(const float16_t *base,vuint8m2_t bindex,size_t vl)
{
...
vfloat16m4_t
test1_vloxei8_v_f16m4(const float16_t *base,vuint8m2_t bindex,size_t vl)
{
    return vloxei8_v_f16m4(base, bindex, 4);
}
