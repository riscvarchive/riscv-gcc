...
vint64m1_t
test0_vloxei8_v_i64m1_m(vbool64_t mask,vint64m1_t maskedoff,const int64_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vint64m1_t
test1_vloxei8_v_i64m1_m(vbool64_t mask,vint64m1_t maskedoff,const int64_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vloxei8_v_i64m1_m(mask, maskedoff, base, bindex, 28);
}
