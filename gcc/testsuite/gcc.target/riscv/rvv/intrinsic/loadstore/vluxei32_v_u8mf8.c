...
vuint8mf8_t
test0_vluxei32_v_u8mf8(const uint8_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vuint8mf8_t
test1_vluxei32_v_u8mf8(const uint8_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vluxei32_v_u8mf8(base, bindex, 0);
}
