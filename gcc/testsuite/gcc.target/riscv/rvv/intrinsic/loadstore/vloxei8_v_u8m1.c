...
vuint8m1_t
test0_vloxei8_v_u8m1(const uint8_t *base,vuint8m1_t bindex,size_t vl)
{
...
vuint8m1_t
test1_vloxei8_v_u8m1(const uint8_t *base,vuint8m1_t bindex,size_t vl)
{
    return vloxei8_v_u8m1(base, bindex, 10);
}
