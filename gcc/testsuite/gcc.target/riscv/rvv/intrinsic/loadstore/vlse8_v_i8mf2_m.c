...
vint8mf2_t
test0_vlse8_v_i8mf2_m(vbool16_t mask,vint8mf2_t maskedoff,const int8_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint8mf2_t
test1_vlse8_v_i8mf2_m(vbool16_t mask,vint8mf2_t maskedoff,const int8_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse8_v_i8mf2_m(mask, maskedoff, base, bstride, 30);
}
