...
vfloat16m1_t
test0_vle16_v_f16m1_m(vbool16_t mask,vfloat16m1_t maskedoff,const float16_t *base,size_t vl)
{
...
vfloat16m1_t
test1_vle16_v_f16m1_m(vbool16_t mask,vfloat16m1_t maskedoff,const float16_t *base,size_t vl)
{
    return vle16_v_f16m1_m(mask, maskedoff, base, 28);
}
