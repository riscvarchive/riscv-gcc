...
vuint8mf8_t
test0_vloxei32_v_u8mf8(const uint8_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vuint8mf8_t
test1_vloxei32_v_u8mf8(const uint8_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vloxei32_v_u8mf8(base, bindex, 1);
}
