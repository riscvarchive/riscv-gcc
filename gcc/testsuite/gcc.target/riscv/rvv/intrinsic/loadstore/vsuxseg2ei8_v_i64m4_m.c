...
void
test1_vsuxseg2ei8_v_i64m4_m(vbool16_t mask,int64_t *base,vuint8mf2_t bindex,vint64m4_t v0,vint64m4_t v1,size_t vl)
{
    vsuxseg2ei8_v_i64m4_m(mask, base, bindex, v0, v1, 1);
}
