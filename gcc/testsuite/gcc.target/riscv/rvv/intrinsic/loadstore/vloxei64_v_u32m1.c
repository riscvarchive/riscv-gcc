...
vuint32m1_t
test0_vloxei64_v_u32m1(const uint32_t *base,vuint64m2_t bindex,size_t vl)
{
...
vuint32m1_t
test1_vloxei64_v_u32m1(const uint32_t *base,vuint64m2_t bindex,size_t vl)
{
    return vloxei64_v_u32m1(base, bindex, 15);
}
