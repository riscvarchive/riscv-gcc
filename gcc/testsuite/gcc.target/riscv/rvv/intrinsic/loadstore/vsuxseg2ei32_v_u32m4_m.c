...
void
test1_vsuxseg2ei32_v_u32m4_m(vbool8_t mask,uint32_t *base,vuint32m4_t bindex,vuint32m4_t v0,vuint32m4_t v1,size_t vl)
{
    vsuxseg2ei32_v_u32m4_m(mask, base, bindex, v0, v1, 23);
}
