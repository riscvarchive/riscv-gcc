...
vfloat32m1_t
test0_vloxei16_v_f32m1(const float32_t *base,vuint16mf2_t bindex,size_t vl)
{
...
vfloat32m1_t
test1_vloxei16_v_f32m1(const float32_t *base,vuint16mf2_t bindex,size_t vl)
{
    return vloxei16_v_f32m1(base, bindex, 28);
}
