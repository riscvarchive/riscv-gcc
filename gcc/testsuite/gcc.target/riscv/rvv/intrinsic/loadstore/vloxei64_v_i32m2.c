...
vint32m2_t
test0_vloxei64_v_i32m2(const int32_t *base,vuint64m4_t bindex,size_t vl)
{
...
vint32m2_t
test1_vloxei64_v_i32m2(const int32_t *base,vuint64m4_t bindex,size_t vl)
{
    return vloxei64_v_i32m2(base, bindex, 24);
}
