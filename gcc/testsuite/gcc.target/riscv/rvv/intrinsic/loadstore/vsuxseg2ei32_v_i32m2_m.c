...
void
test1_vsuxseg2ei32_v_i32m2_m(vbool16_t mask,int32_t *base,vuint32m2_t bindex,vint32m2_t v0,vint32m2_t v1,size_t vl)
{
    vsuxseg2ei32_v_i32m2_m(mask, base, bindex, v0, v1, 23);
}
