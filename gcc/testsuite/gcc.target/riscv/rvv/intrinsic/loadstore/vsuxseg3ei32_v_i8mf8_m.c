...
void
test1_vsuxseg3ei32_v_i8mf8_m(vbool64_t mask,int8_t *base,vuint32mf2_t bindex,vint8mf8_t v0,vint8mf8_t v1,vint8mf8_t v2,size_t vl)
{
    vsuxseg3ei32_v_i8mf8_m(mask, base, bindex, v0, v1, v2, 27);
}
