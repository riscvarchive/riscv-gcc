...
vuint16mf2_t
test0_vloxei32_v_u16mf2_m(vbool32_t mask,vuint16mf2_t maskedoff,const uint16_t *base,vuint32m1_t bindex,size_t vl)
{
...
vuint16mf2_t
test1_vloxei32_v_u16mf2_m(vbool32_t mask,vuint16mf2_t maskedoff,const uint16_t *base,vuint32m1_t bindex,size_t vl)
{
    return vloxei32_v_u16mf2_m(mask, maskedoff, base, bindex, 3);
}
