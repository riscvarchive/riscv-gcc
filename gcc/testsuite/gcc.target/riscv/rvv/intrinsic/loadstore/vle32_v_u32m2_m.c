...
vuint32m2_t
test0_vle32_v_u32m2_m(vbool16_t mask,vuint32m2_t maskedoff,const uint32_t *base,size_t vl)
{
...
vuint32m2_t
test1_vle32_v_u32m2_m(vbool16_t mask,vuint32m2_t maskedoff,const uint32_t *base,size_t vl)
{
    return vle32_v_u32m2_m(mask, maskedoff, base, 16);
}
