...
vuint32m2_t
test0_vlse32_v_u32m2(const uint32_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint32m2_t
test1_vlse32_v_u32m2(const uint32_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse32_v_u32m2(base, bstride, 29);
}
