...
vuint8mf4_t
test0_vluxei16_v_u8mf4(const uint8_t *base,vuint16mf2_t bindex,size_t vl)
{
...
vuint8mf4_t
test1_vluxei16_v_u8mf4(const uint8_t *base,vuint16mf2_t bindex,size_t vl)
{
    return vluxei16_v_u8mf4(base, bindex, 7);
}
