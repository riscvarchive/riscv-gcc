...
vfloat16m1_t
test0_vlse16_v_f16m1_m(vbool16_t mask,vfloat16m1_t maskedoff,const float16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vfloat16m1_t
test1_vlse16_v_f16m1_m(vbool16_t mask,vfloat16m1_t maskedoff,const float16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_f16m1_m(mask, maskedoff, base, bstride, 1);
}
