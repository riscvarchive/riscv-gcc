...
void
test1_vsuxseg4ei8_v_u64m1(uint64_t *base,vuint8mf8_t bindex,vuint64m1_t v0,vuint64m1_t v1,vuint64m1_t v2,vuint64m1_t v3,size_t vl)
{
    vsuxseg4ei8_v_u64m1(base, bindex, v0, v1, v2, v3, 14);
}
