...
vint8m1_t
test0_vloxei32_v_i8m1_m(vbool8_t mask,vint8m1_t maskedoff,const int8_t *base,vuint32m4_t bindex,size_t vl)
{
...
vint8m1_t
test1_vloxei32_v_i8m1_m(vbool8_t mask,vint8m1_t maskedoff,const int8_t *base,vuint32m4_t bindex,size_t vl)
{
    return vloxei32_v_i8m1_m(mask, maskedoff, base, bindex, 18);
}
