...
vfloat32m2_t
test0_vluxei64_v_f32m2(const float32_t *base,vuint64m4_t bindex,size_t vl)
{
...
vfloat32m2_t
test1_vluxei64_v_f32m2(const float32_t *base,vuint64m4_t bindex,size_t vl)
{
    return vluxei64_v_f32m2(base, bindex, 16);
}
