...
vfloat64m4_t
test0_vluxei8_v_f64m4(const float64_t *base,vuint8mf2_t bindex,size_t vl)
{
...
vfloat64m4_t
test1_vluxei8_v_f64m4(const float64_t *base,vuint8mf2_t bindex,size_t vl)
{
    return vluxei8_v_f64m4(base, bindex, 26);
}
