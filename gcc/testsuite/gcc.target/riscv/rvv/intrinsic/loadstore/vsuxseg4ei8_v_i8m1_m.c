...
void
test1_vsuxseg4ei8_v_i8m1_m(vbool8_t mask,int8_t *base,vuint8m1_t bindex,vint8m1_t v0,vint8m1_t v1,vint8m1_t v2,vint8m1_t v3,size_t vl)
{
    vsuxseg4ei8_v_i8m1_m(mask, base, bindex, v0, v1, v2, v3, 18);
}
