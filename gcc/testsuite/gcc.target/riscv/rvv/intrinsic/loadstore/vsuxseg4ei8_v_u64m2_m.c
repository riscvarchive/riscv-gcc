...
void
test1_vsuxseg4ei8_v_u64m2_m(vbool32_t mask,uint64_t *base,vuint8mf4_t bindex,vuint64m2_t v0,vuint64m2_t v1,vuint64m2_t v2,vuint64m2_t v3,size_t vl)
{
    vsuxseg4ei8_v_u64m2_m(mask, base, bindex, v0, v1, v2, v3, 0);
}
