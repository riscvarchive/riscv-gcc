...
void
test1_vsuxseg3ei8_v_f64m1(float64_t *base,vuint8mf8_t bindex,vfloat64m1_t v0,vfloat64m1_t v1,vfloat64m1_t v2,size_t vl)
{
    vsuxseg3ei8_v_f64m1(base, bindex, v0, v1, v2, 18);
}
