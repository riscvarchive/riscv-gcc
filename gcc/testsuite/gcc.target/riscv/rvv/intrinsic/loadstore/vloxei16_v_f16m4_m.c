...
vfloat16m4_t
test0_vloxei16_v_f16m4_m(vbool4_t mask,vfloat16m4_t maskedoff,const float16_t *base,vuint16m4_t bindex,size_t vl)
{
...
vfloat16m4_t
test1_vloxei16_v_f16m4_m(vbool4_t mask,vfloat16m4_t maskedoff,const float16_t *base,vuint16m4_t bindex,size_t vl)
{
    return vloxei16_v_f16m4_m(mask, maskedoff, base, bindex, 29);
}
