...
vuint8mf8_t
test0_vluxei8_v_u8mf8(const uint8_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vuint8mf8_t
test1_vluxei8_v_u8mf8(const uint8_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vluxei8_v_u8mf8(base, bindex, 7);
}
