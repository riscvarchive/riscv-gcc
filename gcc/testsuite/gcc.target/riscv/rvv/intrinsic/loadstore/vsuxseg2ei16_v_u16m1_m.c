...
void
test1_vsuxseg2ei16_v_u16m1_m(vbool16_t mask,uint16_t *base,vuint16m1_t bindex,vuint16m1_t v0,vuint16m1_t v1,size_t vl)
{
    vsuxseg2ei16_v_u16m1_m(mask, base, bindex, v0, v1, 20);
}
