...
vfloat16mf2_t
test0_vluxei32_v_f16mf2(const float16_t *base,vuint32m1_t bindex,size_t vl)
{
...
vfloat16mf2_t
test1_vluxei32_v_f16mf2(const float16_t *base,vuint32m1_t bindex,size_t vl)
{
    return vluxei32_v_f16mf2(base, bindex, 22);
}
