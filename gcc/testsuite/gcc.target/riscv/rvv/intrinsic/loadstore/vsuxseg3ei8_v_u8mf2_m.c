...
void
test1_vsuxseg3ei8_v_u8mf2_m(vbool16_t mask,uint8_t *base,vuint8mf2_t bindex,vuint8mf2_t v0,vuint8mf2_t v1,vuint8mf2_t v2,size_t vl)
{
    vsuxseg3ei8_v_u8mf2_m(mask, base, bindex, v0, v1, v2, 12);
}
