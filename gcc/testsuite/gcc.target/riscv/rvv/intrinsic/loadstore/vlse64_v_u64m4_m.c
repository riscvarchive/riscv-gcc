...
vuint64m4_t
test0_vlse64_v_u64m4_m(vbool16_t mask,vuint64m4_t maskedoff,const uint64_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint64m4_t
test1_vlse64_v_u64m4_m(vbool16_t mask,vuint64m4_t maskedoff,const uint64_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse64_v_u64m4_m(mask, maskedoff, base, bstride, 21);
}
