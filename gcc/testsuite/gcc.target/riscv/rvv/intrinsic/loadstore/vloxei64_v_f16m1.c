...
vfloat16m1_t
test0_vloxei64_v_f16m1(const float16_t *base,vuint64m4_t bindex,size_t vl)
{
...
vfloat16m1_t
test1_vloxei64_v_f16m1(const float16_t *base,vuint64m4_t bindex,size_t vl)
{
    return vloxei64_v_f16m1(base, bindex, 7);
}
