...
void
test1_vsuxseg3ei16_v_i64m1_m(vbool64_t mask,int64_t *base,vuint16mf4_t bindex,vint64m1_t v0,vint64m1_t v1,vint64m1_t v2,size_t vl)
{
    vsuxseg3ei16_v_i64m1_m(mask, base, bindex, v0, v1, v2, 1);
}
