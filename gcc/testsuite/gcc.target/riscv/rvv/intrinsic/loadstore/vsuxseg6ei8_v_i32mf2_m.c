...
void
test1_vsuxseg6ei8_v_i32mf2_m(vbool64_t mask,int32_t *base,vuint8mf8_t bindex,vint32mf2_t v0,vint32mf2_t v1,vint32mf2_t v2,vint32mf2_t v3,vint32mf2_t v4,vint32mf2_t v5,size_t vl)
{
    vsuxseg6ei8_v_i32mf2_m(mask, base, bindex, v0, v1, v2, v3, v4, v5, 21);
}
