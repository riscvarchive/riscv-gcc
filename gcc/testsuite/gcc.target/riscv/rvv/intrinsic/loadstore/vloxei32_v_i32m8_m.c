...
vint32m8_t
test0_vloxei32_v_i32m8_m(vbool4_t mask,vint32m8_t maskedoff,const int32_t *base,vuint32m8_t bindex,size_t vl)
{
...
vint32m8_t
test1_vloxei32_v_i32m8_m(vbool4_t mask,vint32m8_t maskedoff,const int32_t *base,vuint32m8_t bindex,size_t vl)
{
    return vloxei32_v_i32m8_m(mask, maskedoff, base, bindex, 0);
}
