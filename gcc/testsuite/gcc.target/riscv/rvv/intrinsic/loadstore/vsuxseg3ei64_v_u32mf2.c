...
void
test1_vsuxseg3ei64_v_u32mf2(uint32_t *base,vuint64m1_t bindex,vuint32mf2_t v0,vuint32mf2_t v1,vuint32mf2_t v2,size_t vl)
{
    vsuxseg3ei64_v_u32mf2(base, bindex, v0, v1, v2, 16);
}
