...
vfloat32m8_t
test0_vloxei8_v_f32m8(const float32_t *base,vuint8m2_t bindex,size_t vl)
{
...
vfloat32m8_t
test1_vloxei8_v_f32m8(const float32_t *base,vuint8m2_t bindex,size_t vl)
{
    return vloxei8_v_f32m8(base, bindex, 3);
}
