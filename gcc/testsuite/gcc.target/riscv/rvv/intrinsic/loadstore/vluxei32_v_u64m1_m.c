...
vuint64m1_t
test0_vluxei32_v_u64m1_m(vbool64_t mask,vuint64m1_t maskedoff,const uint64_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vuint64m1_t
test1_vluxei32_v_u64m1_m(vbool64_t mask,vuint64m1_t maskedoff,const uint64_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vluxei32_v_u64m1_m(mask, maskedoff, base, bindex, 21);
}
