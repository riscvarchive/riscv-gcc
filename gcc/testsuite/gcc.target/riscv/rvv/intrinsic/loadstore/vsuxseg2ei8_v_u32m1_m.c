...
void
test1_vsuxseg2ei8_v_u32m1_m(vbool32_t mask,uint32_t *base,vuint8mf4_t bindex,vuint32m1_t v0,vuint32m1_t v1,size_t vl)
{
    vsuxseg2ei8_v_u32m1_m(mask, base, bindex, v0, v1, 15);
}
