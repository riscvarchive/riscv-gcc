...
vint64m2_t
test0_vloxei32_v_i64m2_m(vbool32_t mask,vint64m2_t maskedoff,const int64_t *base,vuint32m1_t bindex,size_t vl)
{
...
vint64m2_t
test1_vloxei32_v_i64m2_m(vbool32_t mask,vint64m2_t maskedoff,const int64_t *base,vuint32m1_t bindex,size_t vl)
{
    return vloxei32_v_i64m2_m(mask, maskedoff, base, bindex, 5);
}
