...
vint16mf2_t
test0_vluxei8_v_i16mf2(const int16_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vint16mf2_t
test1_vluxei8_v_i16mf2(const int16_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vluxei8_v_i16mf2(base, bindex, 25);
}
