...
void
test1_vsuxseg2ei16_v_u8m1_m(vbool8_t mask,uint8_t *base,vuint16m2_t bindex,vuint8m1_t v0,vuint8m1_t v1,size_t vl)
{
    vsuxseg2ei16_v_u8m1_m(mask, base, bindex, v0, v1, 17);
}
