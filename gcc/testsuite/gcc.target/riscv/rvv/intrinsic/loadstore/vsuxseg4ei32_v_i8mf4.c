...
void
test1_vsuxseg4ei32_v_i8mf4(int8_t *base,vuint32m1_t bindex,vint8mf4_t v0,vint8mf4_t v1,vint8mf4_t v2,vint8mf4_t v3,size_t vl)
{
    vsuxseg4ei32_v_i8mf4(base, bindex, v0, v1, v2, v3, 12);
}
