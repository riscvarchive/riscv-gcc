...
vint32m2_t
test0_vluxei64_v_i32m2_m(vbool16_t mask,vint32m2_t maskedoff,const int32_t *base,vuint64m4_t bindex,size_t vl)
{
...
vint32m2_t
test1_vluxei64_v_i32m2_m(vbool16_t mask,vint32m2_t maskedoff,const int32_t *base,vuint64m4_t bindex,size_t vl)
{
    return vluxei64_v_i32m2_m(mask, maskedoff, base, bindex, 12);
}
