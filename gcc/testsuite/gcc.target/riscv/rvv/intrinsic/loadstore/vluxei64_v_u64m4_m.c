...
vuint64m4_t
test0_vluxei64_v_u64m4_m(vbool16_t mask,vuint64m4_t maskedoff,const uint64_t *base,vuint64m4_t bindex,size_t vl)
{
...
vuint64m4_t
test1_vluxei64_v_u64m4_m(vbool16_t mask,vuint64m4_t maskedoff,const uint64_t *base,vuint64m4_t bindex,size_t vl)
{
    return vluxei64_v_u64m4_m(mask, maskedoff, base, bindex, 14);
}
