...
void
test1_vsuxseg4ei16_v_u32m2(uint32_t *base,vuint16m1_t bindex,vuint32m2_t v0,vuint32m2_t v1,vuint32m2_t v2,vuint32m2_t v3,size_t vl)
{
    vsuxseg4ei16_v_u32m2(base, bindex, v0, v1, v2, v3, 26);
}
