...
vuint8mf8_t
test0_vluxei64_v_u8mf8(const uint8_t *base,vuint64m1_t bindex,size_t vl)
{
...
vuint8mf8_t
test1_vluxei64_v_u8mf8(const uint8_t *base,vuint64m1_t bindex,size_t vl)
{
    return vluxei64_v_u8mf8(base, bindex, 13);
}
