...
vfloat64m1_t
test0_vluxei8_v_f64m1_m(vbool64_t mask,vfloat64m1_t maskedoff,const float64_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vfloat64m1_t
test1_vluxei8_v_f64m1_m(vbool64_t mask,vfloat64m1_t maskedoff,const float64_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vluxei8_v_f64m1_m(mask, maskedoff, base, bindex, 3);
}
