...
vint64m2_t
test0_vluxei8_v_i64m2(const int64_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vint64m2_t
test1_vluxei8_v_i64m2(const int64_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vluxei8_v_i64m2(base, bindex, 26);
}
