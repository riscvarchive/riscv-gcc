...
void
test1_vsuxseg4ei16_v_u64m2(uint64_t *base,vuint16mf2_t bindex,vuint64m2_t v0,vuint64m2_t v1,vuint64m2_t v2,vuint64m2_t v3,size_t vl)
{
    vsuxseg4ei16_v_u64m2(base, bindex, v0, v1, v2, v3, 16);
}
