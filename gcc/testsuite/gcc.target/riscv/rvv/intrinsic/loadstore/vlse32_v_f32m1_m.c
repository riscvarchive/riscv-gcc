...
vfloat32m1_t
test0_vlse32_v_f32m1_m(vbool32_t mask,vfloat32m1_t maskedoff,const float32_t *base,ptrdiff_t bstride,size_t vl)
{
...
vfloat32m1_t
test1_vlse32_v_f32m1_m(vbool32_t mask,vfloat32m1_t maskedoff,const float32_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse32_v_f32m1_m(mask, maskedoff, base, bstride, 21);
}
