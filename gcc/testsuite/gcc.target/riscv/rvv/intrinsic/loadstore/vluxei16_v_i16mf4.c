...
vint16mf4_t
test0_vluxei16_v_i16mf4(const int16_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vint16mf4_t
test1_vluxei16_v_i16mf4(const int16_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vluxei16_v_i16mf4(base, bindex, 19);
}
