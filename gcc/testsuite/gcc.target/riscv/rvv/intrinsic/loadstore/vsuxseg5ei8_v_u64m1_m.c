...
void
test1_vsuxseg5ei8_v_u64m1_m(vbool64_t mask,uint64_t *base,vuint8mf8_t bindex,vuint64m1_t v0,vuint64m1_t v1,vuint64m1_t v2,vuint64m1_t v3,vuint64m1_t v4,size_t vl)
{
    vsuxseg5ei8_v_u64m1_m(mask, base, bindex, v0, v1, v2, v3, v4, 29);
}
