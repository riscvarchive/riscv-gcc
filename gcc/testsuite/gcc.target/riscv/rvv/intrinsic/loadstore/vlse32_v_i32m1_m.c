...
vint32m1_t
test0_vlse32_v_i32m1_m(vbool32_t mask,vint32m1_t maskedoff,const int32_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint32m1_t
test1_vlse32_v_i32m1_m(vbool32_t mask,vint32m1_t maskedoff,const int32_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse32_v_i32m1_m(mask, maskedoff, base, bstride, 3);
}
