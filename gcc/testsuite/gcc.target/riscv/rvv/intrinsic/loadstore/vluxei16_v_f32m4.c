...
vfloat32m4_t
test0_vluxei16_v_f32m4(const float32_t *base,vuint16m2_t bindex,size_t vl)
{
...
vfloat32m4_t
test1_vluxei16_v_f32m4(const float32_t *base,vuint16m2_t bindex,size_t vl)
{
    return vluxei16_v_f32m4(base, bindex, 16);
}
