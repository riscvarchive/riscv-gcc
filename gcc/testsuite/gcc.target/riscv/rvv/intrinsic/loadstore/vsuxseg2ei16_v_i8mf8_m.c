...
void
test1_vsuxseg2ei16_v_i8mf8_m(vbool64_t mask,int8_t *base,vuint16mf4_t bindex,vint8mf8_t v0,vint8mf8_t v1,size_t vl)
{
    vsuxseg2ei16_v_i8mf8_m(mask, base, bindex, v0, v1, 8);
}
