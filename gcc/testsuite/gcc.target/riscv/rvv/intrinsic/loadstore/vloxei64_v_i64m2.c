...
vint64m2_t
test0_vloxei64_v_i64m2(const int64_t *base,vuint64m2_t bindex,size_t vl)
{
...
vint64m2_t
test1_vloxei64_v_i64m2(const int64_t *base,vuint64m2_t bindex,size_t vl)
{
    return vloxei64_v_i64m2(base, bindex, 7);
}
