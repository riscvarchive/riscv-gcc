...
vuint16mf2_t
test0_vle16ff_v_u16mf2_m(vbool32_t mask,vuint16mf2_t maskedoff,const uint16_t *base,size_t *new_vl,size_t vl)
{
...
vuint16mf2_t
test1_vle16ff_v_u16mf2_m(vbool32_t mask,vuint16mf2_t maskedoff,const uint16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_u16mf2_m(mask, maskedoff, base, new_vl, 25);
}
