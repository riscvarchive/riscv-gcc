...
void
test1_vsuxseg2ei32_v_i16mf2_m(vbool32_t mask,int16_t *base,vuint32m1_t bindex,vint16mf2_t v0,vint16mf2_t v1,size_t vl)
{
    vsuxseg2ei32_v_i16mf2_m(mask, base, bindex, v0, v1, 18);
}
