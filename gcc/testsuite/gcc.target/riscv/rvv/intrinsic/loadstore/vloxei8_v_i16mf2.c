...
vint16mf2_t
test0_vloxei8_v_i16mf2(const int16_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vint16mf2_t
test1_vloxei8_v_i16mf2(const int16_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vloxei8_v_i16mf2(base, bindex, 22);
}
