...
vuint8mf2_t
test0_vluxei32_v_u8mf2(const uint8_t *base,vuint32m2_t bindex,size_t vl)
{
...
vuint8mf2_t
test1_vluxei32_v_u8mf2(const uint8_t *base,vuint32m2_t bindex,size_t vl)
{
    return vluxei32_v_u8mf2(base, bindex, 3);
}
