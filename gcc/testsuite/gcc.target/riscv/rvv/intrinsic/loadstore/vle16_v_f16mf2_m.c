...
vfloat16mf2_t
test0_vle16_v_f16mf2_m(vbool32_t mask,vfloat16mf2_t maskedoff,const float16_t *base,size_t vl)
{
...
vfloat16mf2_t
test1_vle16_v_f16mf2_m(vbool32_t mask,vfloat16mf2_t maskedoff,const float16_t *base,size_t vl)
{
    return vle16_v_f16mf2_m(mask, maskedoff, base, 1);
}
