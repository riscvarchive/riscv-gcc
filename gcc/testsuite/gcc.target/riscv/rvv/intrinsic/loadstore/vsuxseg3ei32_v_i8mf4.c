...
void
test1_vsuxseg3ei32_v_i8mf4(int8_t *base,vuint32m1_t bindex,vint8mf4_t v0,vint8mf4_t v1,vint8mf4_t v2,size_t vl)
{
    vsuxseg3ei32_v_i8mf4(base, bindex, v0, v1, v2, 3);
}
