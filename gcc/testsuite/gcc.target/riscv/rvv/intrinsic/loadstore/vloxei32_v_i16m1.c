...
vint16m1_t
test0_vloxei32_v_i16m1(const int16_t *base,vuint32m2_t bindex,size_t vl)
{
...
vint16m1_t
test1_vloxei32_v_i16m1(const int16_t *base,vuint32m2_t bindex,size_t vl)
{
    return vloxei32_v_i16m1(base, bindex, 4);
}
