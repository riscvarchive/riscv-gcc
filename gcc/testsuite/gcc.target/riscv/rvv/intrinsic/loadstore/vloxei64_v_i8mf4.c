...
vint8mf4_t
test0_vloxei64_v_i8mf4(const int8_t *base,vuint64m2_t bindex,size_t vl)
{
...
vint8mf4_t
test1_vloxei64_v_i8mf4(const int8_t *base,vuint64m2_t bindex,size_t vl)
{
    return vloxei64_v_i8mf4(base, bindex, 11);
}
