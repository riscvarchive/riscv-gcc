...
vfloat16m2_t
test0_vluxei16_v_f16m2(const float16_t *base,vuint16m2_t bindex,size_t vl)
{
...
vfloat16m2_t
test1_vluxei16_v_f16m2(const float16_t *base,vuint16m2_t bindex,size_t vl)
{
    return vluxei16_v_f16m2(base, bindex, 3);
}
