...
vuint64m2_t
test0_vluxei8_v_u64m2(const uint64_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vuint64m2_t
test1_vluxei8_v_u64m2(const uint64_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vluxei8_v_u64m2(base, bindex, 22);
}
