...
vfloat16mf4_t
test0_vluxei8_v_f16mf4_tu(vfloat16mf4_t dest,const float16_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vfloat16mf4_t
test1_vluxei8_v_f16mf4_tu(vfloat16mf4_t dest,const float16_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vluxei8_v_f16mf4_tu(dest, base, bindex, 17);
}
