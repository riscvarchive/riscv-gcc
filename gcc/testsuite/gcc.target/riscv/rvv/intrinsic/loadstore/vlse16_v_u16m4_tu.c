...
vuint16m4_t
test0_vlse16_v_u16m4_tu(vuint16m4_t dest,const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint16m4_t
test1_vlse16_v_u16m4_tu(vuint16m4_t dest,const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_u16m4_tu(dest, base, bstride, 2);
}
