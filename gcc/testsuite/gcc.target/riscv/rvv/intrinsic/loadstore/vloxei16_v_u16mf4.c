...
vuint16mf4_t
test0_vloxei16_v_u16mf4(const uint16_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vuint16mf4_t
test1_vloxei16_v_u16mf4(const uint16_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vloxei16_v_u16mf4(base, bindex, 7);
}
