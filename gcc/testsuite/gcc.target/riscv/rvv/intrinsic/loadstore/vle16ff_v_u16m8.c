...
vuint16m8_t
test0_vle16ff_v_u16m8(const uint16_t *base,size_t *new_vl,size_t vl)
{
...
vuint16m8_t
test1_vle16ff_v_u16m8(const uint16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_u16m8(base, new_vl, 2);
}
