...
vuint64m1_t
test0_vluxei16_v_u64m1(const uint64_t *base,vuint16mf4_t bindex,size_t vl)
{
...
vuint64m1_t
test1_vluxei16_v_u64m1(const uint64_t *base,vuint16mf4_t bindex,size_t vl)
{
    return vluxei16_v_u64m1(base, bindex, 18);
}
