...
vint32mf2_t
test0_vle32_v_i32mf2_tu(vint32mf2_t dest,const int32_t *base,size_t vl)
{
...
vint32mf2_t
test1_vle32_v_i32mf2_tu(vint32mf2_t dest,const int32_t *base,size_t vl)
{
    return vle32_v_i32mf2_tu(dest, base, 23);
}
