...
void
test1_vsuxseg3ei16_v_u16mf4(uint16_t *base,vuint16mf4_t bindex,vuint16mf4_t v0,vuint16mf4_t v1,vuint16mf4_t v2,size_t vl)
{
    vsuxseg3ei16_v_u16mf4(base, bindex, v0, v1, v2, 5);
}
