...
vuint32m1_t
test0_vluxei16_v_u32m1(const uint32_t *base,vuint16mf2_t bindex,size_t vl)
{
...
vuint32m1_t
test1_vluxei16_v_u32m1(const uint32_t *base,vuint16mf2_t bindex,size_t vl)
{
    return vluxei16_v_u32m1(base, bindex, 13);
}
