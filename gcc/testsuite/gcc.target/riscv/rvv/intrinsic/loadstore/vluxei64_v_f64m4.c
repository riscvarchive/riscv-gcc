...
vfloat64m4_t
test0_vluxei64_v_f64m4(const float64_t *base,vuint64m4_t bindex,size_t vl)
{
...
vfloat64m4_t
test1_vluxei64_v_f64m4(const float64_t *base,vuint64m4_t bindex,size_t vl)
{
    return vluxei64_v_f64m4(base, bindex, 16);
}
