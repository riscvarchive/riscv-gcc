...
vint8m1_t
test0_vle8_v_i8m1_m(vbool8_t mask,vint8m1_t maskedoff,const int8_t *base,size_t vl)
{
...
vint8m1_t
test1_vle8_v_i8m1_m(vbool8_t mask,vint8m1_t maskedoff,const int8_t *base,size_t vl)
{
    return vle8_v_i8m1_m(mask, maskedoff, base, 9);
}
