...
void
test1_vsuxseg4ei64_v_i16m2(int16_t *base,vuint64m8_t bindex,vint16m2_t v0,vint16m2_t v1,vint16m2_t v2,vint16m2_t v3,size_t vl)
{
    vsuxseg4ei64_v_i16m2(base, bindex, v0, v1, v2, v3, 22);
}
