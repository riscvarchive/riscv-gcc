...
vint8mf8_t
test0_vle8ff_v_i8mf8(const int8_t *base,size_t *new_vl,size_t vl)
{
...
vint8mf8_t
test1_vle8ff_v_i8mf8(const int8_t *base,size_t *new_vl,size_t vl)
{
    return vle8ff_v_i8mf8(base, new_vl, 0);
}
