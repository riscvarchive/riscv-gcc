...
vfloat64m1_t
test0_vloxei32_v_f64m1(const float64_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vfloat64m1_t
test1_vloxei32_v_f64m1(const float64_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vloxei32_v_f64m1(base, bindex, 14);
}
