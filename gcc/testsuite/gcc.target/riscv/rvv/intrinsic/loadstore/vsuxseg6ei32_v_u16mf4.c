...
void
test1_vsuxseg6ei32_v_u16mf4(uint16_t *base,vuint32mf2_t bindex,vuint16mf4_t v0,vuint16mf4_t v1,vuint16mf4_t v2,vuint16mf4_t v3,vuint16mf4_t v4,vuint16mf4_t v5,size_t vl)
{
    vsuxseg6ei32_v_u16mf4(base, bindex, v0, v1, v2, v3, v4, v5, 17);
}
