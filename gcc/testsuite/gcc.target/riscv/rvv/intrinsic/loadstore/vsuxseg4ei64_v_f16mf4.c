...
void
test1_vsuxseg4ei64_v_f16mf4(float16_t *base,vuint64m1_t bindex,vfloat16mf4_t v0,vfloat16mf4_t v1,vfloat16mf4_t v2,vfloat16mf4_t v3,size_t vl)
{
    vsuxseg4ei64_v_f16mf4(base, bindex, v0, v1, v2, v3, 7);
}
