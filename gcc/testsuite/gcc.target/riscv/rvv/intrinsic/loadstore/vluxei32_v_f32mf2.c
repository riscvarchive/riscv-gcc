...
vfloat32mf2_t
test0_vluxei32_v_f32mf2(const float32_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vfloat32mf2_t
test1_vluxei32_v_f32mf2(const float32_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vluxei32_v_f32mf2(base, bindex, 7);
}
