...
vuint8m1_t
test0_vluxei16_v_u8m1(const uint8_t *base,vuint16m2_t bindex,size_t vl)
{
...
vuint8m1_t
test1_vluxei16_v_u8m1(const uint8_t *base,vuint16m2_t bindex,size_t vl)
{
    return vluxei16_v_u8m1(base, bindex, 17);
}
