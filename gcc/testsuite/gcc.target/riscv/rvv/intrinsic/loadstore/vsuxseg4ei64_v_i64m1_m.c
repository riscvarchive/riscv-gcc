...
void
test1_vsuxseg4ei64_v_i64m1_m(vbool64_t mask,int64_t *base,vuint64m1_t bindex,vint64m1_t v0,vint64m1_t v1,vint64m1_t v2,vint64m1_t v3,size_t vl)
{
    vsuxseg4ei64_v_i64m1_m(mask, base, bindex, v0, v1, v2, v3, 21);
}
