...
vuint64m2_t
test0_vloxei64_v_u64m2(const uint64_t *base,vuint64m2_t bindex,size_t vl)
{
...
vuint64m2_t
test1_vloxei64_v_u64m2(const uint64_t *base,vuint64m2_t bindex,size_t vl)
{
    return vloxei64_v_u64m2(base, bindex, 19);
}
