...
void
test1_vsuxseg5ei8_v_u16mf4_m(vbool64_t mask,uint16_t *base,vuint8mf8_t bindex,vuint16mf4_t v0,vuint16mf4_t v1,vuint16mf4_t v2,vuint16mf4_t v3,vuint16mf4_t v4,size_t vl)
{
    vsuxseg5ei8_v_u16mf4_m(mask, base, bindex, v0, v1, v2, v3, v4, 1);
}
