...
vint16mf2_t
test0_vluxei64_v_i16mf2(const int16_t *base,vuint64m2_t bindex,size_t vl)
{
...
vint16mf2_t
test1_vluxei64_v_i16mf2(const int16_t *base,vuint64m2_t bindex,size_t vl)
{
    return vluxei64_v_i16mf2(base, bindex, 16);
}
