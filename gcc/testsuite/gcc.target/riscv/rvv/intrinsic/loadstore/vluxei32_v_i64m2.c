...
vint64m2_t
test0_vluxei32_v_i64m2(const int64_t *base,vuint32m1_t bindex,size_t vl)
{
...
vint64m2_t
test1_vluxei32_v_i64m2(const int64_t *base,vuint32m1_t bindex,size_t vl)
{
    return vluxei32_v_i64m2(base, bindex, 4);
}
