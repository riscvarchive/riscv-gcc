...
vint32m2_t
test0_vloxei32_v_i32m2(const int32_t *base,vuint32m2_t bindex,size_t vl)
{
...
vint32m2_t
test1_vloxei32_v_i32m2(const int32_t *base,vuint32m2_t bindex,size_t vl)
{
    return vloxei32_v_i32m2(base, bindex, 1);
}
