...
vfloat16mf4_t
test0_vloxei8_v_f16mf4(const float16_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vfloat16mf4_t
test1_vloxei8_v_f16mf4(const float16_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vloxei8_v_f16mf4(base, bindex, 9);
}
