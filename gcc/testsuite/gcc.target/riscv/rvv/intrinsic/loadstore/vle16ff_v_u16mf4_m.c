...
vuint16mf4_t
test0_vle16ff_v_u16mf4_m(vbool64_t mask,vuint16mf4_t maskedoff,const uint16_t *base,size_t *new_vl,size_t vl)
{
...
vuint16mf4_t
test1_vle16ff_v_u16mf4_m(vbool64_t mask,vuint16mf4_t maskedoff,const uint16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_u16mf4_m(mask, maskedoff, base, new_vl, 22);
}
