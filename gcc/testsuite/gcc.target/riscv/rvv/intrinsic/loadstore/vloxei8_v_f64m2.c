...
vfloat64m2_t
test0_vloxei8_v_f64m2(const float64_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vfloat64m2_t
test1_vloxei8_v_f64m2(const float64_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vloxei8_v_f64m2(base, bindex, 22);
}
