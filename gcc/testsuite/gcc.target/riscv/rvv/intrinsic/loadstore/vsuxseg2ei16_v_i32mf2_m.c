...
void
test1_vsuxseg2ei16_v_i32mf2_m(vbool64_t mask,int32_t *base,vuint16mf4_t bindex,vint32mf2_t v0,vint32mf2_t v1,size_t vl)
{
    vsuxseg2ei16_v_i32mf2_m(mask, base, bindex, v0, v1, 8);
}
