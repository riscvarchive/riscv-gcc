...
void
test1_vsuxseg2ei8_v_i8mf2_m(vbool16_t mask,int8_t *base,vuint8mf2_t bindex,vint8mf2_t v0,vint8mf2_t v1,size_t vl)
{
    vsuxseg2ei8_v_i8mf2_m(mask, base, bindex, v0, v1, 22);
}
