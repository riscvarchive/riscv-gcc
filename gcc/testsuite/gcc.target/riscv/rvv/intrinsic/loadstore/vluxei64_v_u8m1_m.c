...
vuint8m1_t
test0_vluxei64_v_u8m1_m(vbool8_t mask,vuint8m1_t maskedoff,const uint8_t *base,vuint64m8_t bindex,size_t vl)
{
...
vuint8m1_t
test1_vluxei64_v_u8m1_m(vbool8_t mask,vuint8m1_t maskedoff,const uint8_t *base,vuint64m8_t bindex,size_t vl)
{
    return vluxei64_v_u8m1_m(mask, maskedoff, base, bindex, 2);
}
