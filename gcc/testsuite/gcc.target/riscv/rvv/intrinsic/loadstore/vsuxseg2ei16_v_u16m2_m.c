...
void
test1_vsuxseg2ei16_v_u16m2_m(vbool8_t mask,uint16_t *base,vuint16m2_t bindex,vuint16m2_t v0,vuint16m2_t v1,size_t vl)
{
    vsuxseg2ei16_v_u16m2_m(mask, base, bindex, v0, v1, 28);
}
