...
vfloat64m1_t
test0_vluxei64_v_f64m1(const float64_t *base,vuint64m1_t bindex,size_t vl)
{
...
vfloat64m1_t
test1_vluxei64_v_f64m1(const float64_t *base,vuint64m1_t bindex,size_t vl)
{
    return vluxei64_v_f64m1(base, bindex, 20);
}
