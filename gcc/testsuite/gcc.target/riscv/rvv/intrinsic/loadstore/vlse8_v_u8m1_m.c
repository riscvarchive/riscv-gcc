...
vuint8m1_t
test0_vlse8_v_u8m1_m(vbool8_t mask,vuint8m1_t maskedoff,const uint8_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint8m1_t
test1_vlse8_v_u8m1_m(vbool8_t mask,vuint8m1_t maskedoff,const uint8_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse8_v_u8m1_m(mask, maskedoff, base, bstride, 15);
}
