...
vfloat16m1_t
test0_vloxei16_v_f16m1_m(vbool16_t mask,vfloat16m1_t maskedoff,const float16_t *base,vuint16m1_t bindex,size_t vl)
{
...
vfloat16m1_t
test1_vloxei16_v_f16m1_m(vbool16_t mask,vfloat16m1_t maskedoff,const float16_t *base,vuint16m1_t bindex,size_t vl)
{
    return vloxei16_v_f16m1_m(mask, maskedoff, base, bindex, 3);
}
