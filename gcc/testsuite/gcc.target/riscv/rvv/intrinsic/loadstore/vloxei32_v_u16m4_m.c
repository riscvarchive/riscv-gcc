...
vuint16m4_t
test0_vloxei32_v_u16m4_m(vbool4_t mask,vuint16m4_t maskedoff,const uint16_t *base,vuint32m8_t bindex,size_t vl)
{
...
vuint16m4_t
test1_vloxei32_v_u16m4_m(vbool4_t mask,vuint16m4_t maskedoff,const uint16_t *base,vuint32m8_t bindex,size_t vl)
{
    return vloxei32_v_u16m4_m(mask, maskedoff, base, bindex, 31);
}
