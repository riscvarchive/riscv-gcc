...
void
test1_vsuxseg4ei16_v_f32m2(float32_t *base,vuint16m1_t bindex,vfloat32m2_t v0,vfloat32m2_t v1,vfloat32m2_t v2,vfloat32m2_t v3,size_t vl)
{
    vsuxseg4ei16_v_f32m2(base, bindex, v0, v1, v2, v3, 24);
}
