...
vint32m8_t
test0_vlse32_v_i32m8_m(vbool4_t mask,vint32m8_t maskedoff,const int32_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint32m8_t
test1_vlse32_v_i32m8_m(vbool4_t mask,vint32m8_t maskedoff,const int32_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse32_v_i32m8_m(mask, maskedoff, base, bstride, 15);
}
