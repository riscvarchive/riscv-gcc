...
vuint32m4_t
test0_vluxei8_v_u32m4(const uint32_t *base,vuint8m1_t bindex,size_t vl)
{
...
vuint32m4_t
test1_vluxei8_v_u32m4(const uint32_t *base,vuint8m1_t bindex,size_t vl)
{
    return vluxei8_v_u32m4(base, bindex, 26);
}
