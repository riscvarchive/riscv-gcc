...
vint16m1_t
test0_vloxei16_v_i16m1_m(vbool16_t mask,vint16m1_t maskedoff,const int16_t *base,vuint16m1_t bindex,size_t vl)
{
...
vint16m1_t
test1_vloxei16_v_i16m1_m(vbool16_t mask,vint16m1_t maskedoff,const int16_t *base,vuint16m1_t bindex,size_t vl)
{
    return vloxei16_v_i16m1_m(mask, maskedoff, base, bindex, 17);
}
