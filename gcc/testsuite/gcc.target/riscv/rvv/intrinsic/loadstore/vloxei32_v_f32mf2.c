...
vfloat32mf2_t
test0_vloxei32_v_f32mf2(const float32_t *base,vuint32mf2_t bindex,size_t vl)
{
...
vfloat32mf2_t
test1_vloxei32_v_f32mf2(const float32_t *base,vuint32mf2_t bindex,size_t vl)
{
    return vloxei32_v_f32mf2(base, bindex, 28);
}
