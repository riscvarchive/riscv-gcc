...
vuint32m4_t
test0_vloxei64_v_u32m4(const uint32_t *base,vuint64m8_t bindex,size_t vl)
{
...
vuint32m4_t
test1_vloxei64_v_u32m4(const uint32_t *base,vuint64m8_t bindex,size_t vl)
{
    return vloxei64_v_u32m4(base, bindex, 3);
}
