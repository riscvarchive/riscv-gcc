...
void
test1_vsuxseg4ei16_v_i16m2_m(vbool8_t mask,int16_t *base,vuint16m2_t bindex,vint16m2_t v0,vint16m2_t v1,vint16m2_t v2,vint16m2_t v3,size_t vl)
{
    vsuxseg4ei16_v_i16m2_m(mask, base, bindex, v0, v1, v2, v3, 3);
}
