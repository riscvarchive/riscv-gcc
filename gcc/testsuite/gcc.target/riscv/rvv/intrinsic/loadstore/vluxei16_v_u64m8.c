...
vuint64m8_t
test0_vluxei16_v_u64m8(const uint64_t *base,vuint16m2_t bindex,size_t vl)
{
...
vuint64m8_t
test1_vluxei16_v_u64m8(const uint64_t *base,vuint16m2_t bindex,size_t vl)
{
    return vluxei16_v_u64m8(base, bindex, 25);
}
