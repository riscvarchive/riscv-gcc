...
vuint16mf4_t
test0_vlse16_v_u16mf4_tu(vuint16mf4_t dest,const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint16mf4_t
test1_vlse16_v_u16mf4_tu(vuint16mf4_t dest,const uint16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_u16mf4_tu(dest, base, bstride, 17);
}
