...
void
test1_vsuxseg3ei8_v_f32mf2_m(vbool64_t mask,float32_t *base,vuint8mf8_t bindex,vfloat32mf2_t v0,vfloat32mf2_t v1,vfloat32mf2_t v2,size_t vl)
{
    vsuxseg3ei8_v_f32mf2_m(mask, base, bindex, v0, v1, v2, 19);
}
