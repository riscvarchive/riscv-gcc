...
void
test1_vsuxseg5ei32_v_i32m1(int32_t *base,vuint32m1_t bindex,vint32m1_t v0,vint32m1_t v1,vint32m1_t v2,vint32m1_t v3,vint32m1_t v4,size_t vl)
{
    vsuxseg5ei32_v_i32m1(base, bindex, v0, v1, v2, v3, v4, 1);
}
