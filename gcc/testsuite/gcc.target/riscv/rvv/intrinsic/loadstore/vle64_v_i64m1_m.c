...
vint64m1_t
test0_vle64_v_i64m1_m(vbool64_t mask,vint64m1_t maskedoff,const int64_t *base,size_t vl)
{
...
vint64m1_t
test1_vle64_v_i64m1_m(vbool64_t mask,vint64m1_t maskedoff,const int64_t *base,size_t vl)
{
    return vle64_v_i64m1_m(mask, maskedoff, base, 21);
}
