...
vint16mf2_t
test0_vlse16_v_i16mf2(const int16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint16mf2_t
test1_vlse16_v_i16mf2(const int16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_i16mf2(base, bstride, 1);
}
