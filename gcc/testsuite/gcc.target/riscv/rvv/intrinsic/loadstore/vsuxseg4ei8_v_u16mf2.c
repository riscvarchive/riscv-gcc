...
void
test1_vsuxseg4ei8_v_u16mf2(uint16_t *base,vuint8mf4_t bindex,vuint16mf2_t v0,vuint16mf2_t v1,vuint16mf2_t v2,vuint16mf2_t v3,size_t vl)
{
    vsuxseg4ei8_v_u16mf2(base, bindex, v0, v1, v2, v3, 22);
}
