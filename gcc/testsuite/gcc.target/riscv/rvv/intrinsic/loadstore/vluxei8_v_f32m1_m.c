...
vfloat32m1_t
test0_vluxei8_v_f32m1_m(vbool32_t mask,vfloat32m1_t maskedoff,const float32_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vfloat32m1_t
test1_vluxei8_v_f32m1_m(vbool32_t mask,vfloat32m1_t maskedoff,const float32_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vluxei8_v_f32m1_m(mask, maskedoff, base, bindex, 21);
}
