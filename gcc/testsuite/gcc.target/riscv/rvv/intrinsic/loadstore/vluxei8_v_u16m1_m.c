...
vuint16m1_t
test0_vluxei8_v_u16m1_m(vbool16_t mask,vuint16m1_t maskedoff,const uint16_t *base,vuint8mf2_t bindex,size_t vl)
{
...
vuint16m1_t
test1_vluxei8_v_u16m1_m(vbool16_t mask,vuint16m1_t maskedoff,const uint16_t *base,vuint8mf2_t bindex,size_t vl)
{
    return vluxei8_v_u16m1_m(mask, maskedoff, base, bindex, 12);
}
