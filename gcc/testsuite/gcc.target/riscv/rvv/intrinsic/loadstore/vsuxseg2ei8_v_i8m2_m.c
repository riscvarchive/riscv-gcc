...
void
test1_vsuxseg2ei8_v_i8m2_m(vbool4_t mask,int8_t *base,vuint8m2_t bindex,vint8m2_t v0,vint8m2_t v1,size_t vl)
{
    vsuxseg2ei8_v_i8m2_m(mask, base, bindex, v0, v1, 20);
}
