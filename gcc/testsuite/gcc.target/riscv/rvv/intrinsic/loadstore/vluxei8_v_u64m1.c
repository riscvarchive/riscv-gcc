...
vuint64m1_t
test0_vluxei8_v_u64m1(const uint64_t *base,vuint8mf8_t bindex,size_t vl)
{
...
vuint64m1_t
test1_vluxei8_v_u64m1(const uint64_t *base,vuint8mf8_t bindex,size_t vl)
{
    return vluxei8_v_u64m1(base, bindex, 29);
}
