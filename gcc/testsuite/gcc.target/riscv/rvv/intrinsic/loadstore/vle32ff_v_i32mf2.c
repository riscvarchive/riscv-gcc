...
vint32mf2_t
test0_vle32ff_v_i32mf2(const int32_t *base,size_t *new_vl,size_t vl)
{
...
vint32mf2_t
test1_vle32ff_v_i32mf2(const int32_t *base,size_t *new_vl,size_t vl)
{
    return vle32ff_v_i32mf2(base, new_vl, 8);
}
