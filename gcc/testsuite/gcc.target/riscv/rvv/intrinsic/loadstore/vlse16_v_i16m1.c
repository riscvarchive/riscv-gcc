...
vint16m1_t
test0_vlse16_v_i16m1(const int16_t *base,ptrdiff_t bstride,size_t vl)
{
...
vint16m1_t
test1_vlse16_v_i16m1(const int16_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse16_v_i16m1(base, bstride, 0);
}
