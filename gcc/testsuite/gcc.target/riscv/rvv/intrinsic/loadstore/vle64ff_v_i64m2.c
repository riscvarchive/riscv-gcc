...
vint64m2_t
test0_vle64ff_v_i64m2(const int64_t *base,size_t *new_vl,size_t vl)
{
...
vint64m2_t
test1_vle64ff_v_i64m2(const int64_t *base,size_t *new_vl,size_t vl)
{
    return vle64ff_v_i64m2(base, new_vl, 4);
}
