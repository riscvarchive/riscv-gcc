...
void
test1_vsuxseg6ei8_v_i64m1(int64_t *base,vuint8mf8_t bindex,vint64m1_t v0,vint64m1_t v1,vint64m1_t v2,vint64m1_t v3,vint64m1_t v4,vint64m1_t v5,size_t vl)
{
    vsuxseg6ei8_v_i64m1(base, bindex, v0, v1, v2, v3, v4, v5, 25);
}
