...
void
test1_vsuxseg3ei32_v_f32m1(float32_t *base,vuint32m1_t bindex,vfloat32m1_t v0,vfloat32m1_t v1,vfloat32m1_t v2,size_t vl)
{
    vsuxseg3ei32_v_f32m1(base, bindex, v0, v1, v2, 28);
}
