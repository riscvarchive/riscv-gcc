...
void
test1_vsuxseg4ei64_v_u8mf8_m(vbool64_t mask,uint8_t *base,vuint64m1_t bindex,vuint8mf8_t v0,vuint8mf8_t v1,vuint8mf8_t v2,vuint8mf8_t v3,size_t vl)
{
    vsuxseg4ei64_v_u8mf8_m(mask, base, bindex, v0, v1, v2, v3, 11);
}
