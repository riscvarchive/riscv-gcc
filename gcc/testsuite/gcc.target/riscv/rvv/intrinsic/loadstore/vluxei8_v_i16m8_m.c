...
vint16m8_t
test0_vluxei8_v_i16m8_m(vbool2_t mask,vint16m8_t maskedoff,const int16_t *base,vuint8m4_t bindex,size_t vl)
{
...
vint16m8_t
test1_vluxei8_v_i16m8_m(vbool2_t mask,vint16m8_t maskedoff,const int16_t *base,vuint8m4_t bindex,size_t vl)
{
    return vluxei8_v_i16m8_m(mask, maskedoff, base, bindex, 23);
}
