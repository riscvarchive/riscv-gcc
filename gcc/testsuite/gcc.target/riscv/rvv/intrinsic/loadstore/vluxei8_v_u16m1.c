...
vuint16m1_t
test0_vluxei8_v_u16m1(const uint16_t *base,vuint8mf2_t bindex,size_t vl)
{
...
vuint16m1_t
test1_vluxei8_v_u16m1(const uint16_t *base,vuint8mf2_t bindex,size_t vl)
{
    return vluxei8_v_u16m1(base, bindex, 20);
}
