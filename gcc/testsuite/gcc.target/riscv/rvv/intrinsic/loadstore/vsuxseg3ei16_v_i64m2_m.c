...
void
test1_vsuxseg3ei16_v_i64m2_m(vbool32_t mask,int64_t *base,vuint16mf2_t bindex,vint64m2_t v0,vint64m2_t v1,vint64m2_t v2,size_t vl)
{
    vsuxseg3ei16_v_i64m2_m(mask, base, bindex, v0, v1, v2, 28);
}
