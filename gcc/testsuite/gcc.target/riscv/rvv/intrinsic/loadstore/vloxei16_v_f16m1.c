...
vfloat16m1_t
test0_vloxei16_v_f16m1(const float16_t *base,vuint16m1_t bindex,size_t vl)
{
...
vfloat16m1_t
test1_vloxei16_v_f16m1(const float16_t *base,vuint16m1_t bindex,size_t vl)
{
    return vloxei16_v_f16m1(base, bindex, 6);
}
