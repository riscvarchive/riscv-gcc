...
vint64m8_t
test0_vluxei32_v_i64m8(const int64_t *base,vuint32m4_t bindex,size_t vl)
{
...
vint64m8_t
test1_vluxei32_v_i64m8(const int64_t *base,vuint32m4_t bindex,size_t vl)
{
    return vluxei32_v_i64m8(base, bindex, 9);
}
