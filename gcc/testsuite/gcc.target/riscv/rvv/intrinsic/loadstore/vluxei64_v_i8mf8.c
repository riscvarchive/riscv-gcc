...
vint8mf8_t
test0_vluxei64_v_i8mf8(const int8_t *base,vuint64m1_t bindex,size_t vl)
{
...
vint8mf8_t
test1_vluxei64_v_i8mf8(const int8_t *base,vuint64m1_t bindex,size_t vl)
{
    return vluxei64_v_i8mf8(base, bindex, 19);
}
