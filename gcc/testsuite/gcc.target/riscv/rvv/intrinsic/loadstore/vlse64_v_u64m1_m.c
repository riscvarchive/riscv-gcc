...
vuint64m1_t
test0_vlse64_v_u64m1_m(vbool64_t mask,vuint64m1_t maskedoff,const uint64_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint64m1_t
test1_vlse64_v_u64m1_m(vbool64_t mask,vuint64m1_t maskedoff,const uint64_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse64_v_u64m1_m(mask, maskedoff, base, bstride, 21);
}
