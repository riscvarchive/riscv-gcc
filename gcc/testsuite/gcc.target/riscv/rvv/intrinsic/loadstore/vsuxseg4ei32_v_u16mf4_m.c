...
void
test1_vsuxseg4ei32_v_u16mf4_m(vbool64_t mask,uint16_t *base,vuint32mf2_t bindex,vuint16mf4_t v0,vuint16mf4_t v1,vuint16mf4_t v2,vuint16mf4_t v3,size_t vl)
{
    vsuxseg4ei32_v_u16mf4_m(mask, base, bindex, v0, v1, v2, v3, 29);
}
