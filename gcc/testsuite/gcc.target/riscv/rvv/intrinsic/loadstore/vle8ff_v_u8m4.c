...
vuint8m4_t
test0_vle8ff_v_u8m4(const uint8_t *base,size_t *new_vl,size_t vl)
{
...
vuint8m4_t
test1_vle8ff_v_u8m4(const uint8_t *base,size_t *new_vl,size_t vl)
{
    return vle8ff_v_u8m4(base, new_vl, 25);
}
