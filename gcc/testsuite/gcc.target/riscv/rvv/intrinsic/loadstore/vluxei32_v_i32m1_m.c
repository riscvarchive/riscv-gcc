...
vint32m1_t
test0_vluxei32_v_i32m1_m(vbool32_t mask,vint32m1_t maskedoff,const int32_t *base,vuint32m1_t bindex,size_t vl)
{
...
vint32m1_t
test1_vluxei32_v_i32m1_m(vbool32_t mask,vint32m1_t maskedoff,const int32_t *base,vuint32m1_t bindex,size_t vl)
{
    return vluxei32_v_i32m1_m(mask, maskedoff, base, bindex, 21);
}
