...
vuint64m2_t
test0_vlse64_v_u64m2_tu(vuint64m2_t dest,const uint64_t *base,ptrdiff_t bstride,size_t vl)
{
...
vuint64m2_t
test1_vlse64_v_u64m2_tu(vuint64m2_t dest,const uint64_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse64_v_u64m2_tu(dest, base, bstride, 1);
}
