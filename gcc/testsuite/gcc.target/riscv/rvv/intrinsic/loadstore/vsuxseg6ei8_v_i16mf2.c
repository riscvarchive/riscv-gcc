...
void
test1_vsuxseg6ei8_v_i16mf2(int16_t *base,vuint8mf4_t bindex,vint16mf2_t v0,vint16mf2_t v1,vint16mf2_t v2,vint16mf2_t v3,vint16mf2_t v4,vint16mf2_t v5,size_t vl)
{
    vsuxseg6ei8_v_i16mf2(base, bindex, v0, v1, v2, v3, v4, v5, 5);
}
