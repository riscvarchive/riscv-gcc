...
vint32m2_t
test0_vluxei8_v_i32m2_m(vbool16_t mask,vint32m2_t maskedoff,const int32_t *base,vuint8mf2_t bindex,size_t vl)
{
...
vint32m2_t
test1_vluxei8_v_i32m2_m(vbool16_t mask,vint32m2_t maskedoff,const int32_t *base,vuint8mf2_t bindex,size_t vl)
{
    return vluxei8_v_i32m2_m(mask, maskedoff, base, bindex, 27);
}
