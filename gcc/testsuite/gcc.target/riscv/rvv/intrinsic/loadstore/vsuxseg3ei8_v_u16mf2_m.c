...
void
test1_vsuxseg3ei8_v_u16mf2_m(vbool32_t mask,uint16_t *base,vuint8mf4_t bindex,vuint16mf2_t v0,vuint16mf2_t v1,vuint16mf2_t v2,size_t vl)
{
    vsuxseg3ei8_v_u16mf2_m(mask, base, bindex, v0, v1, v2, 13);
}
