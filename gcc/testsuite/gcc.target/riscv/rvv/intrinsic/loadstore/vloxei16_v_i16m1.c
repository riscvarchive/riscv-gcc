...
vint16m1_t
test0_vloxei16_v_i16m1(const int16_t *base,vuint16m1_t bindex,size_t vl)
{
...
vint16m1_t
test1_vloxei16_v_i16m1(const int16_t *base,vuint16m1_t bindex,size_t vl)
{
    return vloxei16_v_i16m1(base, bindex, 29);
}
