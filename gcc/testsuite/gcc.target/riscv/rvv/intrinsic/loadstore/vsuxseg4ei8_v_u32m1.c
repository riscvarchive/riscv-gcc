...
void
test1_vsuxseg4ei8_v_u32m1(uint32_t *base,vuint8mf4_t bindex,vuint32m1_t v0,vuint32m1_t v1,vuint32m1_t v2,vuint32m1_t v3,size_t vl)
{
    vsuxseg4ei8_v_u32m1(base, bindex, v0, v1, v2, v3, 11);
}
