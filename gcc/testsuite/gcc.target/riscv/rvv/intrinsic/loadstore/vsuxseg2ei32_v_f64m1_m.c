...
void
test1_vsuxseg2ei32_v_f64m1_m(vbool64_t mask,float64_t *base,vuint32mf2_t bindex,vfloat64m1_t v0,vfloat64m1_t v1,size_t vl)
{
    vsuxseg2ei32_v_f64m1_m(mask, base, bindex, v0, v1, 26);
}
