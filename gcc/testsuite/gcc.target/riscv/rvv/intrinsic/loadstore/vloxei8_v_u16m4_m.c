...
vuint16m4_t
test0_vloxei8_v_u16m4_m(vbool4_t mask,vuint16m4_t maskedoff,const uint16_t *base,vuint8m2_t bindex,size_t vl)
{
...
vuint16m4_t
test1_vloxei8_v_u16m4_m(vbool4_t mask,vuint16m4_t maskedoff,const uint16_t *base,vuint8m2_t bindex,size_t vl)
{
    return vloxei8_v_u16m4_m(mask, maskedoff, base, bindex, 6);
}
