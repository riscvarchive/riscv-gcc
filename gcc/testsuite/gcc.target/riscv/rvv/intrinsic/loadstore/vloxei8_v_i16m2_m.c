...
vint16m2_t
test0_vloxei8_v_i16m2_m(vbool8_t mask,vint16m2_t maskedoff,const int16_t *base,vuint8m1_t bindex,size_t vl)
{
...
vint16m2_t
test1_vloxei8_v_i16m2_m(vbool8_t mask,vint16m2_t maskedoff,const int16_t *base,vuint8m1_t bindex,size_t vl)
{
    return vloxei8_v_i16m2_m(mask, maskedoff, base, bindex, 8);
}
