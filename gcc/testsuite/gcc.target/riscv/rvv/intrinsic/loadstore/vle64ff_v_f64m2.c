...
vfloat64m2_t
test0_vle64ff_v_f64m2(const float64_t *base,size_t *new_vl,size_t vl)
{
...
vfloat64m2_t
test1_vle64ff_v_f64m2(const float64_t *base,size_t *new_vl,size_t vl)
{
    return vle64ff_v_f64m2(base, new_vl, 3);
}
