...
vint64m4_t
test0_vloxei32_v_i64m4(const int64_t *base,vuint32m2_t bindex,size_t vl)
{
...
vint64m4_t
test1_vloxei32_v_i64m4(const int64_t *base,vuint32m2_t bindex,size_t vl)
{
    return vloxei32_v_i64m4(base, bindex, 14);
}
