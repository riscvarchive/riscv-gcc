...
vint16mf2_t
test0_vle16ff_v_i16mf2_m(vbool32_t mask,vint16mf2_t maskedoff,const int16_t *base,size_t *new_vl,size_t vl)
{
...
vint16mf2_t
test1_vle16ff_v_i16mf2_m(vbool32_t mask,vint16mf2_t maskedoff,const int16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_i16mf2_m(mask, maskedoff, base, new_vl, 7);
}
