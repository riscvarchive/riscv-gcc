...
vuint32m2_t
test0_vloxei64_v_u32m2_m(vbool16_t mask,vuint32m2_t maskedoff,const uint32_t *base,vuint64m4_t bindex,size_t vl)
{
...
vuint32m2_t
test1_vloxei64_v_u32m2_m(vbool16_t mask,vuint32m2_t maskedoff,const uint32_t *base,vuint64m4_t bindex,size_t vl)
{
    return vloxei64_v_u32m2_m(mask, maskedoff, base, bindex, 28);
}
