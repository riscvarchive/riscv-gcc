...
vfloat32m4_t
test0_vlse32_v_f32m4_m(vbool8_t mask,vfloat32m4_t maskedoff,const float32_t *base,ptrdiff_t bstride,size_t vl)
{
...
vfloat32m4_t
test1_vlse32_v_f32m4_m(vbool8_t mask,vfloat32m4_t maskedoff,const float32_t *base,ptrdiff_t bstride,size_t vl)
{
    return vlse32_v_f32m4_m(mask, maskedoff, base, bstride, 23);
}
