...
vfloat16mf2_t
test0_vle16ff_v_f16mf2(const float16_t *base,size_t *new_vl,size_t vl)
{
...
vfloat16mf2_t
test1_vle16ff_v_f16mf2(const float16_t *base,size_t *new_vl,size_t vl)
{
    return vle16ff_v_f16mf2(base, new_vl, 16);
}
