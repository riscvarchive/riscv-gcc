...
vuint16mf2_t
test0_vluxei64_v_u16mf2(const uint16_t *base,vuint64m2_t bindex,size_t vl)
{
...
vuint16mf2_t
test1_vluxei64_v_u16mf2(const uint16_t *base,vuint64m2_t bindex,size_t vl)
{
    return vluxei64_v_u16mf2(base, bindex, 8);
}
