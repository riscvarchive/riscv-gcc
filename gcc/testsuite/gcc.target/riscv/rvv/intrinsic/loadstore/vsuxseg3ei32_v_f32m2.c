...
void
test1_vsuxseg3ei32_v_f32m2(float32_t *base,vuint32m2_t bindex,vfloat32m2_t v0,vfloat32m2_t v1,vfloat32m2_t v2,size_t vl)
{
    vsuxseg3ei32_v_f32m2(base, bindex, v0, v1, v2, 1);
}
