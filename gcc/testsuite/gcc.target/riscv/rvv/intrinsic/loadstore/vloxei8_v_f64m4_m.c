...
vfloat64m4_t
test0_vloxei8_v_f64m4_m(vbool16_t mask,vfloat64m4_t maskedoff,const float64_t *base,vuint8mf2_t bindex,size_t vl)
{
...
vfloat64m4_t
test1_vloxei8_v_f64m4_m(vbool16_t mask,vfloat64m4_t maskedoff,const float64_t *base,vuint8mf2_t bindex,size_t vl)
{
    return vloxei8_v_f64m4_m(mask, maskedoff, base, bindex, 12);
}
