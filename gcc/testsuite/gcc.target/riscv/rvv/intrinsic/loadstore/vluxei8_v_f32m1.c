...
vfloat32m1_t
test0_vluxei8_v_f32m1(const float32_t *base,vuint8mf4_t bindex,size_t vl)
{
...
vfloat32m1_t
test1_vluxei8_v_f32m1(const float32_t *base,vuint8mf4_t bindex,size_t vl)
{
    return vluxei8_v_f32m1(base, bindex, 2);
}
