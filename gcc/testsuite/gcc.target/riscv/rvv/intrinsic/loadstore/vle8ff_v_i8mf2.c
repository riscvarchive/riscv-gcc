...
vint8mf2_t
test0_vle8ff_v_i8mf2(const int8_t *base,size_t *new_vl,size_t vl)
{
...
vint8mf2_t
test1_vle8ff_v_i8mf2(const int8_t *base,size_t *new_vl,size_t vl)
{
    return vle8ff_v_i8mf2(base, new_vl, 14);
}
