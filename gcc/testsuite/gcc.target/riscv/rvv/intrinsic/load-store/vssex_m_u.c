...
void
test_vsse8_v_u8mf8_vl31_m (vbool64_t mask, uint8_t *base, ptrdiff_t bstride, vuint8mf8_t v0)
{
...
void
test_vsse8_v_u8mf4_vl31_m (vbool32_t mask, uint8_t *base, ptrdiff_t bstride, vuint8mf4_t v0)
{
...
void
test_vsse8_v_u8mf2_vl31_m (vbool16_t mask, uint8_t *base, ptrdiff_t bstride, vuint8mf2_t v0)
{
...
void
test_vsse8_v_u8m1_vl31_m (vbool8_t mask, uint8_t *base, ptrdiff_t bstride, vuint8m1_t v0)
{
...
void
test_vsse8_v_u8m2_vl31_m (vbool4_t mask, uint8_t *base, ptrdiff_t bstride, vuint8m2_t v0)
{
...
void
test_vsse8_v_u8m4_vl31_m (vbool2_t mask, uint8_t *base, ptrdiff_t bstride, vuint8m4_t v0)
{
...
void
test_vsse8_v_u8m8_vl31_m (vbool1_t mask, uint8_t *base, ptrdiff_t bstride, vuint8m8_t v0)
{
...
void
test_vsse16_v_u16mf4_vl31_m (vbool64_t mask, uint16_t *base, ptrdiff_t bstride, vuint16mf4_t v0)
{
...
void
test_vsse16_v_u16mf2_vl31_m (vbool32_t mask, uint16_t *base, ptrdiff_t bstride, vuint16mf2_t v0)
{
...
void
test_vsse16_v_u16m1_vl31_m (vbool16_t mask, uint16_t *base, ptrdiff_t bstride, vuint16m1_t v0)
{
...
void
test_vsse16_v_u16m2_vl31_m (vbool8_t mask, uint16_t *base, ptrdiff_t bstride, vuint16m2_t v0)
{
...
void
test_vsse16_v_u16m4_vl31_m (vbool4_t mask, uint16_t *base, ptrdiff_t bstride, vuint16m4_t v0)
{
...
void
test_vsse16_v_u16m8_vl31_m (vbool2_t mask, uint16_t *base, ptrdiff_t bstride, vuint16m8_t v0)
{
...
void
test_vsse32_v_u32mf2_vl31_m (vbool64_t mask, uint32_t *base, ptrdiff_t bstride, vuint32mf2_t v0)
{
...
void
test_vsse32_v_u32m1_vl31_m (vbool32_t mask, uint32_t *base, ptrdiff_t bstride, vuint32m1_t v0)
{
...
void
test_vsse32_v_u32m2_vl31_m (vbool16_t mask, uint32_t *base, ptrdiff_t bstride, vuint32m2_t v0)
{
...
void
test_vsse32_v_u32m4_vl31_m (vbool8_t mask, uint32_t *base, ptrdiff_t bstride, vuint32m4_t v0)
{
...
void
test_vsse32_v_u32m8_vl31_m (vbool4_t mask, uint32_t *base, ptrdiff_t bstride, vuint32m8_t v0)
{
...
void
test_vsse64_v_u64m1_vl31_m (vbool64_t mask, uint64_t *base, ptrdiff_t bstride, vuint64m1_t v0)
{
...
void
test_vsse64_v_u64m2_vl31_m (vbool32_t mask, uint64_t *base, ptrdiff_t bstride, vuint64m2_t v0)
{
...
void
test_vsse64_v_u64m4_vl31_m (vbool16_t mask, uint64_t *base, ptrdiff_t bstride, vuint64m4_t v0)
{
...
void
test_vsse64_v_u64m8_vl31_m (vbool8_t mask, uint64_t *base, ptrdiff_t bstride, vuint64m8_t v0)
{
