...
void
test_vsoxei8_v_f16mf4_vl32_m (vbool64_t mask, float16_t *base, vuint8mf8_t bindex, vfloat16mf4_t v0)
{
...
void
test_vsoxei8_v_f32mf2_vl32_m (vbool64_t mask, float32_t *base, vuint8mf8_t bindex, vfloat32mf2_t v0)
{
...
void
test_vsoxei8_v_f64m1_vl32_m (vbool64_t mask, float64_t *base, vuint8mf8_t bindex, vfloat64m1_t v0)
{
...
void
test_vsoxei8_v_f16mf2_vl32_m (vbool32_t mask, float16_t *base, vuint8mf4_t bindex, vfloat16mf2_t v0)
{
...
void
test_vsoxei8_v_f32m1_vl32_m (vbool32_t mask, float32_t *base, vuint8mf4_t bindex, vfloat32m1_t v0)
{
...
void
test_vsoxei8_v_f64m2_vl32_m (vbool32_t mask, float64_t *base, vuint8mf4_t bindex, vfloat64m2_t v0)
{
...
void
test_vsoxei8_v_f16m1_vl32_m (vbool16_t mask, float16_t *base, vuint8mf2_t bindex, vfloat16m1_t v0)
{
...
void
test_vsoxei8_v_f32m2_vl32_m (vbool16_t mask, float32_t *base, vuint8mf2_t bindex, vfloat32m2_t v0)
{
...
void
test_vsoxei8_v_f64m4_vl32_m (vbool16_t mask, float64_t *base, vuint8mf2_t bindex, vfloat64m4_t v0)
{
...
void
test_vsoxei8_v_f16m2_vl32_m (vbool8_t mask, float16_t *base, vuint8m1_t bindex, vfloat16m2_t v0)
{
...
void
test_vsoxei8_v_f32m4_vl32_m (vbool8_t mask, float32_t *base, vuint8m1_t bindex, vfloat32m4_t v0)
{
...
void
test_vsoxei8_v_f64m8_vl32_m (vbool8_t mask, float64_t *base, vuint8m1_t bindex, vfloat64m8_t v0)
{
...
void
test_vsoxei8_v_f16m4_vl32_m (vbool4_t mask, float16_t *base, vuint8m2_t bindex, vfloat16m4_t v0)
{
...
void
test_vsoxei8_v_f32m8_vl32_m (vbool4_t mask, float32_t *base, vuint8m2_t bindex, vfloat32m8_t v0)
{
...
void
test_vsoxei8_v_f16m8_vl32_m (vbool2_t mask, float16_t *base, vuint8m4_t bindex, vfloat16m8_t v0)
{
...
void
test_vsoxei16_v_f16mf4_vl32_m (vbool64_t mask, float16_t *base, vuint16mf4_t bindex, vfloat16mf4_t v0)
{
...
void
test_vsoxei16_v_f32mf2_vl32_m (vbool64_t mask, float32_t *base, vuint16mf4_t bindex, vfloat32mf2_t v0)
{
...
void
test_vsoxei16_v_f64m1_vl32_m (vbool64_t mask, float64_t *base, vuint16mf4_t bindex, vfloat64m1_t v0)
{
...
void
test_vsoxei16_v_f16mf2_vl32_m (vbool32_t mask, float16_t *base, vuint16mf2_t bindex, vfloat16mf2_t v0)
{
...
void
test_vsoxei16_v_f32m1_vl32_m (vbool32_t mask, float32_t *base, vuint16mf2_t bindex, vfloat32m1_t v0)
{
...
void
test_vsoxei16_v_f64m2_vl32_m (vbool32_t mask, float64_t *base, vuint16mf2_t bindex, vfloat64m2_t v0)
{
...
void
test_vsoxei16_v_f16m1_vl32_m (vbool16_t mask, float16_t *base, vuint16m1_t bindex, vfloat16m1_t v0)
{
...
void
test_vsoxei16_v_f32m2_vl32_m (vbool16_t mask, float32_t *base, vuint16m1_t bindex, vfloat32m2_t v0)
{
...
void
test_vsoxei16_v_f64m4_vl32_m (vbool16_t mask, float64_t *base, vuint16m1_t bindex, vfloat64m4_t v0)
{
...
void
test_vsoxei16_v_f16m2_vl32_m (vbool8_t mask, float16_t *base, vuint16m2_t bindex, vfloat16m2_t v0)
{
...
void
test_vsoxei16_v_f32m4_vl32_m (vbool8_t mask, float32_t *base, vuint16m2_t bindex, vfloat32m4_t v0)
{
...
void
test_vsoxei16_v_f64m8_vl32_m (vbool8_t mask, float64_t *base, vuint16m2_t bindex, vfloat64m8_t v0)
{
...
void
test_vsoxei16_v_f16m4_vl32_m (vbool4_t mask, float16_t *base, vuint16m4_t bindex, vfloat16m4_t v0)
{
...
void
test_vsoxei16_v_f32m8_vl32_m (vbool4_t mask, float32_t *base, vuint16m4_t bindex, vfloat32m8_t v0)
{
...
void
test_vsoxei16_v_f16m8_vl32_m (vbool2_t mask, float16_t *base, vuint16m8_t bindex, vfloat16m8_t v0)
{
...
void
test_vsoxei32_v_f16mf4_vl32_m (vbool64_t mask, float16_t *base, vuint32mf2_t bindex, vfloat16mf4_t v0)
{
...
void
test_vsoxei32_v_f32mf2_vl32_m (vbool64_t mask, float32_t *base, vuint32mf2_t bindex, vfloat32mf2_t v0)
{
...
void
test_vsoxei32_v_f64m1_vl32_m (vbool64_t mask, float64_t *base, vuint32mf2_t bindex, vfloat64m1_t v0)
{
...
void
test_vsoxei32_v_f16mf2_vl32_m (vbool32_t mask, float16_t *base, vuint32m1_t bindex, vfloat16mf2_t v0)
{
...
void
test_vsoxei32_v_f32m1_vl32_m (vbool32_t mask, float32_t *base, vuint32m1_t bindex, vfloat32m1_t v0)
{
...
void
test_vsoxei32_v_f64m2_vl32_m (vbool32_t mask, float64_t *base, vuint32m1_t bindex, vfloat64m2_t v0)
{
...
void
test_vsoxei32_v_f16m1_vl32_m (vbool16_t mask, float16_t *base, vuint32m2_t bindex, vfloat16m1_t v0)
{
...
void
test_vsoxei32_v_f32m2_vl32_m (vbool16_t mask, float32_t *base, vuint32m2_t bindex, vfloat32m2_t v0)
{
...
void
test_vsoxei32_v_f64m4_vl32_m (vbool16_t mask, float64_t *base, vuint32m2_t bindex, vfloat64m4_t v0)
{
...
void
test_vsoxei32_v_f16m2_vl32_m (vbool8_t mask, float16_t *base, vuint32m4_t bindex, vfloat16m2_t v0)
{
...
void
test_vsoxei32_v_f32m4_vl32_m (vbool8_t mask, float32_t *base, vuint32m4_t bindex, vfloat32m4_t v0)
{
...
void
test_vsoxei32_v_f64m8_vl32_m (vbool8_t mask, float64_t *base, vuint32m4_t bindex, vfloat64m8_t v0)
{
...
void
test_vsoxei32_v_f16m4_vl32_m (vbool4_t mask, float16_t *base, vuint32m8_t bindex, vfloat16m4_t v0)
{
...
void
test_vsoxei32_v_f32m8_vl32_m (vbool4_t mask, float32_t *base, vuint32m8_t bindex, vfloat32m8_t v0)
{
...
void
test_vsoxei64_v_f16mf4_vl32_m (vbool64_t mask, float16_t *base, vuint64m1_t bindex, vfloat16mf4_t v0)
{
...
void
test_vsoxei64_v_f32mf2_vl32_m (vbool64_t mask, float32_t *base, vuint64m1_t bindex, vfloat32mf2_t v0)
{
...
void
test_vsoxei64_v_f64m1_vl32_m (vbool64_t mask, float64_t *base, vuint64m1_t bindex, vfloat64m1_t v0)
{
...
void
test_vsoxei64_v_f16mf2_vl32_m (vbool32_t mask, float16_t *base, vuint64m2_t bindex, vfloat16mf2_t v0)
{
...
void
test_vsoxei64_v_f32m1_vl32_m (vbool32_t mask, float32_t *base, vuint64m2_t bindex, vfloat32m1_t v0)
{
...
void
test_vsoxei64_v_f64m2_vl32_m (vbool32_t mask, float64_t *base, vuint64m2_t bindex, vfloat64m2_t v0)
{
...
void
test_vsoxei64_v_f16m1_vl32_m (vbool16_t mask, float16_t *base, vuint64m4_t bindex, vfloat16m1_t v0)
{
...
void
test_vsoxei64_v_f32m2_vl32_m (vbool16_t mask, float32_t *base, vuint64m4_t bindex, vfloat32m2_t v0)
{
...
void
test_vsoxei64_v_f64m4_vl32_m (vbool16_t mask, float64_t *base, vuint64m4_t bindex, vfloat64m4_t v0)
{
...
void
test_vsoxei64_v_f16m2_vl32_m (vbool8_t mask, float16_t *base, vuint64m8_t bindex, vfloat16m2_t v0)
{
...
void
test_vsoxei64_v_f32m4_vl32_m (vbool8_t mask, float32_t *base, vuint64m8_t bindex, vfloat32m4_t v0)
{
...
void
test_vsoxei64_v_f64m8_vl32_m (vbool8_t mask, float64_t *base, vuint64m8_t bindex, vfloat64m8_t v0)
{
