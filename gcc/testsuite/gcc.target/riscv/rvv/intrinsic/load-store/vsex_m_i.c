...
void
test_vse8_v_i8mf8_vl31_m (vbool64_t mask, int8_t *base, vint8mf8_t v0)
{
...
void
test_vse8_v_i8mf4_vl31_m (vbool32_t mask, int8_t *base, vint8mf4_t v0)
{
...
void
test_vse8_v_i8mf2_vl31_m (vbool16_t mask, int8_t *base, vint8mf2_t v0)
{
...
void
test_vse8_v_i8m1_vl31_m (vbool8_t mask, int8_t *base, vint8m1_t v0)
{
...
void
test_vse8_v_i8m2_vl31_m (vbool4_t mask, int8_t *base, vint8m2_t v0)
{
...
void
test_vse8_v_i8m4_vl31_m (vbool2_t mask, int8_t *base, vint8m4_t v0)
{
...
void
test_vse8_v_i8m8_vl31_m (vbool1_t mask, int8_t *base, vint8m8_t v0)
{
...
void
test_vse16_v_i16mf4_vl31_m (vbool64_t mask, int16_t *base, vint16mf4_t v0)
{
...
void
test_vse16_v_i16mf2_vl31_m (vbool32_t mask, int16_t *base, vint16mf2_t v0)
{
...
void
test_vse16_v_i16m1_vl31_m (vbool16_t mask, int16_t *base, vint16m1_t v0)
{
...
void
test_vse16_v_i16m2_vl31_m (vbool8_t mask, int16_t *base, vint16m2_t v0)
{
...
void
test_vse16_v_i16m4_vl31_m (vbool4_t mask, int16_t *base, vint16m4_t v0)
{
...
void
test_vse16_v_i16m8_vl31_m (vbool2_t mask, int16_t *base, vint16m8_t v0)
{
...
void
test_vse32_v_i32mf2_vl31_m (vbool64_t mask, int32_t *base, vint32mf2_t v0)
{
...
void
test_vse32_v_i32m1_vl31_m (vbool32_t mask, int32_t *base, vint32m1_t v0)
{
...
void
test_vse32_v_i32m2_vl31_m (vbool16_t mask, int32_t *base, vint32m2_t v0)
{
...
void
test_vse32_v_i32m4_vl31_m (vbool8_t mask, int32_t *base, vint32m4_t v0)
{
...
void
test_vse32_v_i32m8_vl31_m (vbool4_t mask, int32_t *base, vint32m8_t v0)
{
...
void
test_vse64_v_i64m1_vl31_m (vbool64_t mask, int64_t *base, vint64m1_t v0)
{
...
void
test_vse64_v_i64m2_vl31_m (vbool32_t mask, int64_t *base, vint64m2_t v0)
{
...
void
test_vse64_v_i64m4_vl31_m (vbool16_t mask, int64_t *base, vint64m4_t v0)
{
...
void
test_vse64_v_i64m8_vl31_m (vbool8_t mask, int64_t *base, vint64m8_t v0)
{
