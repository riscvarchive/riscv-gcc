...
void
test_vsse16_v_f16mf4_vl32_m (vbool64_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf4_t v0)
{
...
void
test_vsse16_v_f16mf2_vl32_m (vbool32_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf2_t v0)
{
...
void
test_vsse16_v_f16m1_vl32_m (vbool16_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m1_t v0)
{
...
void
test_vsse16_v_f16m2_vl32_m (vbool8_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m2_t v0)
{
...
void
test_vsse16_v_f16m4_vl32_m (vbool4_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m4_t v0)
{
...
void
test_vsse16_v_f16m8_vl32_m (vbool2_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m8_t v0)
{
...
void
test_vsse32_v_f32mf2_vl32_m (vbool64_t mask, float32_t *base, ptrdiff_t bstride, vfloat32mf2_t v0)
{
...
void
test_vsse32_v_f32m1_vl32_m (vbool32_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m1_t v0)
{
...
void
test_vsse32_v_f32m2_vl32_m (vbool16_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m2_t v0)
{
...
void
test_vsse32_v_f32m4_vl32_m (vbool8_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m4_t v0)
{
...
void
test_vsse32_v_f32m8_vl32_m (vbool4_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m8_t v0)
{
...
void
test_vsse64_v_f64m1_vl32_m (vbool64_t mask, float64_t *base, ptrdiff_t bstride, vfloat64m1_t v0)
{
...
void
test_vsse64_v_f64m2_vl32_m (vbool32_t mask, float64_t *base, ptrdiff_t bstride, vfloat64m2_t v0)
{
...
void
test_vsse64_v_f64m4_vl32_m (vbool16_t mask, float64_t *base, ptrdiff_t bstride, vfloat64m4_t v0)
{
...
void
test_vsse64_v_f64m8_vl32_m (vbool8_t mask, float64_t *base, ptrdiff_t bstride, vfloat64m8_t v0)
{
