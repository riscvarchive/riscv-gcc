...
vfloat16mf4_t 
test_vcompress_vm_f16mf4_ta_vl32(vbool64_t mask, vfloat16mf4_t op1)
{
...
vfloat16mf2_t 
test_vcompress_vm_f16mf2_ta_vl32(vbool32_t mask, vfloat16mf2_t op1)
{
...
vfloat16m1_t 
test_vcompress_vm_f16m1_ta_vl32(vbool16_t mask, vfloat16m1_t op1)
{
...
vfloat16m2_t 
test_vcompress_vm_f16m2_ta_vl32(vbool8_t mask, vfloat16m2_t op1)
{
...
vfloat16m4_t 
test_vcompress_vm_f16m4_ta_vl32(vbool4_t mask, vfloat16m4_t op1)
{
...
vfloat16m8_t 
test_vcompress_vm_f16m8_ta_vl32(vbool2_t mask, vfloat16m8_t op1)
{
...
vfloat32mf2_t 
test_vcompress_vm_f32mf2_ta_vl32(vbool64_t mask, vfloat32mf2_t op1)
{
...
vfloat32m1_t 
test_vcompress_vm_f32m1_ta_vl32(vbool32_t mask, vfloat32m1_t op1)
{
...
vfloat32m2_t 
test_vcompress_vm_f32m2_ta_vl32(vbool16_t mask, vfloat32m2_t op1)
{
...
vfloat32m4_t 
test_vcompress_vm_f32m4_ta_vl32(vbool8_t mask, vfloat32m4_t op1)
{
...
vfloat32m8_t 
test_vcompress_vm_f32m8_ta_vl32(vbool4_t mask, vfloat32m8_t op1)
{
...
vfloat64m1_t 
test_vcompress_vm_f64m1_ta_vl32(vbool64_t mask, vfloat64m1_t op1)
{
...
vfloat64m2_t 
test_vcompress_vm_f64m2_ta_vl32(vbool32_t mask, vfloat64m2_t op1)
{
...
vfloat64m4_t 
test_vcompress_vm_f64m4_ta_vl32(vbool16_t mask, vfloat64m4_t op1)
{
...
vfloat64m8_t 
test_vcompress_vm_f64m8_ta_vl32(vbool8_t mask, vfloat64m8_t op1)
{
...
vfloat16mf4_t 
test_vcompress_vm_f16mf4_tu_vl32(vfloat16mf4_t dest, vbool64_t mask, vfloat16mf4_t op1)
{
  return vcompress_vm_f16mf4_tu(mask, dest, op1, 32);
}
...
vfloat16mf2_t 
test_vcompress_vm_f16mf2_tu_vl32(vfloat16mf2_t dest, vbool32_t mask, vfloat16mf2_t op1)
{
  return vcompress_vm_f16mf2_tu(mask, dest, op1, 32);
}
...
vfloat16m1_t 
test_vcompress_vm_f16m1_tu_vl32(vfloat16m1_t dest, vbool16_t mask, vfloat16m1_t op1)
{
  return vcompress_vm_f16m1_tu(mask, dest, op1, 32);
}
...
vfloat16m2_t 
test_vcompress_vm_f16m2_tu_vl32(vfloat16m2_t dest, vbool8_t mask, vfloat16m2_t op1)
{
  return vcompress_vm_f16m2_tu(mask, dest, op1, 32);
}
...
vfloat16m4_t 
test_vcompress_vm_f16m4_tu_vl32(vfloat16m4_t dest, vbool4_t mask, vfloat16m4_t op1)
{
  return vcompress_vm_f16m4_tu(mask, dest, op1, 32);
}
...
vfloat16m8_t 
test_vcompress_vm_f16m8_tu_vl32(vfloat16m8_t dest, vbool2_t mask, vfloat16m8_t op1)
{
  return vcompress_vm_f16m8_tu(mask, dest, op1, 32);
}
...
vfloat32mf2_t 
test_vcompress_vm_f32mf2_tu_vl32(vfloat32mf2_t dest, vbool64_t mask, vfloat32mf2_t op1)
{
  return vcompress_vm_f32mf2_tu(mask, dest, op1, 32);
}
...
vfloat32m1_t 
test_vcompress_vm_f32m1_tu_vl32(vfloat32m1_t dest, vbool32_t mask, vfloat32m1_t op1)
{
  return vcompress_vm_f32m1_tu(mask, dest, op1, 32);
}
...
vfloat32m2_t 
test_vcompress_vm_f32m2_tu_vl32(vfloat32m2_t dest, vbool16_t mask, vfloat32m2_t op1)
{
  return vcompress_vm_f32m2_tu(mask, dest, op1, 32);
}
...
vfloat32m4_t 
test_vcompress_vm_f32m4_tu_vl32(vfloat32m4_t dest, vbool8_t mask, vfloat32m4_t op1)
{
  return vcompress_vm_f32m4_tu(mask, dest, op1, 32);
}
...
vfloat32m8_t 
test_vcompress_vm_f32m8_tu_vl32(vfloat32m8_t dest, vbool4_t mask, vfloat32m8_t op1)
{
  return vcompress_vm_f32m8_tu(mask, dest, op1, 32);
}
...
vfloat64m1_t 
test_vcompress_vm_f64m1_tu_vl32(vfloat64m1_t dest, vbool64_t mask, vfloat64m1_t op1)
{
  return vcompress_vm_f64m1_tu(mask, dest, op1, 32);
}
...
vfloat64m2_t 
test_vcompress_vm_f64m2_tu_vl32(vfloat64m2_t dest, vbool32_t mask, vfloat64m2_t op1)
{
  return vcompress_vm_f64m2_tu(mask, dest, op1, 32);
}
...
vfloat64m4_t 
test_vcompress_vm_f64m4_tu_vl32(vfloat64m4_t dest, vbool16_t mask, vfloat64m4_t op1)
{
  return vcompress_vm_f64m4_tu(mask, dest, op1, 32);
}
...
vfloat64m8_t 
test_vcompress_vm_f64m8_tu_vl32(vfloat64m8_t dest, vbool8_t mask, vfloat64m8_t op1)
{
  return vcompress_vm_f64m8_tu(mask, dest, op1, 32);
}
