...
vuint8m1_t 
test_vredsum_vs_u8mf8_u8m1_vl32(vuint8mf8_t op1, vuint8m1_t op2)
{
  return vredsum_vs_u8mf8_u8m1(op1, op2, 32);
}
...
vuint8m1_t 
test_vredsum_vs_u8mf4_u8m1_vl32(vuint8mf4_t op1, vuint8m1_t op2)
{
  return vredsum_vs_u8mf4_u8m1(op1, op2, 32);
}
...
vuint8m1_t 
test_vredsum_vs_u8mf2_u8m1_vl32(vuint8mf2_t op1, vuint8m1_t op2)
{
  return vredsum_vs_u8mf2_u8m1(op1, op2, 32);
}
...
vuint8m1_t 
test_vredsum_vs_u8m1_u8m1_vl32(vuint8m1_t op1, vuint8m1_t op2)
{
  return vredsum_vs_u8m1_u8m1(op1, op2, 32);
}
...
vuint8m1_t 
test_vredsum_vs_u8m2_u8m1_vl32(vuint8m2_t op1, vuint8m1_t op2)
{
  return vredsum_vs_u8m2_u8m1(op1, op2, 32);
}
...
vuint8m1_t 
test_vredsum_vs_u8m4_u8m1_vl32(vuint8m4_t op1, vuint8m1_t op2)
{
  return vredsum_vs_u8m4_u8m1(op1, op2, 32);
}
...
vuint8m1_t 
test_vredsum_vs_u8m8_u8m1_vl32(vuint8m8_t op1, vuint8m1_t op2)
{
  return vredsum_vs_u8m8_u8m1(op1, op2, 32);
}
...
vuint16m1_t 
test_vredsum_vs_u16mf4_u16m1_vl32(vuint16mf4_t op1, vuint16m1_t op2)
{
  return vredsum_vs_u16mf4_u16m1(op1, op2, 32);
}
...
vuint16m1_t 
test_vredsum_vs_u16mf2_u16m1_vl32(vuint16mf2_t op1, vuint16m1_t op2)
{
  return vredsum_vs_u16mf2_u16m1(op1, op2, 32);
}
...
vuint16m1_t 
test_vredsum_vs_u16m1_u16m1_vl32(vuint16m1_t op1, vuint16m1_t op2)
{
  return vredsum_vs_u16m1_u16m1(op1, op2, 32);
}
...
vuint16m1_t 
test_vredsum_vs_u16m2_u16m1_vl32(vuint16m2_t op1, vuint16m1_t op2)
{
  return vredsum_vs_u16m2_u16m1(op1, op2, 32);
}
...
vuint16m1_t 
test_vredsum_vs_u16m4_u16m1_vl32(vuint16m4_t op1, vuint16m1_t op2)
{
  return vredsum_vs_u16m4_u16m1(op1, op2, 32);
}
...
vuint16m1_t 
test_vredsum_vs_u16m8_u16m1_vl32(vuint16m8_t op1, vuint16m1_t op2)
{
  return vredsum_vs_u16m8_u16m1(op1, op2, 32);
}
...
vuint32m1_t 
test_vredsum_vs_u32mf2_u32m1_vl32(vuint32mf2_t op1, vuint32m1_t op2)
{
  return vredsum_vs_u32mf2_u32m1(op1, op2, 32);
}
...
vuint32m1_t 
test_vredsum_vs_u32m1_u32m1_vl32(vuint32m1_t op1, vuint32m1_t op2)
{
  return vredsum_vs_u32m1_u32m1(op1, op2, 32);
}
...
vuint32m1_t 
test_vredsum_vs_u32m2_u32m1_vl32(vuint32m2_t op1, vuint32m1_t op2)
{
  return vredsum_vs_u32m2_u32m1(op1, op2, 32);
}
...
vuint32m1_t 
test_vredsum_vs_u32m4_u32m1_vl32(vuint32m4_t op1, vuint32m1_t op2)
{
  return vredsum_vs_u32m4_u32m1(op1, op2, 32);
}
...
vuint32m1_t 
test_vredsum_vs_u32m8_u32m1_vl32(vuint32m8_t op1, vuint32m1_t op2)
{
  return vredsum_vs_u32m8_u32m1(op1, op2, 32);
}
...
vuint64m1_t 
test_vredsum_vs_u64m1_u64m1_vl32(vuint64m1_t op1, vuint64m1_t op2)
{
  return vredsum_vs_u64m1_u64m1(op1, op2, 32);
}
...
vuint64m1_t 
test_vredsum_vs_u64m2_u64m1_vl32(vuint64m2_t op1, vuint64m1_t op2)
{
  return vredsum_vs_u64m2_u64m1(op1, op2, 32);
}
...
vuint64m1_t 
test_vredsum_vs_u64m4_u64m1_vl32(vuint64m4_t op1, vuint64m1_t op2)
{
  return vredsum_vs_u64m4_u64m1(op1, op2, 32);
}
...
vuint64m1_t 
test_vredsum_vs_u64m8_u64m1_vl32(vuint64m8_t op1, vuint64m1_t op2)
{
  return vredsum_vs_u64m8_u64m1(op1, op2, 32);
}
