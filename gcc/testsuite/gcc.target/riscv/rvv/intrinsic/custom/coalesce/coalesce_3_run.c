...
int  main(void )
{
    int32_t in[36]={5848,3451,7965,1441,35,656,7281,4078,5894,6274,1492,748,1004,1140,4704,3487,3886,1002,6203,4870,614,6809,2326,1296,4289,6316,4250,7665,4525,5198,219,7136,3258,4632,2941,1653};
    int32_t out[36] = {0};
