...
/*
** test_vmv_v_x_vl2: { target { { any-opts "-mriscv-vector-bits=512" } || { no-opts "-mriscv-vector-bits=*" } } }
**  ...
**  vsetivli\s+zero,4,e32,m1,t[au],m[au]
**  vmv.v.x\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7])
**  vmerge.vxm\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),(?:v[0-9]|v[1-2][0-9]|v3[0-1]),(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),(?:v[0-9]|v[1-2][0-9]|v3[0-1])
**  ret
*/
vint64m1_t
test_vmv_v_x_vl2 (int64_t x)
{
  return vmv_v_x_i64m1 (x, 2);
}

/*
** test_vmv_v_x_vl15: { target { { any-opts "-mriscv-vector-bits=512" } || { no-opts "-mriscv-vector-bits=*" } } }
**  ...
**  vsetivli\s+(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),15,e64,m1,t[au],m[au]
**  slli\s+(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),1
**  vsetvli\s+zero,(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),e32,m1,t[au],m[au]
...
*/
vint64m1_t
test_vmv_v_x_vl15 (int64_t x)
{
  return vmv_v_x_i64m1 (x, 15);
}

/*
** test_vmv_v_x: { target { { any-opts "-mriscv-vector-bits=512" } || { no-opts "-mriscv-vector-bits=*" } } }
**  ...
**  vsetvli\s+(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),e64,m1,t[au],m[au]
**  slli\s+(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),1
**  vsetvli\s+zero,(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),e32,m1,t[au],m[au]
...
*/
vint64m1_t
test_vmv_v_x (int64_t x, size_t vl)
{
  return vmv_v_x_i64m1 (x, vl);
}
