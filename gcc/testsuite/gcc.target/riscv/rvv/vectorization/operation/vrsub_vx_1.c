...
/* { dg-final { scan-assembler-times "\tvrsub\.vx" 68 {target riscv64-*-*} } } */
/* { dg-final { scan-assembler-times "\tvrsub\.vx" 52 {target riscv32-*-*} } } */
/* { dg-final { scan-assembler-times "\tvfrsub\.vf" 24 } } */