...
/* { dg-final { scan-assembler-times "\tvmadd\.vx" 74 {target riscv64-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmadd\.vx" 56 {target riscv32-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmadd\.vv" 20 {target riscv32-*-*} } } */
