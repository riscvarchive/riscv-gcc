...
/* { dg-final { scan-assembler-times "\tvmul\.vx" 68 {target riscv64-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmul\.vx" 52 {target riscv32-*-*} } } */
/* { dg-final { scan-assembler-times "\tvfmul\.vf" 24 } } */