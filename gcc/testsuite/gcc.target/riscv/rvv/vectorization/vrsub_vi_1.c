...
/* { dg-final { scan-assembler-times "\tvrsub\.vx" 204 {target riscv64-*-*} } } */
/* { dg-final { scan-assembler-times "\tvrsub\.vi" 136 {target riscv64-*-*} } } */
/* { dg-final { scan-assembler-times "\tvrsub\.vx" 156 {target riscv32-*-*} } } */
/* { dg-final { scan-assembler-times "\tvrsub\.vi" 104 {target riscv32-*-*} } } */