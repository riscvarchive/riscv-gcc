...
/* { dg-final { scan-assembler {\tvadd\.vi\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*10,\s*v0\.t} } } */
/* { dg-final { scan-assembler {\tvadd\.vi\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*-10,\s*v0\.t} } } */
/* { dg-final { scan-assembler {\tvmul\.vx\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:ra|[sgtf]p|t[0-6]|s[0-9]|s10|s11|a[0-7]),\s*v0\.t} } } */
...
/* { dg-final { scan-assembler-not {\tvadd\.vi\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*10\n} } } */
/* { dg-final { scan-assembler-not {\tvadd\.vi\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*-10\n} } } */
...
/* { dg-final { scan-assembler-not {\tvadd\.vv} } } */
/* { dg-final { scan-assembler-not {\tvsub\.vv} } } */
/* { dg-final { scan-assembler-not {\tvmul\.vv} } } */
