...
#define TEST_LOOP(TYPE1)			                                \
  ...
  f_##TYPE1##_5 (TYPE1 *restrict a,TYPE1 *restrict b,		\
...
/* { dg-final { scan-assembler-times {\tvfmsac\.vv\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*v0\.t} 3 } } */
