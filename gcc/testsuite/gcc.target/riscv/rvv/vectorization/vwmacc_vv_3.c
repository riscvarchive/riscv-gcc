...
mixed_int8_t_int16_t (int8_t * restrict a, uint8_t * restrict b, int16_t * restrict c)
{
...
void __attribute__ ((noinline, noclone))
mixed_int16_t_int32_t (int16_t * restrict a, uint16_t * restrict b, int32_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
...
void __attribute__ ((noinline, noclone))
mixed_int32_t_int64_t (int32_t * restrict a, uint32_t * restrict b, int64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
