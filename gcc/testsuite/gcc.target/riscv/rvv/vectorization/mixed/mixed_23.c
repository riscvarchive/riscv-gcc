...
double_mixed_int8_t_int64_t_plus (int8_t * restrict a, int8_t b, int64_t * restrict c)
{
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint8_t_uint64_t_plus (uint8_t * restrict a, uint8_t b, uint64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int8_t_int64_t_minus (int8_t * restrict a, int8_t b, int64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int64_t)a[i] - (int64_t)b;
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint8_t_uint64_t_minus (uint8_t * restrict a, uint8_t b, uint64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (uint64_t)a[i] - (uint64_t)b;
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int8_t_int64_t_mult (int8_t * restrict a, int8_t b, int64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int64_t)a[i] * (int64_t)b;
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint8_t_uint64_t_mult (uint8_t * restrict a, uint8_t b, uint64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (uint64_t)a[i] * (uint64_t)b;
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int8_t_int64_t_multsu (int8_t * restrict a, uint8_t b, int64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int64_t)a[i] * (int64_t)b;
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int8_t_int64_t_multsu2 (int8_t * restrict a, uint8_t b, uint64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (uint64_t)a[i] * (uint64_t)b;
}