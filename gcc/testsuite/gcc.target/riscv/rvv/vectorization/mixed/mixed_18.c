...
double_mixed_int8_t_int32_t_plus (int8_t * restrict a, int8_t * restrict b, int32_t * restrict c)
{
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint8_t_uint32_t_plus (uint8_t * restrict a, uint8_t * restrict b, uint32_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int8_t_int32_t_minus (int8_t * restrict a, int8_t * restrict b, int32_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int32_t)a[i] - (int32_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint8_t_uint32_t_minus (uint8_t * restrict a, uint8_t * restrict b, uint32_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (uint32_t)a[i] - (int32_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int8_t_int32_t_mult (int8_t * restrict a, int8_t * restrict b, int32_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int32_t)a[i] * (int32_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint8_t_uint32_t_mult (uint8_t * restrict a, uint8_t * restrict b, uint32_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int8_t_int32_t_multsu (int8_t * restrict a, uint8_t * restrict b, int32_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int32_t)a[i] * (int32_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int8_t_int32_t_multsu2 (int8_t * restrict a, uint8_t * restrict b, uint32_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (uint32_t)a[i] * (uint32_t)b[i];
}