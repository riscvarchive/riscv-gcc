...
double_mixed_int16_t_int64_t_plus (int16_t * restrict a, int16_t * restrict b, int64_t * restrict c)
{
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint16_t_uint64_t_plus (uint16_t * restrict a, uint16_t * restrict b, uint64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int16_t_int64_t_minus (int16_t * restrict a, int16_t * restrict b, int64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int64_t)a[i] - (int64_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint16_t_uint64_t_minus (uint16_t * restrict a, uint16_t * restrict b, uint64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (uint64_t)a[i] - (uint64_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int16_t_int64_t_mult (int16_t * restrict a, int16_t * restrict b, int64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int64_t)a[i] * (int64_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_uint16_t_uint64_t_mult (uint16_t * restrict a, uint16_t * restrict b, uint64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (uint64_t)a[i] * (uint64_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int16_t_int64_t_multsu (int16_t * restrict a, uint16_t * restrict b, int64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (int64_t)a[i] * (int64_t)b[i];
}
...
*/
void __attribute__ ((noinline, noclone))
double_mixed_int16_t_int64_t_multsu2 (int16_t * restrict a, uint16_t * restrict b, uint64_t * restrict c)
{
  for (size_t i = 0; i < 128; i++)
    c[i] = (uint64_t)a[i] * (uint64_t)b[i];
}