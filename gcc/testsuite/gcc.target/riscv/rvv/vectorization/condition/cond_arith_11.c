...
/* { dg-final { scan-assembler-times {\tvrsub\.vi\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*10,\s*v0\.t} 8 } } */
...
/* { dg-final { scan-assembler-not {\tvsub\.vi\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*10\n} } } */
