...
/* { dg-final { scan-assembler-times "\tvmerge\.vxm" 132 {target riscv32-*-*} } } */
...
/* { dg-final { scan-assembler-times "\tvmsle\.vv" 11 {target riscv32-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmsleu\.vv" 11 {target riscv32-*-*} } } */
