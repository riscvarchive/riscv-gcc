...
/* { dg-final { scan-assembler-times "\tvmseq\.vv" 88 {target riscv32-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmsne\.vv" 88 {target riscv32-*-*} } } */

/* { dg-final { scan-assembler-times "\tvmfeq\.vv" 33 {target riscv32-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmfne\.vv" 33 {target riscv32-*-*} } } */
/* { dg-final { scan-tree-dump-times "\.WHILE_LEN" 121 "optimized" {target riscv32-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmseq\.vv" 88 {target riscv64-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmsne\.vv" 88 {target riscv64-*-*} } } */

/* { dg-final { scan-assembler-times "\tvmfeq\.vv" 33 {target riscv64-*-*} } } */
/* { dg-final { scan-assembler-times "\tvmfne\.vv" 33 {target riscv64-*-*} } } */
